...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/14218288522695188654983050137898342195_O0.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %call12 = call signext i16 @logadd(ptr noundef %arrayidx9, ptr noundef %arrayidx11)
  %12 = load i32, ptr %k, align 4
  %idxprom13 = sext i32 %12 to i64
  %arrayidx14 = getelementptr inbounds [6 x i16], ptr @bndpsd, i64 0, i64 %idxprom13
  store i16 %call12, ptr %arrayidx14, align 2
