...
land.lhs.true27:                                  ; preds = %if.else
  %37 = load i64, ptr %ady, align 8
  %38 = load i64, ptr %adx, align 8
  %shr28 = ashr i64 %38, 4
  %cmp29 = icmp sle i64 %37, %shr28
  br i1 %cmp29, label %if.then30, label %if.else37

if.then30:                                        ; preds = %land.lhs.true27
  %39 = load i64, ptr %dx, align 8
  %cmp31 = icmp slt i64 %39, 0
  %40 = zext i1 %cmp31 to i64
