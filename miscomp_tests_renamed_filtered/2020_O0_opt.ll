...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/135798891897979419009236141630293074240_O0.ll'
...
entry:
  ...
  %call2 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef 0)
  %call3 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef 1)
  %call4 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, i32 noundef 2)
  %call5 = call i32 (ptr, ...) @printf(ptr noundef @.str.5, i32 noundef 0)
  %call6 = call i32 (ptr, ...) @printf(ptr noundef @.str.6, i32 noundef 1)
  %call7 = call i32 (ptr, ...) @printf(ptr noundef @.str.7, i32 noundef 2)
  ret i32 0
}
