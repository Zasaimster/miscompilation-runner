; 126819015822078741165725562535194458863
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/126819015822078741165725562535194458863.c'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/126819015822078741165725562535194458863.c"
...
entry:
  ...
  %7 = load ptr, ptr @d, align 16
  %8 = load i32, ptr getelementptr inbounds nuw (%struct.B, ptr @d, i32 0, i32 1), align 8
  %idxprom2 = sext i32 %8 to i64
  %arrayidx3 = getelementptr inbounds ptr, ptr %7, i64 %idxprom2
  store ptr %call1, ptr %arrayidx3, align 8
  %9 = load ptr, ptr @d, align 16
  %10 = load i32, ptr getelementptr inbounds nuw (%struct.B, ptr @d, i32 0, i32 1), align 8
  %idxprom4 = sext i32 %10 to i64
  %arrayidx5 = getelementptr inbounds ptr, ptr %9, i64 %idxprom4
  %11 = load ptr, ptr %arrayidx5, align 8
  %a = getelementptr inbounds nuw %struct.A, ptr %11, i32 0, i32 0
...
if.then:                                          ; preds = %entry
  ...
  %16 = load ptr, ptr @d, align 16
  %17 = load i32, ptr getelementptr inbounds nuw (%struct.B, ptr @d, i32 0, i32 1), align 8
  %idxprom7 = sext i32 %17 to i64
  %arrayidx8 = getelementptr inbounds ptr, ptr %16, i64 %idxprom7
  %18 = load ptr, ptr %arrayidx8, align 8
  %b = getelementptr inbounds nuw %struct.A, ptr %18, i32 0, i32 1
