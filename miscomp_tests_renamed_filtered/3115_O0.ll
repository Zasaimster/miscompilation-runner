; 154542234152550696943393318505113819682
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/154542234152550696943393318505113819682.c'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/154542234152550696943393318505113819682.c"
...
entry:
  ...
  %ltrue33 = alloca i8, align 1
  %ltrue47 = alloca i8, align 1
...
if.end:                                           ; preds = %if.then, %sw.default
  ...
  %call = call zeroext i1 %22(ptr noundef %23)
  br i1 %call, label %if.else, label %land.lhs.true

land.lhs.true:                                    ; preds = %if.end
  %24 = load i32, ptr %tmpf, align 4
  %cmp = icmp eq i32 %24, 0
  br i1 %cmp, label %if.else, label %if.then32

if.then32:                                        ; preds = %land.lhs.true
  store i8 1, ptr %ltrue33, align 1
  %25 = load i8, ptr %ltrue33, align 1
  %loadedv34 = trunc i8 %25 to i1
  %26 = load ptr, ptr %this, align 8
  %m_floating = getelementptr inbounds nuw %struct.RenderBox, ptr %26, i32 0, i32 2
  %27 = zext i1 %loadedv34 to i16
  %bf.load35 = load i16, ptr %m_floating, align 2
  %bf.shl36 = shl i16 %27, 3
  %bf.clear37 = and i16 %bf.load35, -9
  %bf.set38 = or i16 %bf.clear37, %bf.shl36
  store i16 %bf.set38, ptr %m_floating, align 2
  %bf.result.cast39 = trunc i16 %27 to i8
  %loadedv40 = trunc i8 %bf.result.cast39 to i1
  br label %if.end56

if.else:                                          ; preds = %land.lhs.true, %if.end
  %28 = load ptr, ptr %_style.addr, align 8
  %noninherited_flags41 = getelementptr inbounds nuw %struct.RenderStyle, ptr %28, i32 0, i32 0
  %29 = getelementptr inbounds nuw %struct.NonInheritedFlags, ptr %noninherited_flags41, i32 0, i32 0
  %bf.load42 = load i32, ptr %29, align 4
  %bf.lshr43 = lshr i32 %bf.load42, 17
  %bf.clear44 = and i32 %bf.lshr43, 3
  store i32 %bf.clear44, ptr %tmpp, align 4
  %30 = load i32, ptr %tmpp, align 4
  %cmp45 = icmp eq i32 %30, 1
  br i1 %cmp45, label %if.then46, label %if.end55

if.then46:                                        ; preds = %if.else
  store i8 1, ptr %ltrue47, align 1
  %31 = load i8, ptr %ltrue47, align 1
  %loadedv48 = trunc i8 %31 to i1
  %32 = load ptr, ptr %this, align 8
  %m_relPositioned = getelementptr inbounds nuw %struct.RenderBox, ptr %32, i32 0, i32 2
  %33 = zext i1 %loadedv48 to i16
  %bf.load49 = load i16, ptr %m_relPositioned, align 2
  %bf.shl50 = shl i16 %33, 6
  %bf.clear51 = and i16 %bf.load49, -65
  %bf.set52 = or i16 %bf.clear51, %bf.shl50
  store i16 %bf.set52, ptr %m_relPositioned, align 2
  %bf.result.cast53 = trunc i16 %33 to i8
  %loadedv54 = trunc i8 %bf.result.cast53 to i1
  br label %if.end55

if.end55:                                         ; preds = %if.then46, %if.else
  br label %if.end56

if.end56:                                         ; preds = %if.end55, %if.then32
  br label %sw.epilog

sw.epilog:                                        ; preds = %if.end56, %sw.bb
  ret void
}
