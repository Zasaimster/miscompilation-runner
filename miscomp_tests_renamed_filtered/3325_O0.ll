...
entry:
  ...
  call void @foo(ptr noundef %2, ptr noundef @.str.1, i32 noundef 200)
  ...
  %call1 = call ptr @bar(ptr noundef %3, i32 noundef %cond, i32 noundef %conv, ptr noundef @.str.1, i32 noundef 201)
...
entry:
  ...
  call void @test(ptr noundef @.str.2, ptr noundef null)
  ret i32 0
}
