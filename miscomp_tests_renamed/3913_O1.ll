; 19568021633633199784695613298958312379
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/19568021633633199784695613298958312379.c'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/19568021633633199784695613298958312379.c"
...
entry:
  ...
  %2 = load i8, ptr @a, align 1, !tbaa !11
...
lor.rhs:                                          ; preds = %entry
  %3 = load volatile i32, ptr @c, align 4, !tbaa !9
...
for.end22:                                        ; preds = %for.cond14.if.end.loopexit_crit_edge, %if.else, %for.cond10.if.end.loopexit29_crit_edge, %for.cond10.preheader
  store i32 1, ptr @b, align 4, !tbaa !9
  store i32 %1, ptr @g, align 4, !tbaa !9
  store i32 %lor.ext, ptr @j, align 4, !tbaa !9
  %5 = load i8, ptr @h, align 1, !tbaa !11
