; 173577223200469306348069191824803028348
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/173577223200469306348069191824803028348.c'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/173577223200469306348069191824803028348.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.epic_private = type { ptr, [5 x i32] }
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %ep) #5
  call void @llvm.lifetime.start.p0(i64 20, ptr nonnull %rx_ring) #5
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %arrayidx2 = getelementptr inbounds nuw [5 x i32], ptr %rx_skbuff, i64 0, i64 %indvars.iv
...
for.body6:                                        ; preds = %epic_init_ring.exit, %for.cond4
...
if.end:                                           ; preds = %for.body6
  %arrayidx15 = getelementptr inbounds nuw [5 x i32], ptr %rx_skbuff.i, i64 0, i64 %indvars.iv33
...
for.end21:                                        ; preds = %for.cond4
  call void @llvm.lifetime.end.p0(i64 20, ptr nonnull %rx_ring) #5
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %ep) #5
  ret i32 0
}
