...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/189592074651839413792645169975890593042_O0.ll'
...
entry:
  ...
  store i32 42, ptr @s, align 8
  store ptr null, ptr getelementptr inbounds nuw (%struct.anon, ptr @s, i32 0, i32 1), align 8
