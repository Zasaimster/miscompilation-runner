...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/115266649981759928456917152878797938530.c'
...
define dso_local i32 @calculateSquare(i32 noundef %x) local_unnamed_addr #3 {
entry:
  %mul = mul nsw i32 %x, %x
  ret i32 %mul
}
