; 110565481500439326746287416651708353850
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/110565481500439326746287416651708353850_O0.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/110565481500439326746287416651708353850.c"
...
@.str.1 = private unnamed_addr constant [10 x i8] c"hey there\00", align 1
...
for.body:                                         ; preds = %for.cond
  ...
  store ptr @.str.1, ptr %string, align 8
...
if.end:                                           ; preds = %for.body
  ...
  %value3 = getelementptr inbounds nuw %struct.s, ptr %3, i32 0, i32 0
  store i32 4, ptr %value3, align 8
  %4 = load ptr, ptr %t, align 8
  %value4 = getelementptr inbounds nuw %struct.s, ptr %4, i32 0, i32 0
