...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/180609895609932512173539482780748959209_O1.ll'
...
define dso_local i64 @foo(i32 noundef %x, ptr readnone captures(none) %y) local_unnamed_addr #1 {
entry:
...
entry:
  %call = tail call i64 @foo(i32 noundef 13, ptr nonnull poison)
  unreachable
}
