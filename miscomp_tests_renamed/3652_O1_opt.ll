; 160022551666052451565679012968730210814
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/160022551666052451565679012968730210814_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/160022551666052451565679012968730210814.c"
...
define dso_local noundef i32 @myfunc(i32 noundef %x) local_unnamed_addr #0 {
entry:
  ret i32 10
}
...
entry:
  %call1 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef 10)
  %call3 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef 10)
