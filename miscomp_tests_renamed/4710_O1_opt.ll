; 183118915807724673841185799485707924162
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/183118915807724673841185799485707924162_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/183118915807724673841185799485707924162.c"
...
entry:
  %bf.load = load i64, ptr inttoptr (i64 24 to ptr), align 8
  %bf.clear = and i64 %bf.load, -16777216
  store i64 %bf.clear, ptr inttoptr (i64 24 to ptr), align 8
  ret void
}
