; 133147954370689909422160341456975450127
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/133147954370689909422160341456975450127_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/133147954370689909422160341456975450127.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@w = dso_local local_unnamed_addr global [0 x [2 x i32]] zeroinitializer, align 4
...
if.then:                                          ; preds = %for.body3
  %arrayidx6 = getelementptr inbounds nuw [0 x [2 x i32]], ptr @w, i64 0, i64 %indvars.iv19, i64 %indvars.iv
...
if.then.i:                                        ; preds = %for.body3.i
  %arrayidx6.i = getelementptr inbounds nuw [0 x [2 x i32]], ptr @w, i64 0, i64 %indvars.iv19.i, i64 %indvars.iv.i
...
lor.lhs.false:                                    ; preds = %f.exit
  %1 = load i32, ptr getelementptr inbounds nuw (i8, ptr @w, i64 12), align 4, !tbaa !5
  %cmp1.not = icmp eq i32 %1, 1
  br i1 %cmp1.not, label %lor.lhs.false2, label %if.then

lor.lhs.false2:                                   ; preds = %lor.lhs.false
  %2 = load i32, ptr getelementptr inbounds nuw (i8, ptr @w, i64 8), align 4, !tbaa !5
  %cmp3.not = icmp eq i32 %2, 0
  br i1 %cmp3.not, label %lor.lhs.false4, label %if.then

lor.lhs.false4:                                   ; preds = %lor.lhs.false2
  %3 = load i32, ptr getelementptr inbounds nuw (i8, ptr @w, i64 4), align 4, !tbaa !5
  %cmp5.not = icmp eq i32 %3, 0
  br i1 %cmp5.not, label %if.end, label %if.then

if.then:                                          ; preds = %lor.lhs.false4, %lor.lhs.false2, %lor.lhs.false, %f.exit
