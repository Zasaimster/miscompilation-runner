; 170015396364576958562178818626230220026
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/170015396364576958562178818626230220026_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/170015396364576958562178818626230220026.c"
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %Array) #3
  br label %for.body
...
for.body:                                         ; preds = %for.body, %entry
  ...
  %arrayidx = getelementptr inbounds [2 x i32], ptr %Array, i64 0, i64 %1
...
for.body3:                                        ; preds = %for.body3, %for.body
  ...
  %arrayidx5 = getelementptr inbounds nuw [2 x i32], ptr %Array, i64 0, i64 %indvars.iv21
...
for.end8:                                         ; preds = %for.body3
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %Array) #3
  ret i32 0
}
