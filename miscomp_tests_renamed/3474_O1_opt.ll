; 160776946418188749592281199515713724589
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/160776946418188749592281199515713724589_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/160776946418188749592281199515713724589.c"
...
for.body:                                         ; preds = %for.body, %for.body.preheader
  ...
  %sub = add i32 %0, -2
  %arrayidx = getelementptr inbounds nuw [3 x i32], ptr @a, i64 0, i64 %indvars.iv
...
for.body.i:                                       ; preds = %for.body.i, %entry
  ...
  %sub.i = add i32 %0, -2
  %arrayidx.i = getelementptr inbounds nuw [3 x i32], ptr @a, i64 0, i64 %indvars.iv.i
