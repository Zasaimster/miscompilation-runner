...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/169300782696144887432374311818134907855_O1.ll'
...
for.cond:                                         ; preds = %for.cond, %for.cond.outer.split.lr.ph
  br label %for.cond
...
for.cond.outer.split.i:                           ; preds = %for.cond.outer.split.i, %entry
