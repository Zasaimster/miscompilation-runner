; 192406314699802248569596981428279087246
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/192406314699802248569596981428279087246_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/192406314699802248569596981428279087246.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.S = type { i32, i16, i16, [8 x i8], ptr }

@glob_ptr_int = dso_local local_unnamed_addr global ptr null, align 8
...
@glob_int_arr = dso_local global [42 x i32] zeroinitializer, align 16
...
define dso_local void @simple_arg(ptr noundef readonly captures(none) %g, ptr noundef readonly captures(none) %h, i32 noundef %i) local_unnamed_addr #5 {
entry:
...
attributes #2 = { mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, argmem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #3 = { mustprogress nofree norecurse nosync nounwind willreturn memory(inaccessiblemem: readwrite) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
