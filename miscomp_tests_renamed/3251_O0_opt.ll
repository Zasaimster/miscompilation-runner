; 112072241923336024309197931633807279455
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/112072241923336024309197931633807279455_O0.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/112072241923336024309197931633807279455.c"
...
entry:
  ...
  store i32 0, ptr %unsigned_result, align 4
...
if.end:                                           ; preds = %entry
  ...
  %rem4 = urem i32 %2, %3
  %4 = load i32, ptr %unsigned_result, align 4
  %cmp5 = icmp ne i32 %rem4, %4
...
if.end7:                                          ; preds = %if.end
  ...
  %rem10 = srem i32 %5, %bf.cast
  %6 = load i32, ptr %signed_result, align 4
  %cmp11 = icmp ne i32 %rem10, %6
...
if.end23:                                         ; preds = %if.end13
  ...
  %rem28 = urem i32 %8, %bf.cast27
  %9 = load i32, ptr %unsigned_result, align 4
  %cmp29 = icmp ne i32 %rem28, %9
