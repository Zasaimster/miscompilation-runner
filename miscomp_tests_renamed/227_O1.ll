; 144479349157468095783262428745088846493
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/144479349157468095783262428745088846493.c'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/144479349157468095783262428745088846493.c"
...
entry:
  %call.i81 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i64 noundef 0)
...
while.cond.backedge:                              ; preds = %land.lhs.true25, %land.lhs.true20, %if.then, %if.end56
