...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/107930491423407172577632512688306372287_O1.ll'
...
define dso_local i32 @foo(ptr noundef readnone captures(none) %flags) local_unnamed_addr #0 {
entry:
  ret i32 undef
}
