; 150825119088621516839159856712709637235
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/150825119088621516839159856712709637235_O0.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/150825119088621516839159856712709637235.c"
...
entry:
  ...
  store i32 %call1, ptr %z, align 4
  %b2 = getelementptr inbounds nuw %struct.A, ptr %retval, i32 0, i32 1
  call void @llvm.memcpy.p0.p0.i64(ptr align 4 %b2, ptr align 4 %b, i64 8, i1 false)
