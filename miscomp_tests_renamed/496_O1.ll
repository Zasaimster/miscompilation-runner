...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/147415225274459923738207029154220488245.c'
...
if.end48:                                         ; preds = %if.then38, %if.then25, %if.else
...
if.then:                                          ; preds = %if.else.i83, %entry, %lor.lhs.false3, %if.else.i39, %lor.lhs.false
