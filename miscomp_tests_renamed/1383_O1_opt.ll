; 187023097407123389026013936165246182806
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/187023097407123389026013936165246182806_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/187023097407123389026013936165246182806.c"
...
; Function Attrs: cold nofree noreturn nounwind uwtable
define dso_local void @link_failure() local_unnamed_addr #0 {
entry:
  tail call void @abort() #2
  unreachable
}
...
entry:
  %0 = load volatile i32, ptr @v, align 4, !tbaa !5
  tail call void @abort() #2
  unreachable
}
