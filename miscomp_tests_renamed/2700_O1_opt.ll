...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/16449326957583302683190733711560330905_O1.ll'
...
entry:
  ...
  %cmp.not = icmp eq i32 %y.coerce, 11
...
if.end:                                           ; preds = %entry
  %cmp4.not = icmp eq i32 %z.coerce, 12
