...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/178439111439462342295033110174392526011_O0.ll'
...
if.end:                                           ; preds = %if.then, %lor.lhs.false17
  ...
  %call21 = call i32 @memcmp(ptr noundef %6, ptr noundef @.str.1, i64 noundef 6) #6
