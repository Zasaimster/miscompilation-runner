...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/197954644089364423612826417967624217204_O1.ll'
...
entry:
  %call = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i64 0)
  ret i32 0
}
