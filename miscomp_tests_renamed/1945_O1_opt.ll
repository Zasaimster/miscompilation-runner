...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/134528960502300426281340526240382800481_O1.ll'
...
define dso_local i32 @f(ptr noundef readnone captures(none) %pdbl, double noundef %value) local_unnamed_addr #0 {
entry:
  store double %value, ptr @glob_dbl, align 8, !tbaa !5
  ret i32 undef
}
