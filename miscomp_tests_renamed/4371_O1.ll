; 103100987336799754593859387503662238151
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/103100987336799754593859387503662238151.c'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/103100987336799754593859387503662238151.c"
...
if.then:                                          ; preds = %for.body
  ...
  %call = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %2, i32 noundef %3) #2
  br label %if.end
...
for.body4:                                        ; preds = %if.end, %for.inc11
