...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/130116004066161954816523831040643365200_O1.ll'
...
for.body:                                         ; preds = %for.body, %entry
  ...
  %arrayidx = getelementptr inbounds nuw [20 x %struct.small], ptr getelementptr inbounds nuw (i8, ptr @x, i64 4), i64 0, i64 %indvars.iv
