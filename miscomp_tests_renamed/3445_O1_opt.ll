...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/199100349101084567899972317908452268715_O1.ll'
...
entry:
  %call.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i64 noundef undef)
  unreachable
}
