...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/165205851910114041151794065839167915493_O1.ll'
...
if.end55:                                         ; preds = %if.else46, %if.then36, %if.else16, %if.then11, %entry
...
if.end119:                                        ; preds = %if.else109, %if.then97, %if.else75, %if.then69, %if.end55
...
if.end183:                                        ; preds = %if.else173, %if.then161, %if.else139, %if.then133, %if.end119
...
if.end247:                                        ; preds = %if.else237, %if.then225, %if.else203, %if.then197, %if.end183
