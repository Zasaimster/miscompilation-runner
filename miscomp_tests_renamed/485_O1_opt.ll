...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/196298207274310813986036244642972742260_O1.ll'
...
foo.exit:                                         ; preds = %if.else.i, %if.then2.i, %entry
...
foo.exit41:                                       ; preds = %if.else.i35, %if.then.i33, %if.end
...
foo.exit54:                                       ; preds = %if.else.i48, %if.then2.i52, %if.end4
...
foo.exit67:                                       ; preds = %if.else.i61, %if.then2.i65, %if.end8
...
foo.exit80:                                       ; preds = %if.else.i74, %if.then2.i78, %if.end12
...
foo.exit93:                                       ; preds = %if.else.i87, %if.then.i85, %if.end16
...
foo.exit106:                                      ; preds = %if.else.i100, %if.then2.i104, %if.end20
...
foo.exit119:                                      ; preds = %if.else.i113, %if.then2.i117, %if.end24
