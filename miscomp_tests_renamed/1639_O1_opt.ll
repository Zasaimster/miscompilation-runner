...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/162048449451120321739317793589657742580_O1.ll'
...
entry:
  ...
  %call = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(2) @.str.1) #3
