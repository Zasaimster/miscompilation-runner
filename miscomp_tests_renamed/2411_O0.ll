...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/121208606590724369038288248278474961193.c'
...
entry:
  ...
  %0 = load i32, ptr %newDepth, align 4
  %1 = load i32, ptr %oldDepth, align 4
  %sub = sub nsw i32 %0, %1
...
sw.epilog:                                        ; preds = %sw.default, %sw.bb1, %sw.bb
  %3 = load i32, ptr %newDepth, align 4
  %4 = load i32, ptr %oldDepth, align 4
