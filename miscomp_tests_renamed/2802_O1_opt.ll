...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/149013210985783843192208127133483253285_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/149013210985783843192208127133483253285.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@array = dso_local local_unnamed_addr global [16 x i32] zeroinitializer, align 16
...
entry:
  ...
  %arrayidx2.i = getelementptr inbounds [16 x i32], ptr @array, i64 0, i64 %idxprom1.i
...
for.body:                                         ; preds = %for.inc, %for.body.preheader
  ...
  %arrayidx2 = getelementptr inbounds [16 x i32], ptr @array, i64 0, i64 %indvars.iv
...
if.then:                                          ; preds = %for.body
  ...
  %arrayidx2.i18 = getelementptr inbounds [16 x i32], ptr @array, i64 0, i64 %idxprom1.i17
  store i32 %2, ptr %arrayidx2.i18, align 4, !tbaa !5
...
for.end:                                          ; preds = %for.inc, %entry
  ...
  %arrayidx2.i22 = getelementptr inbounds [16 x i32], ptr @array, i64 0, i64 %idxprom1.i21
  store i32 %3, ptr %arrayidx2.i22, align 4, !tbaa !5
...
if.end:                                           ; preds = %tailrecurse
  ...
  %arrayidx.i = getelementptr inbounds [16 x i32], ptr @array, i64 0, i64 %idxprom.i
  %0 = load i32, ptr %arrayidx.i, align 4, !tbaa !5
  %idxprom1.i.i = sext i32 %right to i64
  %arrayidx2.i.i = getelementptr inbounds [16 x i32], ptr @array, i64 0, i64 %idxprom1.i.i
...
for.body.i:                                       ; preds = %for.inc.i, %if.end
  ...
  %arrayidx2.i = getelementptr inbounds [16 x i32], ptr @array, i64 0, i64 %indvars.iv.i
...
if.then.i:                                        ; preds = %for.body.i
  ...
  %arrayidx2.i18.i = getelementptr inbounds [16 x i32], ptr @array, i64 0, i64 %idxprom1.i17.i
  store i32 %1, ptr %arrayidx2.i18.i, align 4, !tbaa !5
...
partition.exit:                                   ; preds = %for.inc.i
  %2 = load i32, ptr %arrayidx2.i.i, align 4, !tbaa !5
  %idxprom1.i21.i = sext i32 %index.1.i to i64
  %arrayidx2.i22.i = getelementptr inbounds [16 x i32], ptr @array, i64 0, i64 %idxprom1.i21.i
  store i32 %2, ptr %arrayidx2.i22.i, align 4, !tbaa !5
...
for.body:                                         ; preds = %for.body, %entry
  ...
  %arrayidx = getelementptr inbounds nuw [16 x i32], ptr @array, i64 0, i64 %indvars.iv
  %0 = load i32, ptr %arrayidx, align 4, !tbaa !5
...
for.body4:                                        ; preds = %for.body4, %for.end
  ...
  %arrayidx6 = getelementptr inbounds nuw [16 x i32], ptr @array, i64 0, i64 %indvars.iv21
