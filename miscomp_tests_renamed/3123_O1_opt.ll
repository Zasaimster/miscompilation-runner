...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/175474511924019009649598118189100323346_O1.ll'
...
return:                                           ; preds = %sw.bb7, %sw.bb6, %sw.bb5, %sw.bb4, %sw.bb3, %sw.bb, %entry
...
if.then:                                          ; preds = %sw.bb.i, %entry, %entry, %entry, %entry, %entry
  tail call void @abort() #7
  unreachable

if.end:                                           ; preds = %sw.bb.i, %entry
