; 17541464961586441346665522149390913001
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/17541464961586441346665522149390913001_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/17541464961586441346665522149390913001.c"
...
if.then6:                                         ; preds = %if.end
  ...
  %call.i20 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %1)
  br label %if.end7
...
if.then14:                                        ; preds = %if.end7
  ...
  %call.i21 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %2)
  br label %if.end15
...
if.end3:                                          ; preds = %entry
  store i32 0, ptr @count, align 4, !tbaa !5
  %call.i20.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef 0)
  %1 = load i32, ptr @count, align 4, !tbaa !5
...
if.end6:                                          ; preds = %if.end3
  store i32 0, ptr @count, align 4, !tbaa !5
  %call.i21.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef 0)
  %2 = load i32, ptr @count, align 4, !tbaa !5
...
if.end9:                                          ; preds = %if.end6
  store i32 0, ptr @count, align 4, !tbaa !5
  %call.i.i22 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef 0)
  %3 = load i32, ptr @count, align 4, !tbaa !5
  %call.i20.i23 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %3)
...
if.end12:                                         ; preds = %if.end9
  store i32 0, ptr @count, align 4, !tbaa !5
  %call.i.i24 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef 0)
  %5 = load i32, ptr @count, align 4, !tbaa !5
  %call.i21.i25 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %5)
