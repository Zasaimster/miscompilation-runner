...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/191933807444542060558141338466997847928_O0.ll'
...
for.end:                                          ; preds = %for.cond
  %call2 = call i32 (ptr, ...) @printf(ptr noundef @.str, ptr noundef @.str.1, ptr noundef @.str.2)
  %call3 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, i32 noundef 65)
  %call4 = call i32 (ptr, ...) @printf(ptr noundef @.str.5, i32 noundef 97)
  ret i32 0
}
