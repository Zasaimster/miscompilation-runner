; 109377201348529704975138783710646168740
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/109377201348529704975138783710646168740_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/109377201348529704975138783710646168740.c"
...
do.body.i:                                        ; preds = %do.body.i, %entry
  ...
  %call1.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i64 noundef %timeout.0.i)
...
do.body.i23:                                      ; preds = %do.body.i23, %do.body.i18
  ...
  %call.i25 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i64 noundef %timeout.0.i24)
