...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/179525448685838153987509023085741521117_O0.ll'
...
@list = dso_local global [2 x ptr] [ptr inttoptr (i64 1 to ptr), ptr @.str], align 16
