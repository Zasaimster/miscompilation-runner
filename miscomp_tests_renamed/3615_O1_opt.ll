; 163038011499075174891472009191427234117
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/163038011499075174891472009191427234117_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/163038011499075174891472009191427234117.c"
...
bar.exit:                                         ; preds = %if.end.i, %if.then.i
  call void @llvm.memcpy.p0.p0.i64(ptr align 4 @h, ptr align 4 %tmp, i64 20, i1 true), !tbaa.struct !12
  ...
  %2 = load i32, ptr getelementptr inbounds nuw (i8, ptr @h, i64 4), align 4, !tbaa !13
