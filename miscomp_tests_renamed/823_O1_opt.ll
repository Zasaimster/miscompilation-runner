...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/13958120989567923896311575091775331899_O1.ll'
...
entry:
  ...
  %0 = load ptr, ptr @p1, align 8, !tbaa !10
  %m2 = getelementptr inbounds nuw i8, ptr %0, i64 8
  ...
  store ptr %incdec.ptr, ptr %arrayidx, align 8, !tbaa !14
  store ptr %2, ptr @p1, align 8, !tbaa !10
...
if.then:                                          ; preds = %entry
  ...
  store ptr @.str.1, ptr getelementptr inbounds nuw (i8, ptr @s1, i64 32), align 8, !tbaa !14
  %arrayidx4 = getelementptr inbounds nuw i8, ptr %2, i64 32
  %4 = load ptr, ptr %arrayidx4, align 8, !tbaa !14
  %incdec.ptr5 = getelementptr inbounds nuw i8, ptr %4, i64 1
  store ptr %incdec.ptr5, ptr %arrayidx4, align 8, !tbaa !14
  %call6 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %4) #6
