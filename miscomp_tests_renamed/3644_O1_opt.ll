; 135798891897979419009236141630293074240
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/135798891897979419009236141630293074240_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/135798891897979419009236141630293074240.c"
...
entry:
  ...
  %call4 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, i32 noundef 2)
  %call5 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.5, i32 noundef 0)
  %call6 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.6, i32 noundef 1)
  %call7 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.7, i32 noundef 2)
  ret i32 0
}
