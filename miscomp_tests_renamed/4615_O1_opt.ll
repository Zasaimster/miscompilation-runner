; 127470206383608234123380263761455747138
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/127470206383608234123380263761455747138_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/127470206383608234123380263761455747138.c"
...
define dso_local noundef i32 @foo(ptr noundef writeonly captures(none) initializes((4, 8)) %locp, i32 noundef %i, i32 noundef returned %str) local_unnamed_addr #1 {
entry:
