...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/111274523727250517296588782251200869687_O1.ll'
...
entry:
  ...
  %call.i8 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1)
  %0 = and i32 %call.i, 255
  %cmp = icmp ne i32 %0, 171
  %1 = and i32 %call.i8, 65535
  %cmp6 = icmp ne i32 %1, 4660
