; 105757553261778741143312054149968717699
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/105757553261778741143312054149968717699_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/105757553261778741143312054149968717699.c"
...
if.then:                                          ; preds = %entry
  store volatile i32 30, ptr @b, align 4, !tbaa !5
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  store i32 0, ptr @e, align 4, !tbaa !5
  %1 = load volatile i8, ptr @f, align 1, !tbaa !9
  %conv.le = sext i8 %1 to i16
