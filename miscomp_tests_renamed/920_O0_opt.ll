; 148704555805298343215891231867304217503
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/148704555805298343215891231867304217503_O0.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/148704555805298343215891231867304217503.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@x = dso_local global [5 x i32] [i32 0, i32 1, i32 2, i32 3, i32 4], align 16
...
for.body:                                         ; preds = %for.cond2
  ...
  %arrayidx = getelementptr inbounds [5 x i32], ptr @x, i64 0, i64 %idxprom
...
if.then:                                          ; preds = %for.body
  ...
  %arrayidx5 = getelementptr inbounds [5 x i32], ptr @x, i64 0, i64 %idxprom4
...
if.end8:                                          ; preds = %for.end
  ...
  %arrayidx10 = getelementptr inbounds [5 x i32], ptr @x, i64 0, i64 %idxprom9
