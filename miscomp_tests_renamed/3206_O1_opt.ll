...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/156103524588805023345598054631595584945_O1.ll'
...
entry:
  ...
  %call2 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef 12)
  ...
  %call6 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, i32 noundef %2)
  %3 = load i32, ptr getelementptr inbounds nuw (i8, ptr @bolshevic, i64 4), align 4, !tbaa !10
  %call8 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.5, i32 noundef %3)
  %4 = load i32, ptr getelementptr inbounds nuw (i8, ptr @bolshevic, i64 8), align 4, !tbaa !11
  %call10 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.6, i32 noundef %4)
  %5 = load i32, ptr getelementptr inbounds nuw (i8, ptr @bolshevic, i64 4), align 4, !tbaa !12
  %call11 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %5)
  ret i32 0
}
