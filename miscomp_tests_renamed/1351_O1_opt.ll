...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/193287861120852976443437070580725522122_O1.ll'
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %seqnum3 = getelementptr inbounds nuw i8, ptr %S2, i64 8
  %1 = load i32, ptr %seqnum3, align 8, !tbaa !5
  %add = add nsw i32 %1, %0
  %seqnum4 = getelementptr inbounds nuw i8, ptr %S3, i64 8
  %2 = load i32, ptr %seqnum4, align 8, !tbaa !5
...
AddCounts.exit:                                   ; preds = %if.then.i, %entry
  ...
  %add5.i = add nsw i32 %add.i, %3
  %call5 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %add5.i)
...
testAllocaOrder.exit:                             ; preds = %if.then.i.i, %for.body
  ...
  %add5.i.i = add nsw i32 %add.i.i, %4
  %call5.i = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %add5.i.i)
