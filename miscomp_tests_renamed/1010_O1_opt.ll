; 161165431040948003349081421841747659996
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/161165431040948003349081421841747659996_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/161165431040948003349081421841747659996.c"
...
entry:
  ...
  %cmp.not = icmp eq i16 %x.sroa.1.0.extract.shift.mask, 5120
...
if.end6:                                          ; preds = %if.end
  ...
  %cmp9.not = icmp eq i16 %y.sroa.2.0.extract.shift.mask, 5376
...
if.end18:                                         ; preds = %if.end12
  ...
  %cmp21.not = icmp eq i16 %z.sroa.2.0.extract.shift.mask, 5632
