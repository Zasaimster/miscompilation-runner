...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/128286557027077444594793620203575529763_O1.ll'
...
entry:
  %0 = load i32, ptr @b, align 4, !tbaa !5
  %cmp.not9 = icmp eq i32 %0, -20
  br i1 %cmp.not9, label %for.cond.cleanup, label %for.body.lr.ph
