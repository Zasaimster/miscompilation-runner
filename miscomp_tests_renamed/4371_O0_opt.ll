...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/103100987336799754593859387503662238151_O0.ll'
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %call = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %3, i32 noundef %4) #2
  br label %if.end
