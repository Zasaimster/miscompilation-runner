...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/15888894497742609901902911882478931847_O1.ll'
...
define dso_local noundef i32 @foo(i32 noundef %h) local_unnamed_addr #0 {
entry:
...
for.body.lr.ph:                                   ; preds = %entry
  %1 = load ptr, ptr @e, align 8, !tbaa !14
  %2 = load ptr, ptr @g, align 8, !tbaa !9
  br label %for.body

for.body:                                         ; preds = %for.body, %for.body.lr.ph
  %3 = load volatile i64, ptr @f, align 8, !tbaa !12
  store i32 0, ptr %1, align 4, !tbaa !5
  %4 = load i32, ptr @b, align 4, !tbaa !5
  %conv.i = sext i32 %4 to i64
  store i64 %conv.i, ptr %2, align 8, !tbaa !12
  store i32 0, ptr %1, align 4, !tbaa !5
