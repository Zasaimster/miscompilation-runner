...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/116618826465011756398493503419348582306_O1.ll'
...
while.body.i:                                     ; preds = %while.body.i, %entry
  %s.addr.04.i.idx = phi i64 [ %s.addr.04.i.add, %while.body.i ], [ 0, %entry ]
  %s.addr.04.i.add = add nuw nsw i64 %s.addr.04.i.idx, 1
  %incdec.ptr.i.ptr = getelementptr inbounds nuw i8, ptr @.str, i64 %s.addr.04.i.add
  %6 = load i8, ptr %incdec.ptr.i.ptr, align 1, !tbaa !5
  store volatile i8 %6, ptr @v, align 1, !tbaa !5
  %exitcond = icmp eq i64 %s.addr.04.i.add, 2
