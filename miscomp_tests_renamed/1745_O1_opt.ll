; 131040306834603712333882581822886813622
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/131040306834603712333882581822886813622_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/131040306834603712333882581822886813622.c"
...
entry:
  %.not = icmp eq i32 %x, 0
  br i1 %.not, label %cleanup, label %for.cond.preheader
