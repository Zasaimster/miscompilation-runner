...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/165032595752991546362664041298529376374_O1.ll'
...
entry:
  ...
  %call7 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef 0)
  %cmp8 = icmp slt i32 %call7, %n
...
entry:
  %call7.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef 0)
  %cmp8.i = icmp slt i32 %call7.i, 5
  br i1 %cmp8.i, label %for.body.i, label %if.then
...
for.body.i:                                       ; preds = %for.body.i, %entry
  ...
  %1 = trunc nuw nsw i64 %indvars.iv.next.i to i32
