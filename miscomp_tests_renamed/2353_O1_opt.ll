; 14081595518496277213519199053905868098
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/14081595518496277213519199053905868098_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/14081595518496277213519199053905868098.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@array = dso_local local_unnamed_addr global [1 x i32] zeroinitializer, align 4
...
entry:
  ...
  %arrayidx = getelementptr inbounds [1 x i32], ptr @array, i64 0, i64 %idxprom
  %0 = load i32, ptr %arrayidx, align 4, !tbaa !5
  %idxprom1 = sext i32 %a to i64
  %arrayidx2 = getelementptr inbounds [1 x i32], ptr @array, i64 0, i64 %idxprom1
...
entry:
  ...
  %arrayidx.i = getelementptr inbounds [1 x i32], ptr @array, i64 0, i64 %idxprom.i
...
for.body:                                         ; preds = %for.inc, %for.body.preheader
  ...
  %arrayidx2 = getelementptr inbounds [1 x i32], ptr @array, i64 0, i64 %indvars.iv
...
if.then:                                          ; preds = %for.body
  ...
  %arrayidx.i16 = getelementptr inbounds [1 x i32], ptr @array, i64 0, i64 %idxprom.i15
  %4 = load i32, ptr %arrayidx.i16, align 4, !tbaa !5
  store i32 %4, ptr %arrayidx2, align 4, !tbaa !5
  store i32 2, ptr %arrayidx.i16, align 4, !tbaa !5
...
for.end:                                          ; preds = %for.inc, %entry
  ...
  %arrayidx.i20 = getelementptr inbounds [1 x i32], ptr @array, i64 0, i64 %idxprom.i19
  %5 = load i32, ptr %arrayidx.i20, align 4, !tbaa !5
  store i32 %5, ptr %arrayidx.i, align 4, !tbaa !5
  store i32 2, ptr %arrayidx.i20, align 4, !tbaa !5
...
if.end:                                           ; preds = %tailrecurse
  ...
  %arrayidx.i.i = getelementptr inbounds [1 x i32], ptr @array, i64 0, i64 %idxprom.i.i
...
for.body.i:                                       ; preds = %for.inc.i, %if.end
  ...
  %arrayidx2.i = getelementptr inbounds [1 x i32], ptr @array, i64 0, i64 %indvars.iv.i
...
if.then.i:                                        ; preds = %for.body.i
  ...
  %arrayidx.i16.i = getelementptr inbounds [1 x i32], ptr @array, i64 0, i64 %idxprom.i15.i
  %3 = load i32, ptr %arrayidx.i16.i, align 4, !tbaa !5
  store i32 %3, ptr %arrayidx2.i, align 4, !tbaa !5
  store i32 2, ptr %arrayidx.i16.i, align 4, !tbaa !5
...
partition.exit:                                   ; preds = %for.inc.i
  ...
  %arrayidx.i20.i = getelementptr inbounds [1 x i32], ptr @array, i64 0, i64 %idxprom.i19.i
  %4 = load i32, ptr %arrayidx.i20.i, align 4, !tbaa !5
  store i32 %4, ptr %arrayidx.i.i, align 4, !tbaa !5
  store i32 2, ptr %arrayidx.i20.i, align 4, !tbaa !5
...
for.body:                                         ; preds = %for.body, %entry
  ...
  %arrayidx = getelementptr inbounds nuw [1 x i32], ptr @array, i64 0, i64 %indvars.iv
  %0 = load i32, ptr %arrayidx, align 4, !tbaa !5
...
for.body4:                                        ; preds = %for.body4, %for.end
  ...
  %arrayidx6 = getelementptr inbounds nuw [1 x i32], ptr @array, i64 0, i64 %indvars.iv21
