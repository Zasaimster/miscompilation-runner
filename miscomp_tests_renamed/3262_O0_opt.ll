; 157028642617503319030117863433165546291
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/157028642617503319030117863433165546291_O0.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/157028642617503319030117863433165546291.c"
...
entry:
  ...
  %vla = alloca [0 x [8 x [2 x float]]], i64 %1, align 16
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %arrayidx = getelementptr inbounds [0 x [8 x [2 x float]]], ptr %vla, i64 %idxprom
...
if.else:                                          ; preds = %land.lhs.true, %for.body9
  ...
  %arrayidx19 = getelementptr inbounds [0 x [8 x [2 x float]]], ptr %vla, i64 %idxprom18
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  %arrayidx27 = getelementptr inbounds [0 x [8 x [2 x float]]], ptr %vla, i64 %idxprom26
