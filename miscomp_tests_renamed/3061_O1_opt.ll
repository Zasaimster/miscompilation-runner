...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/153708575404676234186830953604706252970_O1.ll'
...
define dso_local i64 @foo(i32 noundef %x, ptr noundef readonly captures(none) %y) local_unnamed_addr #1 {
entry:
  %x.off = add i32 %x, -10
