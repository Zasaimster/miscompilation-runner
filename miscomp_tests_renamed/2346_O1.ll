; 140770247181126235924735071081397709937
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/140770247181126235924735071081397709937.c'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/140770247181126235924735071081397709937.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.epic_private = type { ptr, [100 x i32] }
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 408, ptr nonnull %ep) #4
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %arrayidx2 = getelementptr inbounds nuw [100 x i32], ptr %rx_skbuff, i64 0, i64 %indvars.iv
...
if.end:                                           ; preds = %for.body6
  %arrayidx15 = getelementptr inbounds nuw [100 x i32], ptr %rx_skbuff.i, i64 0, i64 %indvars.iv33
...
for.end21:                                        ; preds = %for.cond4
  ...
  call void @llvm.lifetime.end.p0(i64 408, ptr nonnull %ep) #4
  ret i32 0
}
