...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/137834638491511568630698027034178448528_O1.ll'
...
bar.exit:                                         ; preds = %if.else.i, %lor.lhs.false.i
  %1 = load i32, ptr @s, align 4, !tbaa !5
  %xor.i = xor i32 %1, 1
...
bar.exit46:                                       ; preds = %if.else.i28, %lor.lhs.false.i42
