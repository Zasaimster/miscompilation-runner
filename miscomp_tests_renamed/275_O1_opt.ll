; 104730859454897909490499564178001015097
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/104730859454897909490499564178001015097_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/104730859454897909490499564178001015097.c"
...
entry:
  store ptr inttoptr (i64 42 to ptr), ptr %q, align 8, !tbaa !5
  ret void
}
...
entry:
  store i32 42, ptr inttoptr (i64 42 to ptr), align 4, !tbaa !10
  ret void
}
...
entry:
  store i32 42, ptr inttoptr (i64 42 to ptr), align 4, !tbaa !10
  %0 = load i32, ptr @glob, align 4, !tbaa !10
