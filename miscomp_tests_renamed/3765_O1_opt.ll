; 165797574034156736688376009055262114027
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/165797574034156736688376009055262114027_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/165797574034156736688376009055262114027.c"
...
entry:
  ...
  store i32 100, ptr %x, align 4, !tbaa !5
  %cmp = icmp eq i32 %a, 0
...
if.end:                                           ; preds = %entry
  %sub = add nsw i32 %a, -1
  %call = call i32 @f(i32 noundef %sub, ptr noundef nonnull %x)
  br label %cleanup
