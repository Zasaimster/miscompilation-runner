; 138835704365986126209896293502629799824
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/138835704365986126209896293502629799824_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/138835704365986126209896293502629799824.c"
...
entry:
  ...
  store i32 %call, ptr getelementptr inbounds nuw (i8, ptr @foo, i64 8), align 4, !tbaa !5
  %call1 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1)
  store i32 %call1, ptr getelementptr inbounds nuw (i8, ptr @foo, i64 4), align 4, !tbaa !8
  %0 = load i32, ptr getelementptr inbounds nuw (i8, ptr @foo, i64 8), align 4, !tbaa !5
