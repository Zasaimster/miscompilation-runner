...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/193029876756169075556046368029923844845_O1.ll'
...
define dso_local noundef i32 @f(ptr noundef readnone captures(none) %ps) local_unnamed_addr #0 {
entry:
  ret i32 0
}
