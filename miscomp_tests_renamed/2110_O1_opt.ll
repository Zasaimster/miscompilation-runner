...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/137234115113643132639265893884828123205_O1.ll'
...
if.end:                                           ; preds = %entry
  %2 = load ptr, ptr getelementptr inbounds nuw (i8, ptr @i, i64 8), align 8, !tbaa !16
  %s_blocksize_bits = getelementptr inbounds nuw i8, ptr %2, i64 4
...
define internal fastcc void @isofs_bread(i32 noundef %block) unnamed_addr #3 {
entry:
