; 123444753563639191904175500102676959379
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/123444753563639191904175500102676959379.c'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/123444753563639191904175500102676959379.c"
...
return:                                           ; preds = %if.end3, %if.end, %entry
  %retval.0 = phi i64 [ %x, %entry ], [ %rem, %if.end3 ], [ %y.addr.013, %if.end ]
  ret i64 %retval.0
}
...
if.end.i:                                         ; preds = %if.then13, %if.end3.i
  %y.addr.013.i = phi i64 [ %rem4.i, %if.end3.i ], [ %t.addr.0108, %if.then13 ]
  %x.addr.012.i = phi i64 [ %rem.i100, %if.end3.i ], [ %rem, %if.then13 ]
  %rem.i100 = urem i64 %x.addr.012.i, %y.addr.013.i
  %cmp1.i = icmp eq i64 %rem.i100, 0
  br i1 %cmp1.i, label %gcd_ll.exit, label %if.end3.i

if.end3.i:                                        ; preds = %if.end.i
  %rem4.i = urem i64 %y.addr.013.i, %rem.i100
  %cmp.i101 = icmp eq i64 %rem4.i, 0
  br i1 %cmp.i101, label %gcd_ll.exit, label %if.end.i, !llvm.loop !5

gcd_ll.exit:                                      ; preds = %if.end.i, %if.end3.i
  %retval.0.i102 = phi i64 [ %rem.i100, %if.end3.i ], [ %y.addr.013.i, %if.end.i ]
