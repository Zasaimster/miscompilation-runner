...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/11672838361356003647014911786919974670_O0.ll'
...
entry:
  ...
  store i32 %lnot.ext, ptr @y, align 4
  br label %do.body
...
do.cond:                                          ; preds = %do.body
  ...
  %cmp2 = icmp sge i32 %sub1, 20
  %lnot3 = xor i1 %cmp2, true
  br i1 %lnot3, label %do.body, label %do.end, !llvm.loop !6
