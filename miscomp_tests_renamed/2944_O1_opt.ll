; 165838485922561484883842361995105717584
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/165838485922561484883842361995105717584_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/165838485922561484883842361995105717584.c"
...
entry:
  ...
  %arrayidx2 = getelementptr inbounds [0 x i32], ptr @array, i64 0, i64 %idxprom1
...
entry:
  ...
  %arrayidx = getelementptr inbounds [0 x i32], ptr @array, i64 0, i64 %idxprom
  %0 = load i32, ptr %arrayidx, align 4, !tbaa !5
  %idxprom1.i = sext i32 %right to i64
  %arrayidx2.i = getelementptr inbounds [0 x i32], ptr @array, i64 0, i64 %idxprom1.i
  %1 = load i32, ptr %arrayidx2.i, align 4, !tbaa !5
  store i32 %1, ptr %arrayidx, align 4, !tbaa !5
  store i32 %0, ptr %arrayidx2.i, align 4, !tbaa !5
...
for.body:                                         ; preds = %for.inc, %for.body.preheader
  ...
  %arrayidx2 = getelementptr inbounds [0 x i32], ptr @array, i64 0, i64 %indvars.iv
  %3 = load i32, ptr %arrayidx2, align 4, !tbaa !5
  %cmp3 = icmp slt i32 %3, %0
  br i1 %cmp3, label %if.then, label %for.inc

if.then:                                          ; preds = %for.body
  %idxprom1.i17 = sext i32 %index.024 to i64
  %arrayidx2.i18 = getelementptr inbounds [0 x i32], ptr @array, i64 0, i64 %idxprom1.i17
  %4 = load i32, ptr %arrayidx2.i18, align 4, !tbaa !5
  store i32 %4, ptr %arrayidx2, align 4, !tbaa !5
  store i32 %3, ptr %arrayidx2.i18, align 4, !tbaa !5
...
for.end:                                          ; preds = %for.inc, %entry
  ...
  %idxprom1.i21 = sext i32 %index.0.lcssa to i64
  %arrayidx2.i22 = getelementptr inbounds [0 x i32], ptr @array, i64 0, i64 %idxprom1.i21
  %5 = load i32, ptr %arrayidx2.i22, align 4, !tbaa !5
  store i32 %5, ptr %arrayidx2.i, align 4, !tbaa !5
  store i32 %0, ptr %arrayidx2.i22, align 4, !tbaa !5
...
if.end:                                           ; preds = %tailrecurse
  ...
  %arrayidx.i = getelementptr inbounds [0 x i32], ptr @array, i64 0, i64 %idxprom.i
  %0 = load i32, ptr %arrayidx.i, align 4, !tbaa !5
  %idxprom1.i.i = sext i32 %right to i64
  %arrayidx2.i.i = getelementptr inbounds [0 x i32], ptr @array, i64 0, i64 %idxprom1.i.i
  %1 = load i32, ptr %arrayidx2.i.i, align 4, !tbaa !5
  store i32 %1, ptr %arrayidx.i, align 4, !tbaa !5
  store i32 %0, ptr %arrayidx2.i.i, align 4, !tbaa !5
  br label %for.body.i
...
for.body.i:                                       ; preds = %for.inc.i, %if.end
  ...
  %arrayidx2.i = getelementptr inbounds [0 x i32], ptr @array, i64 0, i64 %indvars.iv.i
  %2 = load i32, ptr %arrayidx2.i, align 4, !tbaa !5
  %cmp3.i = icmp slt i32 %2, %0
  br i1 %cmp3.i, label %if.then.i, label %for.inc.i

if.then.i:                                        ; preds = %for.body.i
  %idxprom1.i17.i = sext i32 %index.024.i to i64
  %arrayidx2.i18.i = getelementptr inbounds [0 x i32], ptr @array, i64 0, i64 %idxprom1.i17.i
  %3 = load i32, ptr %arrayidx2.i18.i, align 4, !tbaa !5
  store i32 %3, ptr %arrayidx2.i, align 4, !tbaa !5
  store i32 %2, ptr %arrayidx2.i18.i, align 4, !tbaa !5
...
for.inc.i:                                        ; preds = %if.then.i, %for.body.i
  ...
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, %idxprom1.i.i
  br i1 %exitcond.not.i, label %partition.exit, label %for.body.i, !llvm.loop !9

partition.exit:                                   ; preds = %for.inc.i
  %idxprom1.i21.i = sext i32 %index.1.i to i64
  %arrayidx2.i22.i = getelementptr inbounds [0 x i32], ptr @array, i64 0, i64 %idxprom1.i21.i
  %4 = load i32, ptr %arrayidx2.i22.i, align 4, !tbaa !5
  store i32 %4, ptr %arrayidx2.i.i, align 4, !tbaa !5
  store i32 %0, ptr %arrayidx2.i22.i, align 4, !tbaa !5
...
entry:
  store i32 62, ptr @array, align 4, !tbaa !5
  store i32 83, ptr getelementptr inbounds nuw (i8, ptr @array, i64 4), align 4, !tbaa !5
  store i32 4, ptr getelementptr inbounds nuw (i8, ptr @array, i64 8), align 4, !tbaa !5
  store i32 89, ptr getelementptr inbounds nuw (i8, ptr @array, i64 12), align 4, !tbaa !5
  store i32 36, ptr getelementptr inbounds nuw (i8, ptr @array, i64 16), align 4, !tbaa !5
  store i32 21, ptr getelementptr inbounds nuw (i8, ptr @array, i64 20), align 4, !tbaa !5
  store i32 74, ptr getelementptr inbounds nuw (i8, ptr @array, i64 24), align 4, !tbaa !5
  store i32 37, ptr getelementptr inbounds nuw (i8, ptr @array, i64 28), align 4, !tbaa !5
  store i32 65, ptr getelementptr inbounds nuw (i8, ptr @array, i64 32), align 4, !tbaa !5
  store i32 33, ptr getelementptr inbounds nuw (i8, ptr @array, i64 36), align 4, !tbaa !5
  store i32 96, ptr getelementptr inbounds nuw (i8, ptr @array, i64 40), align 4, !tbaa !5
  store i32 38, ptr getelementptr inbounds nuw (i8, ptr @array, i64 44), align 4, !tbaa !5
  store i32 53, ptr getelementptr inbounds nuw (i8, ptr @array, i64 48), align 4, !tbaa !5
  store i32 16, ptr getelementptr inbounds nuw (i8, ptr @array, i64 52), align 4, !tbaa !5
  store i32 74, ptr getelementptr inbounds nuw (i8, ptr @array, i64 56), align 4, !tbaa !5
  store i32 55, ptr getelementptr inbounds nuw (i8, ptr @array, i64 60), align 4, !tbaa !5
  br label %for.body

for.body:                                         ; preds = %for.body, %entry
  %indvars.iv = phi i64 [ 0, %entry ], [ %indvars.iv.next, %for.body ]
  %arrayidx = getelementptr inbounds nuw [0 x i32], ptr @array, i64 0, i64 %indvars.iv
  %0 = load i32, ptr %arrayidx, align 4, !tbaa !5
...
for.body4:                                        ; preds = %for.body4, %for.end
  ...
  %arrayidx6 = getelementptr inbounds nuw [0 x i32], ptr @array, i64 0, i64 %indvars.iv21
