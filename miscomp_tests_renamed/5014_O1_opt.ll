; 130773170826172619427231526623471214108
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/130773170826172619427231526623471214108_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/130773170826172619427231526623471214108.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@bytes = dso_local local_unnamed_addr global [0 x i8] zeroinitializer, align 1
...
while.body:                                       ; preds = %while.body, %while.body.preheader
  ...
  %conv = and i8 %0, 127
  %arrayidx = getelementptr inbounds nuw [0 x i8], ptr @bytes, i64 0, i64 %indvars.iv
...
while.body.i:                                     ; preds = %while.body.i, %entry
  ...
  %conv.i = and i8 %0, 127
  %arrayidx.i = getelementptr inbounds nuw [0 x i8], ptr @bytes, i64 0, i64 %indvars.iv.i
...
add_unwind_adjustsp.exit:                         ; preds = %while.body.i
  ...
  %cmp.not = icmp eq i8 %1, -120
  br i1 %cmp.not, label %lor.lhs.false, label %if.then

lor.lhs.false:                                    ; preds = %add_unwind_adjustsp.exit
  %2 = load i8, ptr getelementptr inbounds nuw (i8, ptr @bytes, i64 1), align 1, !tbaa !5
  %cmp3.not = icmp eq i8 %2, 7
  br i1 %cmp3.not, label %if.end, label %if.then

if.then:                                          ; preds = %lor.lhs.false, %add_unwind_adjustsp.exit
