...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/115419153249169556322627613869165187266_O1.ll'
...
if.end4:                                          ; preds = %cond.true.i20, %if.end
...
if.end8:                                          ; preds = %cond.true.i26, %if.end4
...
if.then11:                                        ; preds = %cond.true.i32, %if.end8
  tail call void @abort() #5
  unreachable
...
if.then15:                                        ; preds = %cond.true.i38, %if.end12
  tail call void @abort() #5
  unreachable
