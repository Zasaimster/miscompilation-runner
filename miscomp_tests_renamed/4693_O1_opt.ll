; 175451613242345705900502578769875086217
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/175451613242345705900502578769875086217_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/175451613242345705900502578769875086217.c"
...
entry:
  store i32 10, ptr getelementptr inbounds nuw (i8, ptr @a, i64 4), align 4, !tbaa !5
  %0 = load i32, ptr @b, align 4, !tbaa !11
  %1 = tail call i32 @llvm.smin.i32(i32 %0, i32 11)
  %cond = add nsw i32 %1, -1
  store i32 %cond, ptr getelementptr inbounds nuw (i8, ptr @a, i64 4), align 4, !tbaa !5
  %cmp3.not = icmp sgt i32 %0, 11
