; 185637082393107050659144297654196309419
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/185637082393107050659144297654196309419_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/185637082393107050659144297654196309419.c"
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 14, ptr nonnull %s) #7
  ...
  %add.ptr = getelementptr inbounds nuw i8, ptr %s, i64 12
  br label %while.cond
...
if.end:                                           ; preds = %while.end
  call void @llvm.lifetime.end.p0(i64 14, ptr nonnull %s) #7
  ret i32 undef
}
