; 146171525347211814430850918238375964489
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/146171525347211814430850918238375964489_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/146171525347211814430850918238375964489.c"
...
if.end:                                           ; preds = %entry
  %call3.i40 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %buf, ptr noundef nonnull dereferenceable(1) @.str.1, i64 noundef 305419895) #8
