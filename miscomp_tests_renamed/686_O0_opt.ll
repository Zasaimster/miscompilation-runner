...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/150745116681559876909823844652090749624_O0.ll'
...
entry:
  ...
  %i1 = getelementptr inbounds nuw %struct.foo, ptr %1, i32 0, i32 0
  %2 = load i32, ptr %i1, align 8
  %cmp = icmp ne i32 %0, %2
