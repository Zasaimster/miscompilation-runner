...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/104666141095689956435865759427645982320_O1.ll'
...
entry:
  ...
  %conv4 = zext i8 %a.0.a.0.a.0.a.0. to i32
  %mul.neg.neg = mul i32 %conv4, -2147483647
  %sub5.neg = add i32 %mul.neg.neg, %call1
  %cmp.not = icmp eq i32 %sub5.neg, 1
