; 128073309234200251794223580405203730914
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/128073309234200251794223580405203730914_O0.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/128073309234200251794223580405203730914.c"
...
if.else:                                          ; preds = %entry
  ...
  %sub = sub nsw i32 %1, 1
  %call2 = call i32 @factorial(i32 noundef %sub)
  %mul = mul nsw i32 %0, %call2
