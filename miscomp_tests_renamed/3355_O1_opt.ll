...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/158589233045314678786619663233767088930_O1.ll'
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 0, ptr nonnull %a) #4
  ...
  call void @llvm.lifetime.end.p0(i64 0, ptr nonnull %a) #4
  ret i32 0
}
