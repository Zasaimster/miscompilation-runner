...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/114292074127240903158888956625366698827_O1.ll'
...
if.end:                                           ; preds = %entry
  %call1 = tail call i32 (i32, i32, ...) @show(i32 noundef 10, i32 noundef 20) #5
  %not = xor i32 %shl, -1
...
if.end.i:                                         ; preds = %entry
  %call1.i = tail call i32 (i32, i32, ...) @show(i32 noundef 10, i32 noundef 20) #5
  br label %if.end
