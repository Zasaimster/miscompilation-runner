...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/163983654217894593163976693329473197790_O0.ll'
...
if.end:                                           ; preds = %entry
  ...
  %call1 = call i32 @strcmp(ptr noundef %3, ptr noundef @.str) #3
...
if.else:                                          ; preds = %if.end
  ...
  %call4 = call i32 @strcmp(ptr noundef %4, ptr noundef @.str.1) #3
