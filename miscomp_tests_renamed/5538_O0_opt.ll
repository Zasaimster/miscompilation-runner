...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/198038331738719826907824668107978435749_O0.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [13 x i32], ptr @ops, i64 0, i64 %idxprom
  %3 = load i32, ptr %arrayidx, align 4
  %4 = load i32, ptr %i, align 4
  %idxprom1 = sext i32 %4 to i64
  %arrayidx2 = getelementptr inbounds [13 x i32], ptr @correct, i64 0, i64 %idxprom1
