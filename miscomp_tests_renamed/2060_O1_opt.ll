; 136436817137501655193309190665384177716
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/136436817137501655193309190665384177716_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/136436817137501655193309190665384177716.c"
...
entry:
  %call = tail call i32 (...) @testFunction() #6
...
while.body:                                       ; preds = %while.body, %entry
  ...
  %foo.05 = phi i32 [ %sub, %while.body ], [ %call, %entry ]
...
while.body.i:                                     ; preds = %while.body.i, %while.body.i.preheader
  ...
  %foo.05.i = phi i32 [ %sub.i, %while.body.i ], [ %call.i, %while.body.i.preheader ]
