; 148009714196546163452943143060170863343
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/148009714196546163452943143060170863343_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/148009714196546163452943143060170863343.c"
...
define dso_local void @foo(i32 noundef %a, ptr noundef readnone captures(none) %b, i32 noundef %c, ptr noundef readnone captures(none) %d) local_unnamed_addr #0 {
entry:
  %puts = tail call i32 @puts(ptr nonnull dereferenceable(1) @str)
  %puts3 = tail call i32 @puts(ptr nonnull dereferenceable(1) @str.2)
  %cmp = icmp ne i32 %a, 2
  %cmp2 = icmp ne i32 %c, 2
