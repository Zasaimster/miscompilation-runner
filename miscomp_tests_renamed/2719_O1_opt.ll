; 126042793303121590007910452984726520459
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/126042793303121590007910452984726520459_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/126042793303121590007910452984726520459.c"
...
entry:
  ...
  %spec.store.select = select i1 %or.cond, i32 42, i32 1
  store i32 %spec.store.select, ptr @errflag, align 4
  ret i64 0
}
...
entry:
  store i32 42, ptr @errflag, align 4
