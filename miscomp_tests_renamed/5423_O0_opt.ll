; 12077414949917592060295647369676645892
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/12077414949917592060295647369676645892_O0.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/12077414949917592060295647369676645892.c"
...
if.end:                                           ; preds = %entry
  ...
  %exp2 = getelementptr inbounds nuw %struct.sreal, ptr %4, i32 0, i32 1
  %5 = load i32, ptr %exp2, align 4
  %6 = load ptr, ptr %b.addr, align 8
  %exp3 = getelementptr inbounds nuw %struct.sreal, ptr %6, i32 0, i32 1
  %7 = load i32, ptr %exp3, align 4
...
if.end6:                                          ; preds = %if.end
  ...
  %sig = getelementptr inbounds nuw %struct.sreal, ptr %8, i32 0, i32 0
