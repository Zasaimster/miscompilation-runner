; 139705921725009572755666574798984624615
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/139705921725009572755666574798984624615.c'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/139705921725009572755666574798984624615.c"
...
define dso_local i64 @powmod_ll(i64 noundef %b, i32 noundef %e, i64 noundef %m) local_unnamed_addr #2 {
entry:
...
gcd_ll.exit:                                      ; preds = %if.end.i, %if.end5.i, %if.then13
  %retval.0.i102 = phi i64 [ %rem, %if.then13 ], [ %rem.i100, %if.end5.i ], [ %y.addr.013.i, %if.end.i ]
