...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/136454379134421811889738789124032513625_O0.ll'
...
entry:
  ...
  store i32 1, ptr getelementptr inbounds ([0 x i32], ptr @a, i64 0, i64 12), align 4
...
for.body6:                                        ; preds = %for.cond4
  %3 = load i32, ptr getelementptr inbounds ([0 x i32], ptr @a, i64 0, i64 12), align 4
...
for.body14:                                       ; preds = %for.cond11
  ...
  %arrayidx = getelementptr inbounds [0 x i32], ptr @a, i64 0, i64 %idxprom
  %10 = load i32, ptr %arrayidx, align 4
  %11 = load i32, ptr %d, align 4
  %idxprom15 = sext i32 %11 to i64
  %arrayidx16 = getelementptr inbounds [0 x i32], ptr @a, i64 0, i64 %idxprom15
