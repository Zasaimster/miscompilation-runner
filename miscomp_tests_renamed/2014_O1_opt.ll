...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/135726979936161002755725503149827756991_O1.ll'
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ep) #4
...
for.body:                                         ; preds = %for.body, %entry
  ...
  %arrayidx2 = getelementptr inbounds nuw [1 x i32], ptr %rx_skbuff, i64 0, i64 %indvars.iv
...
for.end:                                          ; preds = %for.body
  ...
  %scevgep = getelementptr inbounds nuw i8, ptr %ep, i64 16
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(12) %scevgep, i8 0, i64 12, i1 false), !tbaa !10
  br label %for.body.i

for.body.i:                                       ; preds = %for.body.i, %for.end
  %indvars.iv.i = phi i64 [ 2, %for.end ], [ %indvars.iv.next.i, %for.body.i ]
...
if.end:                                           ; preds = %for.body6
  %arrayidx15 = getelementptr inbounds nuw [1 x i32], ptr %rx_skbuff.i, i64 0, i64 %indvars.iv33
...
for.end21:                                        ; preds = %for.cond4
  ...
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ep) #4
  ret i32 0
}
