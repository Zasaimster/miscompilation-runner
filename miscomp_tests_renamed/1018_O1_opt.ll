...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/101405570144715978719957840804110450157_O1.ll'
...
@sx = dso_local local_unnamed_addr global i16 0, align 2
...
if.end10:                                         ; preds = %if.end
  %2 = load i16, ptr @sx, align 2, !tbaa !8
  %.off62 = add i16 %2, -12
...
if.end26:                                         ; preds = %if.end18
  %4 = load i32, ptr @ix, align 4, !tbaa !10
  %.off63 = add i32 %4, -18
...
if.end36:                                         ; preds = %if.end31
  %5 = load i64, ptr @lx, align 8, !tbaa !12
  %.off64 = add i64 %5, -24
...
if.end46:                                         ; preds = %if.end41
  %6 = load i64, ptr @Lx, align 8, !tbaa !14
  %.off65 = add i64 %6, -30
