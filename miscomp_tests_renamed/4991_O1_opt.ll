; 14218288522695188654983050137898342195
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/14218288522695188654983050137898342195_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/14218288522695188654983050137898342195.c"
...
for.body:                                         ; preds = %for.body, %for.body.lr.ph
  ...
  %i.027 = phi i32 [ %inc, %for.body.lr.ph ], [ %inc16, %for.body ]
  ...
  %add.i = add i16 %4, %3
  %inc16 = add nsw i32 %i.027, 1
  %exitcond.not = icmp eq i32 %inc16, 4
...
for.body.i:                                       ; preds = %for.body.i, %entry
  ...
  %i.027.i = phi i32 [ 1, %entry ], [ %inc16.i, %for.body.i ]
  ...
  %add.i.i = add i16 %3, %2
  %inc16.i = add nuw nsw i32 %i.027.i, 1
