; 12883980977579126158994329233460736140
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/12883980977579126158994329233460736140_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/12883980977579126158994329233460736140.c"
...
define dso_local range(i64 42949672960, 47244640256) i64 @build(i64 noundef %h, i64 noundef %l) local_unnamed_addr #0 {
entry:
  store i64 42949672960, ptr @hpart, align 8, !tbaa !5
  %and = and i64 %l, 4294967295
  store i64 %and, ptr @lpart, align 8, !tbaa !5
  %or = or disjoint i64 %and, 42949672960
...
entry:
  ...
  store i64 42949672961, ptr @back, align 8, !tbaa !5
