; 185157198866871177433888602868976321361
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/185157198866871177433888602868976321361_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/185157198866871177433888602868976321361.c"
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %mat) #4
  store i32 1, ptr %mat, align 4, !tbaa !5
...
for.end:                                          ; preds = %for.body
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %mat) #4
  ret i32 %add
}
...
entry:
  %mat.i = alloca [2 x [1 x i32]], align 4
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %mat.i) #4
  store i32 1, ptr %mat.i, align 4, !tbaa !5
...
foo.exit:                                         ; preds = %for.body.i
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %mat.i) #4
