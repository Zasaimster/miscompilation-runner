...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/188304253307072509436826226404831830452_O1.ll'
...
testAllocaOrder.exit:                             ; preds = %if.then.i.i, %for.body
  ...
  %add3.i.i = add nsw i32 %add.i.i, %4
  %call5.i = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %add3.i.i)
