; 19880145515678667736384962431009286268
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/19880145515678667736384962431009286268_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/19880145515678667736384962431009286268.c"
...
return:                                           ; preds = %if.end7, %if.then2
  %retval.0 = phi i32 [ 1, %if.end7 ], [ %., %if.then2 ]
  ret i32 %retval.0
}
