; 106343828677069259209416310494882507418
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/106343828677069259209416310494882507418_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/106343828677069259209416310494882507418.c"
...
define dso_local void @b(i8 noundef zeroext %data) local_unnamed_addr #1 {
entry:
...
if.end3:                                          ; preds = %if.end
  ...
  %2 = load i32, ptr @count, align 4, !tbaa !5
  %inc.i20.i = add nsw i32 %2, 1
  store i32 %inc.i20.i, ptr @count, align 4, !tbaa !5
...
if.end6:                                          ; preds = %if.end3
  ...
  %inc.i21.i = add nsw i32 %3, 1
  store i32 %inc.i21.i, ptr @count, align 4, !tbaa !5
...
if.end9:                                          ; preds = %if.end6
  ...
  %inc.i20.i27 = add nsw i32 %4, 1
  store i32 %inc.i20.i27, ptr @count, align 4, !tbaa !5
  %cmp10.not = icmp eq i32 %inc.i20.i27, 2
...
if.end12:                                         ; preds = %if.end9
  ...
  %inc.i21.i30 = add nsw i32 %5, 1
  store i32 %inc.i21.i30, ptr @count, align 4, !tbaa !5
  %cmp13.not = icmp eq i32 %inc.i21.i30, 2
...
if.end15:                                         ; preds = %if.end12
  ...
  %inc.i21.i33 = add nsw i32 %6, 2
  store i32 %inc.i21.i33, ptr @count, align 4, !tbaa !5
