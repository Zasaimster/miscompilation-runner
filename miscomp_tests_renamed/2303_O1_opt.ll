...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/199013194242540960685541924142527351344_O1.ll'
...
entry:
  ...
  store i32 5, ptr getelementptr inbounds nuw (i8, ptr @foo, i64 4), align 4, !tbaa !5
  %0 = load i32, ptr getelementptr inbounds nuw (i8, ptr @foo, i64 8), align 4, !tbaa !11
