...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/194729178309074094771361251419757785016_O0.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/194729178309074094771361251419757785016.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@buf = dso_local global [0 x i8] zeroinitializer, align 1
...
entry:
  ...
  call void @llvm.memset.p0.i64(ptr align 1 @buf, i8 %1, i64 64, i1 false)
  ret void
}
...
entry:
  ...
  store i8 2, ptr getelementptr inbounds ([0 x i8], ptr @buf, i64 0, i64 64), align 1
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [0 x i8], ptr @buf, i64 0, i64 %idxprom
...
for.body6:                                        ; preds = %for.cond3
  ...
  %arrayidx8 = getelementptr inbounds [0 x i8], ptr @buf, i64 0, i64 %idxprom7
...
for.body20:                                       ; preds = %for.cond17
  ...
  %arrayidx22 = getelementptr inbounds [0 x i8], ptr @buf, i64 0, i64 %idxprom21
...
for.end30:                                        ; preds = %for.cond17
  %12 = load i8, ptr getelementptr inbounds ([0 x i8], ptr @buf, i64 0, i64 64), align 1
