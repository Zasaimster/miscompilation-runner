...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/154542234152550696943393318505113819682_O1.ll'
...
sw.epilog.sink.split:                             ; preds = %if.then46, %if.then32, %sw.bb
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local void @func5() local_unnamed_addr #1 {
entry:
  ret void
}
