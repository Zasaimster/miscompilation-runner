...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/121884262781908173242839696881333290644_O0.ll'
...
if.end7:                                          ; preds = %if.end3
  ...
  %4 = load i32, ptr %sess.addr, align 4
  %5 = load i32, ptr %conn.addr, align 4
  %6 = load i16, ptr %family.addr, align 2
  %call = call i32 @aim_callhandler(i32 noundef %4, i32 noundef %5, i16 noundef zeroext %6, i16 noundef zeroext -1)
