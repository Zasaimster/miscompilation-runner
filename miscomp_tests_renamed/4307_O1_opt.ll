...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/173465011339963216900239151528821097153_O1.ll'
...
define dso_local noundef range(i32 0, 536862721) i32 @f(i32 noundef %a) local_unnamed_addr #0 {
entry:
  %0 = shl i32 %a, 13
