...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/145617953922024969862444968529355564310_O1.ll'
...
entry:
  store i32 2241, ptr getelementptr inbounds nuw (i8, ptr @a, i64 4), align 4, !tbaa !5
...
define dso_local noundef i32 @bar(float noundef %x) local_unnamed_addr #1 {
entry:
  ret i32 2241
}
