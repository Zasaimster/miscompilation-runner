...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/157633346433590287452837291822314910363.c'
...
if.end:                                           ; preds = %for.cond11.preheader, %for.cond11.if.end.loopexit30_crit_edge, %if.else, %for.cond15.if.end.loopexit_crit_edge
