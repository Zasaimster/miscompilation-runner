...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/188704817206483081507607465725456054813.c'
...
cleanup:                                          ; preds = %if.else, %if.then, %if.end16
...
f.exit51:                                         ; preds = %if.end12, %if.end16.i49
...
f.exit65:                                         ; preds = %if.end20, %if.end16.i63
