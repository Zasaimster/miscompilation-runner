...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/186830252463365969341402153556078714010_O0.ll'
...
while.body:                                       ; preds = %while.cond
  ...
  %incdec.ptr = getelementptr inbounds nuw float, ptr %1, i32 1
  store ptr %incdec.ptr, ptr %x.addr, align 8
  %2 = load float, ptr %1, align 4
  %3 = load ptr, ptr %y.addr, align 8
  %incdec.ptr1 = getelementptr inbounds nuw float, ptr %3, i32 1
