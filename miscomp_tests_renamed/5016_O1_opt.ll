...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/188650337484891078962112145749319269119_O1.ll'
...
entry:
  ...
  %0 = tail call x86_fp80 @llvm.fmuladd.f80(x86_fp80 %neg.i, x86_fp80 0xKC0018000000000000000, x86_fp80 0xKC0018000000000000000)
