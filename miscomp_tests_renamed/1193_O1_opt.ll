...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/189946525167574976333720302044582546722_O1.ll'
...
define dso_local void @anotherDummyFunc() local_unnamed_addr #1 {
entry:
  ret void
}
...
for.inc.i:                                        ; preds = %for.inc.i, %entry
  br label %for.inc.i
