; 142884996506342224018194644438432620126
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/142884996506342224018194644438432620126_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/142884996506342224018194644438432620126.c"
...
for.cond1.preheader:                              ; preds = %for.cond1.preheader.loopexit, %entry
  %i.0.lcssa = phi i32 [ 1, %entry ], [ %0, %for.cond1.preheader.loopexit ]
...
for.cond1.preheader.i:                            ; preds = %for.cond1.preheader.loopexit.i, %entry
  %i.0.lcssa.i = phi i32 [ 1, %entry ], [ %0, %for.cond1.preheader.loopexit.i ]
...
for.body.i:                                       ; preds = %for.inc.i, %entry
  %indvars.iv.i = phi i64 [ %indvars.iv.next.i, %for.inc.i ], [ 1, %entry ]
