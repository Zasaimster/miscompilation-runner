...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/164400672874479338632895786558655168965_O1.ll'
...
entry:
  %call = tail call i32 (i32, ...) @square(i32 noundef 5) #4
...
entry:
  %call.i = tail call i32 (i32, ...) @square(i32 noundef 5) #4
