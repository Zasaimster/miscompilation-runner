...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/143842195690128184872376727974226181512_O0.ll'
...
entry:
  ...
  %call = call i32 @x(i32 noundef 5, ptr noundef %arraydecay)
...
if.end:                                           ; preds = %lor.lhs.false2
  %call4 = call i32 (i32, ...) @process(i32 noundef 100)
...
entry:
  ...
  %call = call i32 @strcmp(ptr noundef %0, ptr noundef @.str) #8
  %cmp = icmp ne i32 %call, 0
  br i1 %cmp, label %if.then, label %lor.lhs.false
