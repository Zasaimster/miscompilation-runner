...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/184477531667024886439733338528112053692_O1.ll'
...
define dso_local noundef range(i32 -284280, 764296) i32 @main() local_unnamed_addr #0 {
entry:
  ret i32 0
}
