...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/177917240320897563332990474105099078562.c'
...
while.body.i:                                     ; preds = %entry, %if.end18.i
...
while.body14.i:                                   ; preds = %while.end.i, %while.body14.i
...
test.exit:                                        ; preds = %cleanup.i, %if.end18.i, %entry
