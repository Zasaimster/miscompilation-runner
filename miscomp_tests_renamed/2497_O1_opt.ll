; 16083774676277679956285736096444114387
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/16083774676277679956285736096444114387_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/16083774676277679956285736096444114387.c"
...
define dso_local range(i32 0, 2) i32 @foo(ptr noundef writeonly captures(none) %a, ptr noundef readonly captures(none) %b, i32 noundef %c) local_unnamed_addr #2 {
entry:
  %cmp = icmp eq i32 %c, 0
