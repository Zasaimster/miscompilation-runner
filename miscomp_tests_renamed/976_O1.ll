; 194763637034253778842475182408072631544
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/194763637034253778842475182408072631544.c'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/194763637034253778842475182408072631544.c"
...
entry:
  %call13 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef 0)
  %cmp14 = icmp slt i32 %call13, 288
...
for.body:                                         ; preds = %entry, %for.cond
  ...
  %3 = add i32 %2, -280
  %4 = icmp ult i32 %3, -24
  %add = select i1 %4, i32 8, i32 7
  %5 = trunc i64 %indvars.iv to i32
  %6 = add i32 %5, -144
  %7 = icmp ult i32 %6, 112
  %land.ext = zext i1 %7 to i32
  %add5 = add nuw nsw i32 %add, %land.ext
  %cmp6.not = icmp eq i32 %1, %add5
...
for.end24:                                        ; preds = %for.body19
  %call13.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef 0)
  %cmp14.i = icmp slt i32 %call13.i, 288
  br i1 %cmp14.i, label %for.body.i, label %check.exit
...
for.body.i:                                       ; preds = %for.end24, %for.cond.i
