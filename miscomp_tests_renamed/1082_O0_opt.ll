...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/119332514358699938244712999754135882482_O0.ll'
...
entry:
  ...
  store i64 %0, ptr @hpart, align 8
  %1 = load i64, ptr @hpart, align 8
  %shl = shl i64 %1, 32
  store i64 %shl, ptr @hpart, align 8
  %2 = load i64, ptr %l.addr, align 8
  store i64 %2, ptr @lpart, align 8
  %3 = load i64, ptr @lpart, align 8
  %and = and i64 %3, 4294967295
  store i64 %and, ptr @lpart, align 8
  %4 = load i64, ptr @hpart, align 8
  %5 = load i64, ptr @lpart, align 8
  %or = or i64 %4, %5
  store i64 %or, ptr @back, align 8
  %6 = load i64, ptr @back, align 8
  ret i64 %6
}
