; 168750745260305220886512337215835005045
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/168750745260305220886512337215835005045_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/168750745260305220886512337215835005045.c"
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 36, ptr nonnull %buf) #6
  ...
  %cmp34.i = icmp eq i32 %3, 1
  br i1 %cmp34.i, label %for.body.i, label %for.end.i

for.body.i:                                       ; preds = %for.body.i, %entry
  %4 = phi i64 [ %idxprom.i, %for.body.i ], [ 0, %entry ]
  %i.036.i = phi i32 [ %inc.i, %for.body.i ], [ 0, %entry ]
  %x4.i = getelementptr inbounds %struct.S, ptr %2, i64 %4, i32 1
  %5 = load i32, ptr %x4.i, align 4, !tbaa !13
  ...
  %7 = select i1 %cmp.i, i1 %cmp1.i, i1 false
...
for.end.i:                                        ; preds = %for.body.i, %entry
  ...
  %cmp5.i = icmp eq i32 %i.0.lcssa.i, 3
  br i1 %cmp5.i, label %if.then.i, label %for.cond6.preheader.i

for.cond6.preheader.i:                            ; preds = %for.end.i
  %cmp739.i = icmp sgt i32 %i.0.lcssa.i, 0
  br i1 %cmp739.i, label %for.body8.preheader.i, label %foo.exit
...
for.body8.i:                                      ; preds = %for.body8.i, %for.body8.preheader.i
  %indvars.iv.i = phi i64 [ %8, %for.body8.preheader.i ], [ %indvars.iv.next.i, %for.body8.i ]
  %x.141.i = phi i32 [ 0, %for.body8.preheader.i ], [ %10, %for.body8.i ]
  %idxprom9.i = sext i32 %x.141.i to i64
  %y.i = getelementptr inbounds %struct.S, ptr %2, i64 %idxprom9.i, i32 2
  %9 = load i32, ptr %y.i, align 4, !tbaa !17
  %arrayidx12.i = getelementptr inbounds nuw i32, ptr %s, i64 %indvars.iv.i
  store i32 %9, ptr %arrayidx12.i, align 4, !tbaa !18
  %x15.i = getelementptr inbounds %struct.S, ptr %2, i64 %idxprom9.i, i32 1
  %10 = load i32, ptr %x15.i, align 4, !tbaa !13
  %indvars.iv.next.i = add nsw i64 %indvars.iv.i, -1
  %cmp7.i = icmp sgt i64 %indvars.iv.i, 1
  br i1 %cmp7.i, label %for.body8.i, label %foo.exit, !llvm.loop !19

foo.exit:                                         ; preds = %for.body8.i, %for.cond6.preheader.i
  %x.1.lcssa.i = phi i32 [ 0, %for.cond6.preheader.i ], [ %10, %for.body8.i ]
  store i32 %x.1.lcssa.i, ptr %s, align 4, !tbaa !18
  %cmp.not = icmp eq i32 %i.0.lcssa.i, 1
...
if.end:                                           ; preds = %foo.exit
  %cmp2 = icmp ne i32 %x.1.lcssa.i, 1
...
if.end6:                                          ; preds = %if.end
  call void @llvm.lifetime.end.p0(i64 36, ptr nonnull %buf) #6
