; 112221679067769020559764179164041618559
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/112221679067769020559764179164041618559_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/112221679067769020559764179164041618559.c"
...
entry:
  ...
  %cmp18.i = icmp eq i32 %f.promoted.i, 0
  br i1 %cmp18.i, label %for.cond1.preheader.lr.ph.i, label %fn1.exit
...
for.body3.i:                                      ; preds = %if.end.i, %for.cond1.preheader.lr.ph.i
  %g.017.i = phi i32 [ 1, %for.cond1.preheader.lr.ph.i ], [ %dec.i, %if.end.i ]
...
if.end.i:                                         ; preds = %lor.end.i
  ...
  %dec.i = add nsw i32 %g.017.i, -1
  %cmp2.not.i = icmp eq i32 %g.017.i, 0
