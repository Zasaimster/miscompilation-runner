...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/110575755966100432928760164592113848395_O0.ll'
...
@a = internal global [7 x i32] zeroinitializer, align 16
...
if.then:                                          ; preds = %entry
  ...
  %arrayidx = getelementptr inbounds nuw [7 x i32], ptr @a, i64 0, i64 %idxprom
  %2 = load i32, ptr %arrayidx, align 4
  store i32 %2, ptr @b, align 4
  %3 = load i32, ptr @b, align 4
  %and1 = and i32 %3, 1
  %idxprom2 = zext i32 %and1 to i64
  %arrayidx3 = getelementptr inbounds nuw [7 x i32], ptr @a, i64 0, i64 %idxprom2
  ...
  %and5 = and i64 %xor, 1
  %arrayidx6 = getelementptr inbounds nuw [7 x i32], ptr @a, i64 0, i64 %and5
  ...
  %arrayidx11 = getelementptr inbounds nuw [7 x i32], ptr @a, i64 0, i64 %and10
