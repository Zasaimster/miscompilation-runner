...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/139580108130526553659230110610888486184_O1.ll'
...
@a = internal unnamed_addr global [5 x i32] zeroinitializer, align 16
...
for.cond2.preheader:                              ; preds = %for.cond2.preheader, %entry
  ...
  %arrayidx = getelementptr inbounds nuw [5 x i32], ptr @a, i64 0, i64 %indvars.iv
...
if.then.i:                                        ; preds = %for.end14
  ...
  %arrayidx3.i42 = getelementptr inbounds nuw [5 x i32], ptr @a, i64 0, i64 %idxprom2.i41
  %9 = load i32, ptr %arrayidx3.i42, align 4, !tbaa !10
  store i32 %9, ptr @b, align 4, !tbaa !10
  %10 = and i32 %9, 1
  %and5.i43 = zext nneg i32 %10 to i64
  %arrayidx6.i44 = getelementptr inbounds nuw [5 x i32], ptr @a, i64 0, i64 %and5.i43
  %11 = load i32, ptr %arrayidx6.i44, align 4, !tbaa !10
  store i32 %11, ptr @b, align 4, !tbaa !10
  %12 = and i32 %11, 1
  %and10.i45 = zext nneg i32 %12 to i64
  %arrayidx11.i46 = getelementptr inbounds nuw [5 x i32], ptr @a, i64 0, i64 %and10.i45
