...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/165838485922561484883842361995105717584_O0.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/165838485922561484883842361995105717584.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@array = dso_local global [0 x i32] zeroinitializer, align 4
...
entry:
  ...
  %arrayidx4 = getelementptr inbounds [0 x i32], ptr @array, i64 0, i64 %idxprom3
  store i32 %3, ptr %arrayidx4, align 4
  %5 = load i32, ptr %tmp, align 4
  %6 = load i32, ptr %b.addr, align 4
  %idxprom5 = sext i32 %6 to i64
  %arrayidx6 = getelementptr inbounds [0 x i32], ptr @array, i64 0, i64 %idxprom5
...
entry:
  ...
  store i32 83, ptr getelementptr inbounds ([0 x i32], ptr @array, i64 0, i64 1), align 4
  store i32 4, ptr getelementptr inbounds ([0 x i32], ptr @array, i64 0, i64 2), align 4
  store i32 89, ptr getelementptr inbounds ([0 x i32], ptr @array, i64 0, i64 3), align 4
  store i32 36, ptr getelementptr inbounds ([0 x i32], ptr @array, i64 0, i64 4), align 4
  store i32 21, ptr getelementptr inbounds ([0 x i32], ptr @array, i64 0, i64 5), align 4
  store i32 74, ptr getelementptr inbounds ([0 x i32], ptr @array, i64 0, i64 6), align 4
  store i32 37, ptr getelementptr inbounds ([0 x i32], ptr @array, i64 0, i64 7), align 4
  store i32 65, ptr getelementptr inbounds ([0 x i32], ptr @array, i64 0, i64 8), align 4
  store i32 33, ptr getelementptr inbounds ([0 x i32], ptr @array, i64 0, i64 9), align 4
  store i32 96, ptr getelementptr inbounds ([0 x i32], ptr @array, i64 0, i64 10), align 4
  store i32 38, ptr getelementptr inbounds ([0 x i32], ptr @array, i64 0, i64 11), align 4
  store i32 53, ptr getelementptr inbounds ([0 x i32], ptr @array, i64 0, i64 12), align 4
  store i32 16, ptr getelementptr inbounds ([0 x i32], ptr @array, i64 0, i64 13), align 4
  store i32 74, ptr getelementptr inbounds ([0 x i32], ptr @array, i64 0, i64 14), align 4
  store i32 55, ptr getelementptr inbounds ([0 x i32], ptr @array, i64 0, i64 15), align 4
