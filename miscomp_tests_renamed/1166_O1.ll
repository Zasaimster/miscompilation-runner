...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/155857994269536599749967965971689391022.c'
...
for.body4:                                        ; preds = %entry, %for.body4
  ...
  %arrayidx6 = getelementptr inbounds nuw [10 x i32], ptr %Array, i64 0, i64 %indvars.iv
  ...
  br i1 %exitcond.not, label %for.end9, label %for.body4, !llvm.loop !9
