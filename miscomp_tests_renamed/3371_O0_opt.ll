...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/158944555653832940974651799648480305374_O0.ll'
...
define dso_local i32 @arg_ptr() #0 {
entry:
  ret i32 42
}
...
entry:
  ...
  %call = call i32 (ptr, ...) @arg_ptr(ptr noundef getelementptr inbounds ([8 x i8], ptr getelementptr inbounds nuw (%struct.S, ptr @s, i32 0, i32 2), i64 0, i64 1))
  %0 = load ptr, ptr @ptr, align 8
  %add.ptr = getelementptr inbounds i8, ptr %0, i64 3
  %call1 = call i32 (ptr, ...) @arg_ptr(ptr noundef %add.ptr)
  %1 = load ptr, ptr @ptr, align 8
  call void @arg_idx(ptr noundef %1, i32 noundef 3)
  %2 = load ptr, ptr @ptr, align 8
  %add.ptr2 = getelementptr inbounds i8, ptr %2, i64 1
  call void @arg_idx(ptr noundef %add.ptr2, i32 noundef 2)
