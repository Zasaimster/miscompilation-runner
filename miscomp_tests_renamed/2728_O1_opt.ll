...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/147543212970417959120241372225459766045_O1.ll'
...
define dso_local void @bug(i32 noundef %q, i64 noundef %bcount) local_unnamed_addr #2 {
entry:
  tail call void @abort() #3
  unreachable
}
