...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/16825578553055656320824086131082373090_O1.ll'
...
if.end.i:                                         ; preds = %if.end.i, %entry
  %count.08.i = phi i32 [ 0, %entry ], [ %inc.i, %if.end.i ]
  %inc.i = add nuw nsw i32 %count.08.i, 1
  %puts.i.i = tail call i32 @puts(ptr nonnull dereferenceable(1) @str)
  %cmp1.not.i = icmp eq i32 %count.08.i, 0
  br i1 %cmp1.not.i, label %if.end.i, label %if.then.i, !llvm.loop !5
}
