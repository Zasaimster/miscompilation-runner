; 11360941318134164610129147224759665603
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/11360941318134164610129147224759665603_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/11360941318134164610129147224759665603.c"
...
for.body:                                         ; preds = %for.inc5, %entry
  %f.019 = phi i32 [ 0, %entry ], [ %f.2, %for.inc5 ]
  %storemerge18 = phi i32 [ 0, %entry ], [ %inc6, %for.inc5 ]
  %and11517 = phi i32 [ %b.promoted, %entry ], [ %and1, %for.inc5 ]
  %and = and i32 %f.019, 1
  br label %for.body4

for.body4:                                        ; preds = %for.inc, %for.body
  %f.113 = phi i32 [ %f.019, %for.body ], [ %f.2, %for.inc ]
...
for.inc5:                                         ; preds = %for.inc
  %and1 = and i32 %and, %and11517
  %inc6 = add nuw nsw i32 %storemerge18, 1
  %cmp = icmp eq i32 %storemerge18, 0
