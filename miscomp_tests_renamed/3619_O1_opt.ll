...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/104598439295415283173260895762489220822_O1.ll'
...
for.cond:                                         ; preds = %if.end, %for.cond.outer
  %call = tail call i32 (i32, ...) @process(i32 noundef 100) #9
...
for.cond.outer.i:                                 ; preds = %if.end.i, %entry
  %call.i = call i32 (i32, ...) @process(i32 noundef 100) #9
...
define dso_local range(i32 0, 2) i32 @f1(ptr noundef readnone captures(none) %p) local_unnamed_addr #8 {
entry:
