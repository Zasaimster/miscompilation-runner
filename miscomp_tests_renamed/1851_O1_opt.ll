...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/185365106087029645121652397875553138496_O1.ll'
...
define dso_local noundef nonnull ptr @foo(i64 noundef %n) local_unnamed_addr #0 {
entry:
  ret ptr @buf
}
...
entry:
  %cmp = icmp eq i64 %n, 0
  %spec.select = select i1 %cmp, ptr @buf, ptr getelementptr inbounds nuw (i8, ptr @buf, i64 8)
  ret ptr %spec.select
}
