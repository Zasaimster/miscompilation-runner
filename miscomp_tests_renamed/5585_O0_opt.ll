; 145233718329666630657932274651275217962
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/145233718329666630657932274651275217962_O0.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/145233718329666630657932274651275217962.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: noinline nounwind uwtable
define dso_local i32 @tar(i32 noundef %i) #0 {
entry:
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @bug(i32 noundef %q, i32 noundef %bcount) #0 {
entry:
  ...
  store i32 %bcount, ptr %bcount.addr, align 4
...
if.end:                                           ; preds = %if.then, %while.body
  ...
  %6 = load i32, ptr %bcount.addr, align 4
  %mul = mul nsw i32 %5, %6
  %call = call i32 @tar(i32 noundef %mul)
