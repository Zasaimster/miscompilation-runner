...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/146686786109616915471080941674899466821_O0.ll'
...
if.end:                                           ; preds = %for.body
  ...
  %call2 = call i32 @dd(i32 noundef %2, i32 noundef 2)
  %3 = load i32, ptr %i, align 4
  %div = sdiv i32 %3, 2
  %cmp3 = icmp ne i32 %call2, %div
