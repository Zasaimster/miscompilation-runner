; 174688660852374397716455973079452331690
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/174688660852374397716455973079452331690_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/174688660852374397716455973079452331690.c"
...
define dso_local noundef { ptr, i64 } @bar(ptr readnone captures(none) %blah.coerce0, i64 %blah.coerce1) local_unnamed_addr #0 {
entry:
...
define dso_local { ptr, i64 } @foo(ptr readonly captures(none) %x.coerce0, i64 %x.coerce1, ptr %y.coerce0, i64 %y.coerce1) local_unnamed_addr #2 {
entry:
