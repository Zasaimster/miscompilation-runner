; 130293736243088559548049428656452419659
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/130293736243088559548049428656452419659_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/130293736243088559548049428656452419659.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@check = dso_local local_unnamed_addr global i32 42, align 4
...
entry:
  ...
  %call = tail call i32 (...) @unusedFunction() #8
  ...
  store ptr @.str, ptr %arrayinit.element, align 8, !tbaa !5
  %arrayinit.element1 = getelementptr inbounds nuw i8, ptr %args, i64 16
  store ptr @.str.1, ptr %arrayinit.element1, align 16, !tbaa !5
  %arrayinit.element2 = getelementptr inbounds nuw i8, ptr %args, i64 24
  store ptr @.str.2, ptr %arrayinit.element2, align 8, !tbaa !5
  %arrayinit.element3 = getelementptr inbounds nuw i8, ptr %args, i64 32
  store ptr @.str.3, ptr %arrayinit.element3, align 16, !tbaa !5
...
if.then:                                          ; preds = %land.lhs.true2
  %call.i = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %1, ptr noundef nonnull dereferenceable(2) @.str.4) #8
...
s.exit:                                           ; preds = %lor.lhs.false.i
  %call.i46 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %1, ptr noundef nonnull dereferenceable(2) @.str.4) #8
...
entry:
  %call = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %v, ptr noundef nonnull dereferenceable(2) @.str.4) #8
