...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/114116851419447350266782395671512033973_O1.ll'
...
@str.3 = private unnamed_addr constant [29 x i8] c"This function is never used.\00", align 1
...
do.body14:                                        ; preds = %do.body14, %do.body14.preheader
...
doit.exit:                                        ; preds = %do.body.i
  ...
  %call1.i11 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1)
