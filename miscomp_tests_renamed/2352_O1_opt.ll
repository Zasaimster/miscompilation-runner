...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/198423180764545809750052059220800734491_O1.ll'
...
define dso_local noundef i32 @test1(i32 noundef %x) local_unnamed_addr #0 {
entry:
  ret i32 0
}
