; 116883474352232043784489144754557804581
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/116883474352232043784489144754557804581_O0.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/116883474352232043784489144754557804581.c"
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @test1u(i32 noundef %x) #0 {
entry:
  %x.addr = alloca i32, align 4
  store i32 %x, ptr %x.addr, align 4
  %0 = load i32, ptr %x.addr, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @test2u(i32 noundef %x) #0 {
entry:
  %x.addr = alloca i32, align 4
  store i32 %x, ptr %x.addr, align 4
  %0 = load i32, ptr %x.addr, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @test3u(i32 noundef %x) #0 {
entry:
  %x.addr = alloca i32, align 4
  store i32 %x, ptr %x.addr, align 4
  %0 = load i32, ptr %x.addr, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @test4u(i32 noundef %x) #0 {
entry:
  %x.addr = alloca i32, align 4
  store i32 %x, ptr %x.addr, align 4
  %0 = load i32, ptr %x.addr, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @test5u(i32 noundef %x) #0 {
entry:
  %x.addr = alloca i32, align 4
  store i32 %x, ptr %x.addr, align 4
  %0 = load i32, ptr %x.addr, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @test7(i32 noundef %x) #0 {
entry:
  %x.addr = alloca i32, align 4
  store i32 %x, ptr %x.addr, align 4
  %0 = load i32, ptr %x.addr, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @test7u(i32 noundef %x) #0 {
entry:
  %x.addr = alloca i32, align 4
  store i32 %x, ptr %x.addr, align 4
  %0 = load i32, ptr %x.addr, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @test8(i32 noundef %x) #0 {
entry:
  %x.addr = alloca i32, align 4
  store i32 %x, ptr %x.addr, align 4
  %0 = load i32, ptr %x.addr, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @test8u(i32 noundef %x) #0 {
entry:
  %x.addr = alloca i32, align 4
  store i32 %x, ptr %x.addr, align 4
  %0 = load i32, ptr %x.addr, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @test9(i32 noundef %x) #0 {
entry:
  %x.addr = alloca i32, align 4
  store i32 %x, ptr %x.addr, align 4
  %0 = load i32, ptr %x.addr, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @test9u(i32 noundef %x) #0 {
entry:
  %x.addr = alloca i32, align 4
  store i32 %x, ptr %x.addr, align 4
  %0 = load i32, ptr %x.addr, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @test10(i32 noundef %x) #0 {
entry:
  %x.addr = alloca i32, align 4
  store i32 %x, ptr %x.addr, align 4
  %0 = load i32, ptr %x.addr, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @test10u(i32 noundef %x) #0 {
entry:
  %x.addr = alloca i32, align 4
  store i32 %x, ptr %x.addr, align 4
  %0 = load i32, ptr %x.addr, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @test11(i32 noundef %x) #0 {
entry:
  %x.addr = alloca i32, align 4
  store i32 %x, ptr %x.addr, align 4
  %0 = load i32, ptr %x.addr, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @test11u(i32 noundef %x) #0 {
entry:
  %x.addr = alloca i32, align 4
  store i32 %x, ptr %x.addr, align 4
  %0 = load i32, ptr %x.addr, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @test12(i32 noundef %x) #0 {
entry:
  %x.addr = alloca i32, align 4
  store i32 %x, ptr %x.addr, align 4
  %0 = load i32, ptr %x.addr, align 4
...
if.end12:                                         ; preds = %if.end8
  %call13 = call i32 @test1u(i32 noundef 19)
...
if.end16:                                         ; preds = %if.end12
  %call17 = call i32 @test1u(i32 noundef 20)
...
if.end20:                                         ; preds = %if.end16
  %call21 = call i32 @test1u(i32 noundef 29)
...
if.end24:                                         ; preds = %if.end20
  %call25 = call i32 @test1u(i32 noundef 30)
...
if.end28:                                         ; preds = %if.end24
  %call29 = call i32 @test2(i32 noundef 0)
...
if.end32:                                         ; preds = %if.end28
  %call33 = call i32 @test2(i32 noundef 9)
...
if.end36:                                         ; preds = %if.end32
  %call37 = call i32 @test2(i32 noundef 10)
...
if.end40:                                         ; preds = %if.end36
  %call41 = call i32 @test2(i32 noundef -1)
...
if.end44:                                         ; preds = %if.end40
  %call45 = call i32 @test2(i32 noundef -9)
...
if.end48:                                         ; preds = %if.end44
  %call49 = call i32 @test2(i32 noundef -10)
...
if.end52:                                         ; preds = %if.end48
  %call53 = call i32 @test2u(i32 noundef 0)
...
if.end56:                                         ; preds = %if.end52
  %call57 = call i32 @test2u(i32 noundef 9)
...
if.end60:                                         ; preds = %if.end56
  %call61 = call i32 @test2u(i32 noundef 10)
...
if.end64:                                         ; preds = %if.end60
  %call65 = call i32 @test2u(i32 noundef -1)
...
if.end68:                                         ; preds = %if.end64
  %call69 = call i32 @test2u(i32 noundef -9)
...
if.end72:                                         ; preds = %if.end68
  %call73 = call i32 @test2u(i32 noundef -10)
...
if.end76:                                         ; preds = %if.end72
  %call77 = call i32 @test3(i32 noundef 19)
...
if.end80:                                         ; preds = %if.end76
  %call81 = call i32 @test3(i32 noundef 20)
...
if.end84:                                         ; preds = %if.end80
  %call85 = call i32 @test3(i32 noundef 29)
...
if.end88:                                         ; preds = %if.end84
  %call89 = call i32 @test3(i32 noundef 30)
...
if.end92:                                         ; preds = %if.end88
  %call93 = call i32 @test3u(i32 noundef 19)
...
if.end96:                                         ; preds = %if.end92
  %call97 = call i32 @test3u(i32 noundef 20)
...
if.end100:                                        ; preds = %if.end96
  %call101 = call i32 @test3u(i32 noundef 29)
...
if.end104:                                        ; preds = %if.end100
  %call105 = call i32 @test3u(i32 noundef 30)
...
if.end108:                                        ; preds = %if.end104
  %call109 = call i32 @test4(i32 noundef 0)
...
if.end112:                                        ; preds = %if.end108
  %call113 = call i32 @test4(i32 noundef 9)
...
if.end116:                                        ; preds = %if.end112
  %call117 = call i32 @test4(i32 noundef 10)
...
if.end120:                                        ; preds = %if.end116
  %call121 = call i32 @test4(i32 noundef -1)
...
if.end124:                                        ; preds = %if.end120
  %call125 = call i32 @test4(i32 noundef -9)
...
if.end128:                                        ; preds = %if.end124
  %call129 = call i32 @test4(i32 noundef -10)
...
if.end132:                                        ; preds = %if.end128
  %call133 = call i32 @test4u(i32 noundef 0)
...
if.end136:                                        ; preds = %if.end132
  %call137 = call i32 @test4u(i32 noundef 9)
...
if.end140:                                        ; preds = %if.end136
  %call141 = call i32 @test4u(i32 noundef 10)
...
if.end144:                                        ; preds = %if.end140
  %call145 = call i32 @test4u(i32 noundef -1)
...
if.end148:                                        ; preds = %if.end144
  %call149 = call i32 @test4u(i32 noundef -9)
...
if.end152:                                        ; preds = %if.end148
  %call153 = call i32 @test4u(i32 noundef -10)
...
if.end156:                                        ; preds = %if.end152
  %call157 = call i32 @test5(i32 noundef 19)
...
if.end160:                                        ; preds = %if.end156
  %call161 = call i32 @test5(i32 noundef 20)
...
if.end164:                                        ; preds = %if.end160
  %call165 = call i32 @test5(i32 noundef 29)
...
if.end168:                                        ; preds = %if.end164
  %call169 = call i32 @test5(i32 noundef 30)
...
if.end172:                                        ; preds = %if.end168
  %call173 = call i32 @test5u(i32 noundef 19)
...
if.end176:                                        ; preds = %if.end172
  %call177 = call i32 @test5u(i32 noundef 20)
...
if.end180:                                        ; preds = %if.end176
  %call181 = call i32 @test5u(i32 noundef 29)
...
if.end184:                                        ; preds = %if.end180
  %call185 = call i32 @test5u(i32 noundef 30)
...
if.end188:                                        ; preds = %if.end184
  %call189 = call i32 @test6(i32 noundef 0)
...
if.end192:                                        ; preds = %if.end188
  %call193 = call i32 @test6(i32 noundef 9)
...
if.end196:                                        ; preds = %if.end192
  %call197 = call i32 @test6(i32 noundef 10)
...
if.end200:                                        ; preds = %if.end196
  %call201 = call i32 @test6(i32 noundef -1)
...
if.end204:                                        ; preds = %if.end200
  %call205 = call i32 @test6(i32 noundef -9)
...
if.end208:                                        ; preds = %if.end204
  %call209 = call i32 @test6(i32 noundef -10)
...
if.end212:                                        ; preds = %if.end208
  %call213 = call i32 @test7(i32 noundef 19)
...
if.end216:                                        ; preds = %if.end212
  %call217 = call i32 @test7(i32 noundef 20)
...
if.end220:                                        ; preds = %if.end216
  %call221 = call i32 @test7(i32 noundef 29)
...
if.end224:                                        ; preds = %if.end220
  %call225 = call i32 @test7(i32 noundef 30)
...
if.end228:                                        ; preds = %if.end224
  %call229 = call i32 @test7u(i32 noundef 19)
...
if.end232:                                        ; preds = %if.end228
  %call233 = call i32 @test7u(i32 noundef 20)
...
if.end236:                                        ; preds = %if.end232
  %call237 = call i32 @test7u(i32 noundef 29)
...
if.end240:                                        ; preds = %if.end236
  %call241 = call i32 @test7u(i32 noundef 30)
...
if.end244:                                        ; preds = %if.end240
  %call245 = call i32 @test8(i32 noundef 0)
...
if.end248:                                        ; preds = %if.end244
  %call249 = call i32 @test8(i32 noundef 9)
...
if.end252:                                        ; preds = %if.end248
  %call253 = call i32 @test8(i32 noundef 10)
...
if.end256:                                        ; preds = %if.end252
  %call257 = call i32 @test8(i32 noundef -1)
...
if.end260:                                        ; preds = %if.end256
  %call261 = call i32 @test8(i32 noundef -9)
...
if.end264:                                        ; preds = %if.end260
  %call265 = call i32 @test8(i32 noundef -10)
...
if.end268:                                        ; preds = %if.end264
  %call269 = call i32 @test8u(i32 noundef 0)
...
if.end272:                                        ; preds = %if.end268
  %call273 = call i32 @test8u(i32 noundef 9)
...
if.end276:                                        ; preds = %if.end272
  %call277 = call i32 @test8u(i32 noundef 10)
...
if.end280:                                        ; preds = %if.end276
  %call281 = call i32 @test8u(i32 noundef -1)
...
if.end284:                                        ; preds = %if.end280
  %call285 = call i32 @test8u(i32 noundef -9)
...
if.end288:                                        ; preds = %if.end284
  %call289 = call i32 @test8u(i32 noundef -10)
...
if.end292:                                        ; preds = %if.end288
  %call293 = call i32 @test9(i32 noundef 19)
...
if.end296:                                        ; preds = %if.end292
  %call297 = call i32 @test9(i32 noundef 20)
...
if.end300:                                        ; preds = %if.end296
  %call301 = call i32 @test9(i32 noundef 29)
...
if.end304:                                        ; preds = %if.end300
  %call305 = call i32 @test9(i32 noundef 30)
...
if.end308:                                        ; preds = %if.end304
  %call309 = call i32 @test9u(i32 noundef 19)
...
if.end312:                                        ; preds = %if.end308
  %call313 = call i32 @test9u(i32 noundef 20)
...
if.end316:                                        ; preds = %if.end312
  %call317 = call i32 @test9u(i32 noundef 29)
...
if.end320:                                        ; preds = %if.end316
  %call321 = call i32 @test9u(i32 noundef 30)
...
if.end324:                                        ; preds = %if.end320
  %call325 = call i32 @test10(i32 noundef 0)
...
if.end328:                                        ; preds = %if.end324
  %call329 = call i32 @test10(i32 noundef 9)
...
if.end332:                                        ; preds = %if.end328
  %call333 = call i32 @test10(i32 noundef 10)
...
if.end336:                                        ; preds = %if.end332
  %call337 = call i32 @test10(i32 noundef -1)
...
if.end340:                                        ; preds = %if.end336
  %call341 = call i32 @test10(i32 noundef -9)
...
if.end344:                                        ; preds = %if.end340
  %call345 = call i32 @test10(i32 noundef -10)
...
if.end348:                                        ; preds = %if.end344
  %call349 = call i32 @test10u(i32 noundef 0)
...
if.end352:                                        ; preds = %if.end348
  %call353 = call i32 @test10u(i32 noundef 9)
...
if.end356:                                        ; preds = %if.end352
  %call357 = call i32 @test10u(i32 noundef 10)
...
if.end360:                                        ; preds = %if.end356
  %call361 = call i32 @test10u(i32 noundef -1)
...
if.end364:                                        ; preds = %if.end360
  %call365 = call i32 @test10u(i32 noundef -9)
...
if.end368:                                        ; preds = %if.end364
  %call369 = call i32 @test10u(i32 noundef -10)
...
if.end372:                                        ; preds = %if.end368
  %call373 = call i32 @test11(i32 noundef 19)
...
if.end376:                                        ; preds = %if.end372
  %call377 = call i32 @test11(i32 noundef 20)
...
if.end380:                                        ; preds = %if.end376
  %call381 = call i32 @test11(i32 noundef 29)
...
if.end384:                                        ; preds = %if.end380
  %call385 = call i32 @test11(i32 noundef 30)
...
if.end388:                                        ; preds = %if.end384
  %call389 = call i32 @test11u(i32 noundef 19)
...
if.end392:                                        ; preds = %if.end388
  %call393 = call i32 @test11u(i32 noundef 20)
...
if.end396:                                        ; preds = %if.end392
  %call397 = call i32 @test11u(i32 noundef 29)
...
if.end400:                                        ; preds = %if.end396
  %call401 = call i32 @test11u(i32 noundef 30)
...
if.end404:                                        ; preds = %if.end400
  %call405 = call i32 @test12(i32 noundef 0)
...
if.end408:                                        ; preds = %if.end404
  %call409 = call i32 @test12(i32 noundef 9)
...
if.end412:                                        ; preds = %if.end408
  %call413 = call i32 @test12(i32 noundef 10)
...
if.end416:                                        ; preds = %if.end412
  %call417 = call i32 @test12(i32 noundef -1)
...
if.end420:                                        ; preds = %if.end416
  %call421 = call i32 @test12(i32 noundef -9)
...
if.end424:                                        ; preds = %if.end420
  %call425 = call i32 @test12(i32 noundef -10)
