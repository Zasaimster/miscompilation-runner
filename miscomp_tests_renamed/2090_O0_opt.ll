...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/136891704684375185722965710896633140596_O0.ll'
...
entry:
  ...
  %add.ptr = getelementptr inbounds nuw i8, ptr @.str, i64 %1
  %call = call ptr @strcpy(ptr noundef %0, ptr noundef %add.ptr) #5
  ret i64 0
}
...
entry:
  ...
  %call1 = call ptr @strcpy(ptr noundef %0, ptr noundef %add.ptr) #5
  ret void
}
