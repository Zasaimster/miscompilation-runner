...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/148643927294423707306160096175849864005_O1.ll'
...
if.end:                                           ; preds = %entry
  ...
  %1 = load i32, ptr %arrayidx39, align 4, !tbaa !10
...
for.body:                                         ; preds = %for.body, %if.end
  %3 = phi i64 [ %idxprom, %for.body ], [ %idxprom38, %if.end ]
  %i.042 = phi i32 [ %inc, %for.body ], [ 0, %if.end ]
...
if.end8:                                          ; preds = %for.end
  ...
  %cmp1045 = icmp sgt i32 %i.0.lcssa, 0
  br i1 %cmp1045, label %for.body11.preheader, label %for.end20
...
for.body11:                                       ; preds = %for.body11, %for.body11.preheader
  ...
  %x.146 = phi i32 [ %n, %for.body11.preheader ], [ %9, %for.body11 ]
...
entry:
  ...
  %cmp140.i = icmp eq i32 %3, 1
  br i1 %cmp140.i, label %for.body.i, label %for.end.i

for.body.i:                                       ; preds = %for.body.i, %entry
  %4 = phi i64 [ %idxprom.i, %for.body.i ], [ 0, %entry ]
  %i.042.i = phi i32 [ %inc.i, %for.body.i ], [ 0, %entry ]
  ...
  %cmp2.i = icmp samesign ult i32 %i.042.i, 2
...
if.end8.i:                                        ; preds = %for.end.i
  %cmp1045.i = icmp sgt i32 %i.0.lcssa.i, 0
  br i1 %cmp1045.i, label %for.body11.preheader.i, label %foo.exit
...
for.body11.i:                                     ; preds = %for.body11.i, %for.body11.preheader.i
  ...
  %x.146.i = phi i32 [ 0, %for.body11.preheader.i ], [ %10, %for.body11.i ]
  %idxprom12.i = sext i32 %x.146.i to i64
  ...
  br i1 %cmp10.i, label %for.body11.i, label %foo.exit, !llvm.loop !19

foo.exit:                                         ; preds = %for.body11.i, %if.end8.i
