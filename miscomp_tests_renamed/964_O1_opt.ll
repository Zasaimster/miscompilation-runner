; 117328436080561301065632248750056411261
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/117328436080561301065632248750056411261_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/117328436080561301065632248750056411261.c"
...
return:                                           ; preds = %sw.bb3, %sw.bb1, %sw.bb, %entry
  %retval.0 = phi i32 [ %conv4, %sw.bb3 ], [ %conv2, %sw.bb1 ], [ %conv, %sw.bb ], [ 0, %entry ]
  ret i32 %retval.0
}
