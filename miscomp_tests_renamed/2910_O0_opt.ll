...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/192327627411577816665856056609316876555_O0.ll'
...
entry:
  ...
  store i32 %call1, ptr %ye, align 4
  ...
  %sub = fsub float %conv5, %5
  %6 = load float, ptr %error, align 4
  %sub6 = fsub float %6, %sub
  store float %sub6, ptr %error, align 4
  br label %for.cond
...
if.then:                                          ; preds = %for.body
  ...
  %sub14 = fsub float %14, %conv13
  store float %sub14, ptr %error, align 4
  call void @bar()
  br label %if.end
...
if.end:                                           ; preds = %if.then, %for.body
  ...
  %add15 = fadd float %16, %15
  store float %add15, ptr %error, align 4
  br label %for.inc
...
for.end:                                          ; preds = %for.cond
  ...
  %src_y16 = getelementptr inbounds nuw %struct._RenderInfo, ptr %18, i32 0, i32 2
  %19 = load i32, ptr %src_y16, align 4
  ret i32 %19
}
