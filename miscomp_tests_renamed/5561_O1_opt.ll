...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/198457743291206343752356293114344027571_O1.ll'
...
if.end:                                           ; preds = %entry
  %call.i237 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str)
...
if.end4:                                          ; preds = %if.end
  %call.i241 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str)
...
if.end8:                                          ; preds = %if.end4
  %call.i245 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str)
  %3 = add i32 %call.i245, 19
  %cmp.i247 = icmp ult i32 %3, -10
  br i1 %cmp.i247, label %if.end12, label %if.then11
...
if.end12:                                         ; preds = %if.end8
  %call.i249 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1)
  %4 = add i32 %call.i249, -10
  %cmp.i251 = icmp ult i32 %4, -19
  br i1 %cmp.i251, label %if.then15, label %if.end16
...
if.end16:                                         ; preds = %if.end12
  %call.i253 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1)
  %5 = add i32 %call.i253, -10
  %cmp.i255 = icmp ult i32 %5, -19
  br i1 %cmp.i255, label %if.then19, label %if.end20
...
if.end20:                                         ; preds = %if.end16
  %call.i257 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1)
  %6 = add i32 %call.i257, -10
  %cmp.i259 = icmp ult i32 %6, -19
  br i1 %cmp.i259, label %if.end24, label %if.then23
...
if.end24:                                         ; preds = %if.end20
  %call.i261 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1)
  %7 = add i32 %call.i261, -10
  %cmp.i263 = icmp ult i32 %7, -19
  br i1 %cmp.i263, label %if.then27, label %if.end28
...
if.end28:                                         ; preds = %if.end24
  %call.i265 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1)
  %8 = add i32 %call.i265, -10
  %cmp.i267 = icmp ult i32 %8, -19
  br i1 %cmp.i267, label %if.then31, label %if.end32
...
if.end32:                                         ; preds = %if.end28
  %call.i269 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1)
  %9 = add i32 %call.i269, -10
  %cmp.i271 = icmp ult i32 %9, -19
  br i1 %cmp.i271, label %if.end236, label %if.then35

if.then35:                                        ; preds = %if.end32
  tail call void @abort() #4
  unreachable

if.end236:                                        ; preds = %if.end32
  ret i32 0
}
