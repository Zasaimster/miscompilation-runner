...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/154151367413366652376992787909240111296_O0.ll'
...
entry:
  ...
  %cmp = fcmp olt x86_fp80 %36, 0xK00000000000000000000
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  store x86_fp80 0xK4001A000000000000000, ptr @Z, align 16
  br label %if.end
