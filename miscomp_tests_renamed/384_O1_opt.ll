; 130736160278659854639318437119239621001
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/130736160278659854639318437119239621001_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/130736160278659854639318437119239621001.c"
...
entry:
  store ptr inttoptr (i64 5 to ptr), ptr %q, align 8, !tbaa !5
  ret void
}
...
entry:
  %call = tail call i32 (...) @example2() #3
  unreachable
}

declare i32 @example2(...) local_unnamed_addr #2

; Function Attrs: noreturn nounwind uwtable
define dso_local noundef i32 @main() local_unnamed_addr #1 {
entry:
  %call.i = tail call i32 (...) @example2() #3
  unreachable
}
