...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/154476578796324481950133360512396366906.c'
...
do.body:                                          ; preds = %sw.bb4.preheader, %do.body
...
for.body30:                                       ; preds = %do.body, %for.cond27
...
cleanup:                                          ; preds = %for.cond27, %for.body30
