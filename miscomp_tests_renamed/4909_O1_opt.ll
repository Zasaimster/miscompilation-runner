...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/197688370011695891075915333760211007307_O1.ll'
...
define dso_local i64 @f(i64 returned %x.coerce) local_unnamed_addr #0 {
entry:
...
entry:
  ...
  store i64 %bf.set, ptr @main.i.0, align 8, !tbaa !5
  %0 = and i64 %bf.load, 1099511627520
  %cmp7.not = icmp eq i64 %0, 884479243264
