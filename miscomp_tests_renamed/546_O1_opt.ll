; 118228044014512452799061833908224149731
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/118228044014512452799061833908224149731_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/118228044014512452799061833908224149731.c"
...
if.then:                                          ; preds = %entry
  %call1 = tail call i32 (...) @example9() #4
  %and = and i32 %call1, %c
  br label %cleanup
...
if.then.i:                                        ; preds = %entry
  %call1.i = tail call i32 (...) @example9() #4
  ret i32 0
