; 117581002903850864226282807307694577898
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/117581002903850864226282807307694577898_O0.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/117581002903850864226282807307694577898.c"
...
entry:
  ...
  %seqnum = getelementptr inbounds nuw %struct.DummyStruct, ptr %0, i32 0, i32 1
  %1 = load i32, ptr %seqnum, align 8
  %2 = load ptr, ptr %S2.addr, align 8
  %seqnum1 = getelementptr inbounds nuw %struct.DummyStruct, ptr %2, i32 0, i32 1
  %3 = load i32, ptr %seqnum1, align 8
  %add = add nsw i32 %1, %3
  %4 = load ptr, ptr %S3.addr, align 8
  %seqnum2 = getelementptr inbounds nuw %struct.DummyStruct, ptr %4, i32 0, i32 1
  %5 = load i32, ptr %seqnum2, align 8
