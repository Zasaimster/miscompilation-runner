...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/161099150305442904060147649088526471725_O1.ll'
...
entry:
  ...
  %add.ptr.i = getelementptr inbounds nuw i8, ptr %a, i64 2
  store ptr %add.ptr.i, ptr @q, align 8, !tbaa !5
  call void @abort() #5
  unreachable
}
