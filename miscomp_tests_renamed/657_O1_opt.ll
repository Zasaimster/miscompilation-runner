...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/136384437574614105785459182167430355940_O1.ll'
...
define dso_local noundef i32 @f(i32 noundef %n, i8 %x.coerce, i8 %y.coerce, i8 %z.coerce, i64 noundef %l) local_unnamed_addr #0 {
entry:
