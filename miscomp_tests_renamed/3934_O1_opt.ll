; 168685684663691177804729411778300358468
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/168685684663691177804729411778300358468_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/168685684663691177804729411778300358468.c"
...
define dso_local noundef i32 @foo(i32 noundef returned %x, i32 noundef %y) local_unnamed_addr #0 {
entry:
  ret i32 %x
}
...
entry:
  ...
  %1 = load i16, ptr @d, align 2, !tbaa !5
  %conv1.i = sext i16 %1 to i32
  store i32 %conv1.i, ptr @f, align 4, !tbaa !9
  %cmp13.i = icmp sgt i16 %0, 5
