...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/180399435172873835319295803853522401333_O1.ll'
...
entry:
  ...
  store volatile i32 5, ptr %x1, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %x2)
  store volatile i64 10, ptr %x2, align 8, !tbaa !9
