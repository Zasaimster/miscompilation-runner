...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/196352129853432418680317877388728704215_O0.ll'
...
entry:
  ...
  %arraydecay = getelementptr inbounds [1 x [0 x i8]], ptr %arr, i64 0, i64 0
  store ptr %arraydecay, ptr %p, align 8
  %arrayidx = getelementptr inbounds [1 x [0 x i8]], ptr %arr, i64 0, i64 1
  %arrayidx1 = getelementptr inbounds [0 x i8], ptr %arrayidx, i64 0, i64 3
  store ptr %arrayidx1, ptr %q, align 8
  %arrayidx2 = getelementptr inbounds [1 x [0 x i8]], ptr %arr, i64 0, i64 1
  %arrayidx3 = getelementptr inbounds [0 x i8], ptr %arrayidx2, i64 0, i64 3
  ...
  %arrayidx5 = getelementptr inbounds [1 x [0 x i8]], ptr %arr, i64 0, i64 1
  %arrayidx6 = getelementptr inbounds [0 x i8], ptr %arrayidx5, i64 0, i64 3
