; 151730466066430124959154264693707959859
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/151730466066430124959154264693707959859_O0.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/151730466066430124959154264693707959859.c"
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @anotherDummyFunc() #0 {
entry:
  %dummyVar = alloca i32, align 4
  store i32 100, ptr %dummyVar, align 4
  ret void
}
...
entry:
  ...
  %call = call i32 @test1(i32 noundef -30)
...
if.end:                                           ; preds = %entry
  %call1 = call i32 @test1(i32 noundef -29)
...
if.end4:                                          ; preds = %if.end
  %call5 = call i32 @test1(i32 noundef -20)
...
if.end8:                                          ; preds = %if.end4
  %call9 = call i32 @test1(i32 noundef -19)
...
if.end12:                                         ; preds = %if.end8
  %call13 = call i32 @test2(i32 noundef 0)
...
if.end20:                                         ; preds = %if.end16
  %call21 = call i32 @test2(i32 noundef 10)
...
if.end24:                                         ; preds = %if.end20
  %call25 = call i32 @test2(i32 noundef -1)
...
if.end28:                                         ; preds = %if.end24
  %call29 = call i32 @test2(i32 noundef -9)
...
if.end32:                                         ; preds = %if.end28
  %call33 = call i32 @test2(i32 noundef -10)
...
if.end36:                                         ; preds = %if.end32
  %call37 = call i32 @test3(i32 noundef -30)
...
if.end40:                                         ; preds = %if.end36
  %call41 = call i32 @test3(i32 noundef -29)
...
if.end44:                                         ; preds = %if.end40
  %call45 = call i32 @test3(i32 noundef -20)
...
if.end48:                                         ; preds = %if.end44
  %call49 = call i32 @test3(i32 noundef -19)
...
if.end52:                                         ; preds = %if.end48
  %call53 = call i32 @test4(i32 noundef 0)
...
if.end56:                                         ; preds = %if.end52
  %call57 = call i32 @test4(i32 noundef 9)
...
if.end60:                                         ; preds = %if.end56
  %call61 = call i32 @test4(i32 noundef 10)
...
if.end64:                                         ; preds = %if.end60
  %call65 = call i32 @test4(i32 noundef -1)
...
if.end68:                                         ; preds = %if.end64
  %call69 = call i32 @test4(i32 noundef -9)
...
if.end72:                                         ; preds = %if.end68
  %call73 = call i32 @test4(i32 noundef -10)
...
if.end76:                                         ; preds = %if.end72
  %call77 = call i32 @test5(i32 noundef -30)
...
if.end80:                                         ; preds = %if.end76
  %call81 = call i32 @test5(i32 noundef -29)
...
if.end84:                                         ; preds = %if.end80
  %call85 = call i32 @test5(i32 noundef -20)
...
if.end88:                                         ; preds = %if.end84
  %call89 = call i32 @test5(i32 noundef -19)
...
if.end92:                                         ; preds = %if.end88
  %call93 = call i32 @test6(i32 noundef 0)
...
if.end96:                                         ; preds = %if.end92
  %call97 = call i32 @test6(i32 noundef 9)
...
if.end100:                                        ; preds = %if.end96
  %call101 = call i32 @test6(i32 noundef 10)
...
if.end104:                                        ; preds = %if.end100
  %call105 = call i32 @test6(i32 noundef -1)
...
if.end108:                                        ; preds = %if.end104
  %call109 = call i32 @test6(i32 noundef -9)
...
if.end112:                                        ; preds = %if.end108
  %call113 = call i32 @test6(i32 noundef -10)
...
if.end116:                                        ; preds = %if.end112
  %call117 = call i32 @test7(i32 noundef -30)
...
if.end120:                                        ; preds = %if.end116
  %call121 = call i32 @test7(i32 noundef -29)
...
if.end124:                                        ; preds = %if.end120
  %call125 = call i32 @test7(i32 noundef -20)
...
if.end128:                                        ; preds = %if.end124
  %call129 = call i32 @test7(i32 noundef -19)
...
if.end132:                                        ; preds = %if.end128
  %call133 = call i32 @test8(i32 noundef 0)
...
if.end136:                                        ; preds = %if.end132
  %call137 = call i32 @test8(i32 noundef 9)
...
if.end140:                                        ; preds = %if.end136
  %call141 = call i32 @test8(i32 noundef 10)
...
if.end144:                                        ; preds = %if.end140
  %call145 = call i32 @test8(i32 noundef -1)
...
if.end148:                                        ; preds = %if.end144
  %call149 = call i32 @test8(i32 noundef -9)
...
if.end152:                                        ; preds = %if.end148
  %call153 = call i32 @test8(i32 noundef -10)
...
if.end156:                                        ; preds = %if.end152
  %call157 = call i32 @test9(i32 noundef -30)
...
if.end160:                                        ; preds = %if.end156
  %call161 = call i32 @test9(i32 noundef -29)
...
if.end164:                                        ; preds = %if.end160
  %call165 = call i32 @test9(i32 noundef -20)
...
if.end168:                                        ; preds = %if.end164
  %call169 = call i32 @test9(i32 noundef -19)
...
if.end172:                                        ; preds = %if.end168
  %call173 = call i32 @test10(i32 noundef 0)
...
if.end176:                                        ; preds = %if.end172
  %call177 = call i32 @test10(i32 noundef 9)
...
if.end180:                                        ; preds = %if.end176
  %call181 = call i32 @test10(i32 noundef 10)
...
if.end184:                                        ; preds = %if.end180
  %call185 = call i32 @test10(i32 noundef -1)
...
if.end188:                                        ; preds = %if.end184
  %call189 = call i32 @test10(i32 noundef -9)
...
if.end192:                                        ; preds = %if.end188
  %call193 = call i32 @test10(i32 noundef -10)
...
if.end196:                                        ; preds = %if.end192
  %call197 = call i32 @test11(i32 noundef -30)
...
if.end200:                                        ; preds = %if.end196
  %call201 = call i32 @test11(i32 noundef -29)
...
if.end204:                                        ; preds = %if.end200
  %call205 = call i32 @test11(i32 noundef -20)
...
if.end208:                                        ; preds = %if.end204
  %call209 = call i32 @test11(i32 noundef -19)
...
if.end212:                                        ; preds = %if.end208
  %call213 = call i32 @test12(i32 noundef 0)
...
if.end216:                                        ; preds = %if.end212
  %call217 = call i32 @test12(i32 noundef 9)
...
if.end220:                                        ; preds = %if.end216
  %call221 = call i32 @test12(i32 noundef 10)
...
if.end224:                                        ; preds = %if.end220
  %call225 = call i32 @test12(i32 noundef -1)
...
if.end228:                                        ; preds = %if.end224
  %call229 = call i32 @test12(i32 noundef -9)
...
if.end232:                                        ; preds = %if.end228
  %call233 = call i32 @test12(i32 noundef -10)
