...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/158889533132215505522579739426475244668_O1.ll'
...
define dso_local i32 @square(i32 noundef %x) local_unnamed_addr #2 {
entry:
  %mul = mul nsw i32 %x, %x
  ret i32 %mul
}
...
define dso_local void @simple_file() local_unnamed_addr #3 {
entry:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, argmem: none) uwtable
define dso_local void @simple_static_local() local_unnamed_addr #3 {
entry:
...
define dso_local void @simple_local() local_unnamed_addr #4 {
entry:
  %gx = alloca [100 x i32], align 16
  %ix = alloca i32, align 4
  call void @llvm.lifetime.start.p0(i64 400, ptr nonnull %gx) #9
  ...
  call void @llvm.lifetime.end.p0(i64 400, ptr nonnull %gx) #9
  ret void
}
...
define dso_local void @simple_arg(ptr noundef readonly captures(none) %g, ptr noundef readonly captures(none) %h, i32 noundef %i) local_unnamed_addr #6 {
entry:
...
entry:
  ...
  %0 = load ptr, ptr @ptr_str, align 8, !tbaa !12
  tail call void @llvm.prefetch.p0(ptr %0, i32 0, i32 0, i32 1)
  ...
  %1 = load ptr, ptr getelementptr inbounds nuw (i8, ptr @str, i64 16), align 8, !tbaa !14
  tail call void @llvm.prefetch.p0(ptr %1, i32 0, i32 0, i32 1)
  %next = getelementptr inbounds nuw i8, ptr %0, i64 16
  %2 = load ptr, ptr %next, align 8, !tbaa !14
  ...
  %4 = load i32, ptr @glob_int, align 4, !tbaa !10
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %b) #9
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %t) #9
  ...
  call void @llvm.prefetch.p0(ptr nonnull %add.ptr14, i32 0, i32 0, i32 1)
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %t) #9
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %b) #9
  ret void
}
...
entry:
  ...
  tail call void @llvm.prefetch.p0(ptr nonnull @simple_static_local.gx, i32 0, i32 0, i32 1)
  tail call void @llvm.prefetch.p0(ptr nonnull @simple_static_local.ix, i32 0, i32 0, i32 1)
  call void @llvm.lifetime.start.p0(i64 400, ptr nonnull %gx.i) #9
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %ix.i) #9
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %ix.i) #9
  call void @llvm.lifetime.end.p0(i64 400, ptr nonnull %gx.i) #9
  %1 = load i32, ptr @glob_int, align 4, !tbaa !10
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %i.addr.i)
  store i32 %1, ptr %i.addr.i, align 4, !tbaa !10
  tail call void @llvm.prefetch.p0(ptr nonnull @glob_int_arr, i32 0, i32 0, i32 1)
  ...
  store ptr @str, ptr getelementptr inbounds nuw (i8, ptr @str, i64 16), align 8, !tbaa !14
...
attributes #3 = { mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, argmem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #4 = { mustprogress nofree norecurse nosync nounwind willreturn memory(inaccessiblemem: readwrite) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #5 = { nocallback nofree nosync nounwind willreturn memory(argmem: readwrite) }
attributes #6 = { mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite, inaccessiblemem: readwrite) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
attributes #8 = { nofree noreturn "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
!11 = !{!"int", !8, i64 0}
!12 = !{!13, !13, i64 0}
!13 = !{!"p1 _ZTS1S", !7, i64 0}
!14 = !{!15, !13, i64 16}
!15 = !{!"S", !11, i64 0, !16, i64 4, !16, i64 6, !8, i64 8, !13, i64 16}
!16 = !{!"short", !8, i64 0}
