...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/19409211219702877825564369023460889035_O1.ll'
...
define dso_local noundef ptr @test(ptr noundef readnone returned captures(ret: address, provenance) %node) local_unnamed_addr #0 {
entry:
  ret ptr %node
}
