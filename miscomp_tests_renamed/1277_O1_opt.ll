; 156436640747887243502163575456702906246
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/156436640747887243502163575456702906246_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/156436640747887243502163575456702906246.c"
...
define dso_local noundef range(i32 -5, 6) i32 @f(i32 noundef %x) local_unnamed_addr #0 {
entry:
  %call = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %x)
  %tobool.not = icmp eq i32 %call, 0
  %cond = select i1 %tobool.not, i32 -5, i32 5
  ret i32 %cond
}
