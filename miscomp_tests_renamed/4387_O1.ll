...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/176987141583046419845837325307597317124.c'
...
for.inc:                                          ; preds = %lor.lhs.false, %land.lhs.true10, %for.body6
...
for.body6.i:                                      ; preds = %for.body.i, %for.inc.i
