...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/106255199540674486931853147295561610792_O1.ll'
...
for.cond5:                                        ; preds = %for.cond1.for.cond3.preheader_crit_edge, %for.cond1.preheader
