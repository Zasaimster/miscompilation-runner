...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/107312870087145221458424627438483667652_O0.ll'
...
for.end:                                          ; preds = %for.cond
  ...
  store i8 %conv, ptr %e, align 1
  %2 = load i8, ptr %e, align 1
  %conv1 = sext i8 %2 to i32
  %3 = load i32, ptr @b, align 4
  %xor = xor i32 %conv1, %3
  %conv2 = trunc i32 %xor to i8
  store i8 %conv2, ptr %f, align 1
  %4 = load i8, ptr %f, align 1
  %conv3 = sext i8 %4 to i32
  store volatile i32 %conv3, ptr %g, align 4
  %5 = load volatile i32, ptr %g, align 4
  %cmp4 = icmp ne i32 %5, -15
