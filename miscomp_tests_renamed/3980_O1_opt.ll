; 111701689942985065183087965895788257013
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/111701689942985065183087965895788257013_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/111701689942985065183087965895788257013.c"
...
entry:
  ...
  %cond.i = select i1 %cmp.i, i32 %call.i, i32 %sub.i
  store i32 %cond.i, ptr getelementptr inbounds nuw (i8, ptr @a, i64 4), align 4, !tbaa !5
  %cmp2.not.i = icmp slt i32 %cond.i, %sub.i
  br i1 %cmp2.not.i, label %foo.exit, label %if.then.i
