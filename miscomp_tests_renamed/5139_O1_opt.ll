...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/190734313659832621700783866346624757687_O1.ll'
...
entry:
  ...
  %trunc = trunc i8 %bf.load to i1
  %rev = tail call i1 @llvm.bitreverse.i1(i1 %trunc)
