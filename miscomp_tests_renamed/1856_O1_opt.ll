...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/132962015421314434300152438321020076136_O1.ll'
...
entry:
  ...
  %call1 = tail call i32 (i32, ...) @ZERO_1(i32 noundef 1) #3
  %tobool.not = icmp eq i32 %call1, 0
  br i1 %tobool.not, label %if.end, label %return

if.end:                                           ; preds = %entry
  %call2 = tail call i32 (i32, i32, ...) @ZERO_2(i32 noundef 1, i32 noundef 2) #3
  %tobool3.not = icmp eq i32 %call2, 0
  br i1 %tobool3.not, label %if.end5, label %return

if.end5:                                          ; preds = %if.end
  %call6 = tail call i32 (i32, ...) @ZERO_VAR(i32 noundef 1) #3
  %tobool7.not = icmp eq i32 %call6, 0
  br i1 %tobool7.not, label %if.end9, label %return

if.end9:                                          ; preds = %if.end5
  %call10 = tail call i32 (i32, i32, ...) @ZERO_VAR(i32 noundef 1, i32 noundef 2) #3
  %tobool11.not = icmp eq i32 %call10, 0
  br i1 %tobool11.not, label %if.end13, label %return

if.end13:                                         ; preds = %if.end9
  %call14 = tail call i32 (i32, i32, ...) @ZERO_1_VAR(i32 noundef 1, i32 noundef 2) #3
  %tobool15.not = icmp eq i32 %call14, 0
  br i1 %tobool15.not, label %if.end17, label %return

if.end17:                                         ; preds = %if.end13
  %call18 = tail call i32 (i32, i32, i32, ...) @ZERO_1_VAR(i32 noundef 1, i32 noundef 2, i32 noundef 3) #3
  %tobool19.not = icmp ne i32 %call18, 0
  %. = zext i1 %tobool19.not to i32
  br label %return

return:                                           ; preds = %if.end17, %if.end13, %if.end9, %if.end5, %if.end, %entry
  %retval.0 = phi i32 [ 1, %entry ], [ 1, %if.end ], [ 1, %if.end5 ], [ 1, %if.end9 ], [ 1, %if.end13 ], [ %., %if.end17 ]
  ret i32 %retval.0
}
