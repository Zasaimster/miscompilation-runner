...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/155140876404844211407356887723818754535.c'
...
define dso_local range(i32 0, 257) i32 @f(ptr noundef readonly captures(none) %a) local_unnamed_addr #0 {
entry:
