...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/100411270287232556668441553891593833514_O1.ll'
...
define dso_local void @foo(ptr noundef readnone captures(none) %sp, i32 noundef %cnt) local_unnamed_addr #0 {
entry:
  ret void
}
