...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/189925924068820709461555363083365855400_O1.ll'
...
define dso_local range(i64 10, 9) i64 @signed_poly(i64 noundef %sum, i64 noundef %x) local_unnamed_addr #0 {
entry:
  %add = shl i64 %sum, 1
  %mul = add i64 %add, 10
  ret i64 %mul
