...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/117921187684821710045584422262890835233_O1.ll'
...
; Function Attrs: nofree nounwind uwtable
define dso_local i32 @eq(i32 noundef %a, i32 noundef %b) local_unnamed_addr #0 {
entry:
...
for.body:                                         ; preds = %eq.exit, %entry
  %i.05 = phi i32 [ 0, %entry ], [ %inc, %eq.exit ]
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %j) #8
  store i32 %i.05, ptr %j, align 4, !tbaa !5
  %call = call i32 (ptr, ...) @sub3(ptr noundef nonnull %j) #8
...
eq.exit:                                          ; preds = %for.body
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %j) #8
...
declare i32 @sub3(...) local_unnamed_addr #5
