; 168512103474551280549689742049970516610
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/168512103474551280549689742049970516610_O0.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/168512103474551280549689742049970516610.c"
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %i = getelementptr inbounds nuw %struct.F, ptr %0, i32 0, i32 0
...
for.inc:                                          ; preds = %if.end
  ...
  %i2 = getelementptr inbounds nuw %struct.F, ptr %3, i32 0, i32 0
  %4 = load i32, ptr %i2, align 4
  %inc3 = add nsw i32 %4, 1
  store i32 %inc3, ptr %i2, align 4
