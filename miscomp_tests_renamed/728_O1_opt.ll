...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/112869738681587421038305805630334657421_O1.ll'
...
@e = dso_local local_unnamed_addr global [0 x i8] zeroinitializer, align 1
...
entry:
  ...
  %cmp12 = icmp slt i32 %i.promoted, 1
...
for.body:                                         ; preds = %for.inc, %for.body.lr.ph
  %inc1113 = phi i32 [ %i.promoted, %for.body.lr.ph ], [ %inc, %for.inc ]
  %2 = phi i32 [ %f.promoted, %for.body.lr.ph ], [ %6, %for.inc ]
...
for.inc:                                          ; preds = %if.end, %for.body
  %6 = phi i32 [ %2, %for.body ], [ %3, %if.end ]
  %inc = add i32 %inc1113, 1
  %exitcond.not = icmp eq i32 %inc1113, 0
...
for.end:                                          ; preds = %for.cond.for.end_crit_edge, %entry
  %7 = load i8, ptr @e, align 1, !tbaa !9
  %8 = lshr i8 %7, 1
  %9 = and i8 %8, 1
  %idxprom = zext nneg i8 %9 to i64
  %arrayidx = getelementptr inbounds nuw [30 x i32], ptr @a, i64 0, i64 %idxprom
