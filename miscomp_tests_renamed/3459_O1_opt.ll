...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/130523865751176456057687708603311041855_O1.ll'
...
for.cond1.preheader:                              ; preds = %for.inc44, %entry
  %indvars.iv76 = phi i64 [ 0, %entry ], [ %indvars.iv.next77, %for.inc44 ]
  br label %for.cond4.preheader

for.cond4.preheader:                              ; preds = %for.inc41, %for.cond1.preheader
  %indvars.iv78 = phi i64 [ %indvars.iv76, %for.cond1.preheader ], [ %indvars.iv.next79, %for.inc41 ]
  br label %for.cond7.preheader

for.cond7.preheader:                              ; preds = %for.inc38, %for.cond4.preheader
