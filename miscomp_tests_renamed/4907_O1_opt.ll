; 197725999957959382050619229123943398437
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/197725999957959382050619229123943398437_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/197725999957959382050619229123943398437.c"
...
entry:
  ...
  store i64 %conv, ptr @acc, align 8, !tbaa !5
  %puts = tail call i32 @puts(ptr nonnull dereferenceable(1) @str)
  %0 = load i64, ptr @acc, align 8, !tbaa !5
  %cmp.not = icmp eq i64 %0, 281474976710656
...
if.end:                                           ; preds = %entry
  %sub.i = add nsw i64 %0, -4294967296
  store i64 %sub.i, ptr @acc, align 8, !tbaa !5
  %cmp4.not = icmp eq i64 %sub.i, 281470681743360
