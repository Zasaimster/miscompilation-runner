...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/143420764875634923536316732811398835580_O1.ll'
...
entry:
  %call = tail call i32 (...) @example4() #5
  %0 = load ptr, ptr @p, align 8, !tbaa !5
  store i16 1, ptr %0, align 2, !tbaa !9
  ret i32 10
}

declare i32 @example4(...) local_unnamed_addr #2
