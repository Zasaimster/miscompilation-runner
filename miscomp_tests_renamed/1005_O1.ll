...
return:                                           ; preds = %if.end9, %if.end5, %if.end, %entry
  %retval.0 = phi i32 [ 1, %entry ], [ -1, %if.end ], [ 1, %if.end5 ], [ %., %if.end9 ]
  ret i32 %retval.0
}
...
if.then:                                          ; preds = %land.lhs.true, %if.end5.i
  tail call void @abort() #3
  unreachable

if.end:                                           ; preds = %if.end.i, %if.end5.i, %for.body3
...
if.then16:                                        ; preds = %land.lhs.true9, %if.end.i48, %if.end5.i51
  tail call void @abort() #3
  unreachable
...
land.lhs.true19:                                  ; preds = %if.end17
  ...
  %call.i58 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str)
...
if.then26:                                        ; preds = %if.end.i61, %if.end5.i64
  tail call void @abort() #3
  unreachable

for.inc:                                          ; preds = %land.lhs.true19, %if.end17, %if.end5.i64
