...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/185570336819358149377055692835648353723_O0.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx8 = getelementptr inbounds [6 x i16], ptr @bndpsd, i64 0, i64 %idxprom7
  %10 = load i32, ptr %j, align 4
  %idxprom9 = sext i32 %10 to i64
  %arrayidx10 = getelementptr inbounds [6 x i16], ptr @psd, i64 0, i64 %idxprom9
  %call = call signext i16 @logadd(ptr noundef %arrayidx8, ptr noundef %arrayidx10)
  %11 = load i32, ptr %k, align 4
  %idxprom11 = sext i32 %11 to i64
  %arrayidx12 = getelementptr inbounds [6 x i16], ptr @bndpsd, i64 0, i64 %idxprom11
  store i16 %call, ptr %arrayidx12, align 2
