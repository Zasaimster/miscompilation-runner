; 193287861120852976443437070580725522122
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/193287861120852976443437070580725522122_O0.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/193287861120852976443437070580725522122.c"
...
if.end:                                           ; preds = %if.then, %entry
  %4 = load i32, ptr %noPrint.addr, align 4
...
if.end2:                                          ; preds = %if.then1, %if.end
  ...
  %seqnum = getelementptr inbounds nuw %struct.DummyStruct, ptr %5, i32 0, i32 1
  %6 = load i32, ptr %seqnum, align 8
  %7 = load ptr, ptr %S2.addr, align 8
  %seqnum3 = getelementptr inbounds nuw %struct.DummyStruct, ptr %7, i32 0, i32 1
  %8 = load i32, ptr %seqnum3, align 8
  %add = add nsw i32 %6, %8
  %9 = load ptr, ptr %S3.addr, align 8
  %seqnum4 = getelementptr inbounds nuw %struct.DummyStruct, ptr %9, i32 0, i32 1
  %10 = load i32, ptr %seqnum4, align 8
