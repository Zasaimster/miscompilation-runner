; 159980212991436399494019987649788525659
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/159980212991436399494019987649788525659_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/159980212991436399494019987649788525659.c"
...
entry:
  ...
  tail call void %f2(float noundef 2.500000e+00, float noundef 3.500000e+00) #6
  ret i32 undef
}
...
entry:
  tail call void %f3(float noundef 6.000000e+00) #6
  tail call void %f1(double noundef 3.000000e+00) #6
  %0 = sext i32 %i to i64
  %1 = getelementptr float, ptr %f, i64 %0
  %arrayidx = getelementptr i8, ptr %1, i64 4
  %2 = load float, ptr %arrayidx, align 4, !tbaa !5
