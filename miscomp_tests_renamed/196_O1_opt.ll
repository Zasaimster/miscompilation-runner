; 105012100521793284321673806908060285325
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/105012100521793284321673806908060285325_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/105012100521793284321673806908060285325.c"
...
entry:
  ...
  %call7 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.5, i32 noundef %3)
  %4 = load i32, ptr getelementptr inbounds nuw (i8, ptr @bolshevic, i64 8), align 4, !tbaa !11
  %call9 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.6, i32 noundef %4)
  %5 = load i32, ptr getelementptr inbounds nuw (i8, ptr @bolshevic, i64 4), align 4, !tbaa !12
  %call10 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %5)
  ret i32 0
}
