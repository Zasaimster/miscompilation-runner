...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/140179510703954690252760438974961500673_O1.ll'
...
@a = dso_local local_unnamed_addr global [3 x ptr] zeroinitializer, align 16
...
for.body:                                         ; preds = %for.body, %entry
  ...
  %arrayidx = getelementptr inbounds nuw [3 x ptr], ptr @a, i64 0, i64 %indvars.iv
