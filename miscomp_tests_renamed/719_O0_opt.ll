...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/131466718533608738363716135498160478493_O0.ll'
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %seqnum = getelementptr inbounds nuw %struct.DummyStruct, ptr %1, i32 0, i32 1
  %2 = load i32, ptr %seqnum, align 8
  %3 = load ptr, ptr %S2.addr, align 8
  %seqnum1 = getelementptr inbounds nuw %struct.DummyStruct, ptr %3, i32 0, i32 1
  %4 = load i32, ptr %seqnum1, align 8
  %add = add nsw i32 %2, %4
  %5 = load ptr, ptr %S3.addr, align 8
  %seqnum2 = getelementptr inbounds nuw %struct.DummyStruct, ptr %5, i32 0, i32 1
  %6 = load i32, ptr %seqnum2, align 8
