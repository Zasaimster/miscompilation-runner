; 127427992665562431412403268483931538006
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/127427992665562431412403268483931538006_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/127427992665562431412403268483931538006.c"
...
if.then6:                                         ; preds = %if.then
  %call.i = tail call i32 (...) @example2() #2
  br label %if.end7
...
if.then6.i:                                       ; preds = %if.then.i
  %call.i.i = tail call i32 (...) @example2() #2
  br label %foo.exit

foo.exit:                                         ; preds = %if.then6.i, %if.then.i, %entry
  ret i32 0
}
