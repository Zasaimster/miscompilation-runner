; 168450050891887172703563408011919089932
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/168450050891887172703563408011919089932_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/168450050891887172703563408011919089932.c"
...
entry:
  %call = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %bit)
  %and = and i32 %call, 1
  %call1 = tail call i32 (i32, i32, ...) @show(i32 noundef 10, i32 noundef 20) #6
...
entry:
  ...
  %call1.i = tail call i32 (i32, i32, ...) @show(i32 noundef 10, i32 noundef 20) #6
...
if.end:                                           ; preds = %entry
  %call.i9 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef 1)
  %and.i10 = and i32 %call.i9, 1
  %call1.i11 = tail call i32 (i32, i32, ...) @show(i32 noundef 10, i32 noundef 20) #6
...
if.end4:                                          ; preds = %if.end
  %call.i14 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef 65535)
  %and.i15 = and i32 %call.i14, 1
  %call1.i16 = tail call i32 (i32, i32, ...) @show(i32 noundef 10, i32 noundef 20) #6
