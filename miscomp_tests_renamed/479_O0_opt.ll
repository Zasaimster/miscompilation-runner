...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/199039268899826621824290244449272953214_O0.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/199039268899826621824290244449272953214.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.C = type { [0 x %struct.B], i32, i32 }
...
entry:
  ...
  %arrayidx = getelementptr inbounds [0 x %struct.B], ptr %c1, i64 0, i64 %idxprom
...
if.end:                                           ; preds = %if.then, %do.body
  ...
  %arrayidx7 = getelementptr inbounds [0 x %struct.B], ptr %c15, i64 0, i64 %idxprom6
...
do.end:                                           ; preds = %do.cond
  ...
  %arrayidx25 = getelementptr inbounds [0 x %struct.B], ptr %c123, i64 0, i64 %idxprom24
...
entry:
  ...
  call void @llvm.memset.p0.i64(ptr align 4 %b, i8 0, i64 8, i1 false)
  %c1 = getelementptr inbounds nuw %struct.C, ptr %b, i32 0, i32 0
  %arrayidx = getelementptr inbounds [0 x %struct.B], ptr %c1, i64 0, i64 0
