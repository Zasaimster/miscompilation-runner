...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/192123639878332189534714321959167890013_O1.ll'
...
define dso_local range(i32 0, -2147483648) i32 @f(ptr noundef readonly captures(none) %a) local_unnamed_addr #0 {
entry:
...
entry:
  ...
  %sub.i = sub nsw i32 8, %call.i
  %sub.lobit.i = lshr i32 %sub.i, 31
  %y.0.i = tail call i32 @llvm.abs.i32(i32 %sub.i, i1 true)
  %add.i = add nuw nsw i32 %sub.lobit.i, %y.0.i
  %cmp.not = icmp eq i32 %add.i, 2
