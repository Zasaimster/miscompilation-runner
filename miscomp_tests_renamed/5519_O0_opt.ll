...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/197725999957959382050619229123943398437_O0.ll'
...
if.end:                                           ; preds = %entry
  %call3 = call i32 @subhi(i16 noundef signext 1)
  %1 = load i64, ptr @acc, align 8
  %cmp4 = icmp ne i64 %1, 281470681743360
