...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/192406314699802248569596981428279087246_O0.ll'
...
@glob_ptr_int = dso_local global ptr null, align 8
...
entry:
  ...
  call void @llvm.prefetch.p0(ptr getelementptr inbounds ([42 x i32], ptr @glob_int_arr, i64 0, i64 2), i32 0, i32 0, i32 1)
