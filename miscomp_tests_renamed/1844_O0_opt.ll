...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/132672678131599236314092420401418541485_O0.ll'
...
lor.end:                                          ; preds = %lor.rhs, %entry
  ...
  %call = call signext i16 @fn1(i32 noundef %lor.ext, i32 noundef %3)
  %conv3 = sext i16 %call to i32
  %cmp = icmp sge i32 %conv3, 2
