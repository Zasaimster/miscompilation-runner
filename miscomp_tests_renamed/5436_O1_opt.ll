...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/196224537942845944281765503668374964534_O1.ll'
...
if.else3:                                         ; preds = %if.else
  %sub = add nsw i32 %m, -1
  tail call void @foo(i32 noundef 0, i32 noundef %sub)
