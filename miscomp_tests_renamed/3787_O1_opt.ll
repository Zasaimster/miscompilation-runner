...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/133193544094758230098234043798939294578_O1.ll'
...
cleanup:                                          ; preds = %if.end4, %if.end, %entry
  %retval.0 = phi i32 [ 0, %entry ], [ 0, %if.end4 ], [ 1, %if.end ]
  ret i32 %retval.0
}
