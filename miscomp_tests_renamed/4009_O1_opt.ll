; 183065210564440436250356134752369954066
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/183065210564440436250356134752369954066_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/183065210564440436250356134752369954066.c"
...
define dso_local range(i64 -32768, 32768) i64 @foo(ptr noundef %p) local_unnamed_addr #0 {
entry:
  %0 = load i16, ptr %p, align 2, !tbaa !5
  %conv = sext i16 %0 to i64
  %add.ptr = getelementptr inbounds nuw i8, ptr %p, i64 2
  store ptr %add.ptr, ptr @q, align 8, !tbaa !9
  ret i64 %conv
}
