...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/179969144747271364683191442563850503619_O1.ll'
...
; Function Attrs: nofree nounwind uwtable
define dso_local noundef range(i64 0, 4) i64 @foo() local_unnamed_addr #0 {
entry:
