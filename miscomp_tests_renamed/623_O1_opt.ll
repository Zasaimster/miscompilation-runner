...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/111163854696749096161136779760690192192_O1.ll'
...
entry:
  ...
  br i1 %tobool.not5, label %for.inc, label %for.end

for.inc:                                          ; preds = %for.inc, %entry
  %mask.07 = phi i32 [ %shl, %for.inc ], [ 1, %entry ]
  %bit.06 = phi i32 [ %inc, %for.inc ], [ 1, %entry ]
