; 161537262513396997983632828871986222458
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/161537262513396997983632828871986222458.c'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/161537262513396997983632828871986222458.c"
...
for.cond1.preheader:                              ; preds = %entry, %for.inc58
  %i.096 = phi i32 [ 0, %entry ], [ %inc59, %for.inc58 ]
  %cmp294 = icmp samesign ult i32 %i.096, 4
  br i1 %cmp294, label %for.cond4.preheader.lr.ph, label %for.inc58

for.cond4.preheader.lr.ph:                        ; preds = %for.cond1.preheader
  %0 = shl nuw nsw i32 %i.096, 6
  br label %for.cond4.preheader

for.cond4.preheader:                              ; preds = %for.cond4.preheader.lr.ph, %for.inc55
  %j.095 = phi i32 [ %i.096, %for.cond4.preheader.lr.ph ], [ %inc56, %for.inc55 ]
  %cmp10 = icmp eq i32 %j.095, %i.096
  %1 = shl nuw nsw i32 %j.095, 6
  br label %for.cond7.preheader

for.cond7.preheader:                              ; preds = %for.cond4.preheader, %for.inc52
  %ki.093 = phi i32 [ 0, %for.cond4.preheader ], [ %inc53, %for.inc52 ]
  %2 = shl nuw nsw i32 %ki.093, 5
  %x.offs90 = add nuw nsw i32 %2, %0
  br label %for.body9

for.body9:                                        ; preds = %for.cond7.preheader, %for.inc49
...
for.inc55:                                        ; preds = %for.inc52
  %inc56 = add nuw nsw i32 %j.095, 1
  %exitcond.not = icmp eq i32 %inc56, 4
  br i1 %exitcond.not, label %for.inc58, label %for.cond4.preheader, !llvm.loop !9

for.inc58:                                        ; preds = %for.inc55, %for.cond1.preheader
  %inc59 = add nuw nsw i32 %i.096, 1
  %exitcond97.not = icmp eq i32 %inc59, 5
  br i1 %exitcond97.not, label %for.end60, label %for.cond1.preheader, !llvm.loop !10
