...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/17166765229601486359094579848076515166_O1.ll'
...
define dso_local noalias noundef nonnull ptr @f(ptr noundef readnone captures(none) %clas, i32 noundef %size) local_unnamed_addr #0 {
entry:
  unreachable
}
