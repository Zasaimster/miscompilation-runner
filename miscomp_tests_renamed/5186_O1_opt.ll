...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/191525652885769078160536934695144326740_O1.ll'
...
if.end:                                           ; preds = %top
  ...
  store i64 1, ptr %arrayidx7, align 8, !tbaa !10
  ret void
}
...
entry:
  ...
  store i64 58, ptr @m, align 8, !tbaa !10
