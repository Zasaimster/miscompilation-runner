...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/138218647697518355758003259343064856362_O1.ll'
...
define dso_local noalias noundef ptr @test(ptr noundef readnone captures(none) %node) local_unnamed_addr #0 {
entry:
  ret ptr null
}
