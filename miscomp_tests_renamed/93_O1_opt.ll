...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/101727432379709309055157817236572181046_O1.ll'
...
f.exit:                                           ; preds = %f.exit, %entry
  ...
  br i1 %exitcond.not, label %for.end, label %f.exit, !llvm.loop !8
