...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/173741884191377946520717735852901496138_O1.ll'
...
entry:
  ...
  %0 = or disjoint i16 %bf.shl, %bf.clear2
  %bf.set9 = or disjoint i16 %0, %bf.value
