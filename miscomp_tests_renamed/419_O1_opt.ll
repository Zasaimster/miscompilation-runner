; 106976724472931610939184517758297707270
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/106976724472931610939184517758297707270_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/106976724472931610939184517758297707270.c"
...
define dso_local i32 @f(ptr noundef writeonly captures(none) %d, ptr noundef readonly captures(none) %x, ptr noundef readonly captures(none) %y, i32 noundef %n) local_unnamed_addr #0 {
entry:
...
while.body:                                       ; preds = %while.body, %entry
  %d.addr.07 = phi ptr [ %incdec.ptr2, %while.body ], [ %d, %entry ]
  ...
  %incdec.ptr2 = getelementptr inbounds nuw i8, ptr %d.addr.07, i64 4
  store i32 %conv, ptr %d.addr.07, align 4, !tbaa !9
...
entry:
  ...
  br i1 %tobool.not4.i, label %for.body.preheader, label %while.body.i

while.body.i:                                     ; preds = %while.body.i, %entry
  %d.addr.07.i = phi ptr [ %incdec.ptr2.i, %while.body.i ], [ %r, %entry ]
  ...
  %incdec.ptr2.i = getelementptr inbounds nuw i8, ptr %d.addr.07.i, i64 4
  store i32 %conv.i, ptr %d.addr.07.i, align 4, !tbaa !9
  %call.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str)
  %tobool.not.i = icmp eq i32 %call.i, 0
  br i1 %tobool.not.i, label %for.body.preheader, label %while.body.i, !llvm.loop !11

for.body.preheader:                               ; preds = %while.body.i, %entry
  br label %for.body
