; 143842195690128184872376727974226181512
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/143842195690128184872376727974226181512_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/143842195690128184872376727974226181512.c"
...
entry:
  ...
  %or.cond5 = select i1 %cmp1, i1 true, i1 %cmp3
...
if.end:                                           ; preds = %entry
  %call4 = tail call i32 (i32, ...) @process(i32 noundef 100) #8
  tail call void @exit(i32 noundef 0) #7
  unreachable
}

; Function Attrs: nofree nounwind uwtable
define dso_local noundef i32 @x(i32 noundef %argc, ptr noundef readonly captures(none) %argv) local_unnamed_addr #1 {
entry:
...
if.then:                                          ; preds = %land.lhs.true2
  %call.i = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %1, ptr noundef nonnull dereferenceable(2) @.str) #8
...
s.exit:                                           ; preds = %lor.lhs.false.i
  %call.i46 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %1, ptr noundef nonnull dereferenceable(2) @.str) #8
...
lor.lhs.false.i49:                                ; preds = %s.exit
  ...
  store i32 %inc.i50, ptr @check, align 4, !tbaa !5
...
while.cond.preheader:                             ; preds = %s.exit53
  %o.promoted = load i32, ptr @o, align 4, !tbaa !5
...
while.body:                                       ; preds = %r.exit, %while.body.preheader
  ...
  %6 = load ptr, ptr %arrayidx26, align 8, !tbaa !9
...
declare i32 @process(...) local_unnamed_addr #3

; Function Attrs: nofree noreturn
declare void @exit(i32 noundef) local_unnamed_addr #4

; Function Attrs: nofree nounwind uwtable
define dso_local noalias noundef ptr @s(ptr noundef %v, ptr noundef writeonly captures(none) %pp) local_unnamed_addr #1 {
entry:
  %call = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %v, ptr noundef nonnull dereferenceable(2) @.str) #8
...
define dso_local noalias noundef nonnull ptr @m(ptr noundef readnone captures(none) %x) local_unnamed_addr #5 {
entry:
  tail call void @abort() #7
  unreachable
}
...
; Function Attrs: nofree nounwind uwtable
define dso_local noundef i32 @r(ptr noundef readonly captures(none) %f) local_unnamed_addr #1 {
entry:
