...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/105895132073917518089302822005119786918.c'
...
for.body4.i64:                                    ; preds = %powmod_ll.exit, %for.inc9.i76
...
for.body4.i84:                                    ; preds = %powmod_ll.exit80, %for.inc9.i96
...
for.inc:                                          ; preds = %powmod_ll.exit100, %if.then20, %if.then13
