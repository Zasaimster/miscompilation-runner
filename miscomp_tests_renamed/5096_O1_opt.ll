...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/121560578627806871884786080295410276779_O1.ll'
...
for.body:                                         ; preds = %if.end, %entry
  %storemerge2 = phi i32 [ 0, %entry ], [ %inc, %if.end ]
  %cmp1 = icmp eq i32 %storemerge2, 1
