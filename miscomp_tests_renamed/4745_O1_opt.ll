...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/18368275829728973339333484279437801915_O1.ll'
...
entry:
  ...
  %arrayidx2 = getelementptr inbounds nuw i8, ptr %vla, i64 36
...
entry:
  %call = tail call { double, double } @f()
