...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/12077414949917592060295647369676645892_O1.ll'
...
if.end.i48:                                       ; preds = %land.lhs.true9
  %call.i49 = tail call i32 (...) @func1() #3
...
if.then16:                                        ; preds = %if.end6.i51, %if.end.i48, %land.lhs.true9
  tail call void @abort() #4
  unreachable
...
if.end.i61:                                       ; preds = %land.lhs.true19
  %call.i62 = tail call i32 (...) @func1() #3
...
if.then26:                                        ; preds = %if.end6.i64, %if.end.i61
  tail call void @abort() #4
  unreachable
