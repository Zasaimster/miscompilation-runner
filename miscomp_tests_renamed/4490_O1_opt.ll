...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/179019254034504788418688841907939518512_O1.ll'
...
entry:
  %cmp.not = icmp eq i16 %y.coerce, 11
...
if.end:                                           ; preds = %entry
  %cmp6.not = icmp eq i16 %z.coerce, 12
