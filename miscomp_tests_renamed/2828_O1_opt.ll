...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/149490370351959078254201325849606936687_O1.ll'
...
entry:
  %call = tail call i32 (ptr, double, ...) @f(ptr noundef null, double noundef 5.510000e+01) #6
