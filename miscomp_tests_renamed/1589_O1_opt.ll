...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/128352363045284578672297731165433451731_O1.ll'
...
while.cond1:                                      ; preds = %if.end5, %entry
  %x.0 = phi i32 [ 0, %entry ], [ %add, %if.end5 ]
  switch i32 %x.0, label %if.end5 [
    i32 5, label %do.end
    i32 0, label %if.else
  ]
...
if.end5:                                          ; preds = %if.else, %while.cond1
