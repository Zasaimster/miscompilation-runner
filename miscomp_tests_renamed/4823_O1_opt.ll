; 185339288755293270411645141713597636965
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/185339288755293270411645141713597636965_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/185339288755293270411645141713597636965.c"
...
do.body.i:                                        ; preds = %do.body.i, %entry
  %timeout.0.i = phi i64 [ 20, %entry ], [ %dec.i, %do.body.i ]
