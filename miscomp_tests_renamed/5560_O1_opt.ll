...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/103499401066954001375384703885820729686_O1.ll'
...
define dso_local range(i32 -1, 2) i32 @foo() local_unnamed_addr #0 {
entry:
  %0 = load i64, ptr @a, align 8, !tbaa !5
  %rem = srem i64 %0, 2
  %switch.selectcmp = icmp eq i64 %rem, 1
  %switch.select = select i1 %switch.selectcmp, i32 1, i32 -1
  %switch.selectcmp9 = icmp eq i64 %rem, 0
  %switch.select10 = select i1 %switch.selectcmp9, i32 0, i32 %switch.select
...
entry:
  ...
  %switch.selectcmp.i = icmp eq i64 %1, 1
