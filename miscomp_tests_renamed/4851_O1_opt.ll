; 185810652802409239206338879457327284868
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/185810652802409239206338879457327284868_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/185810652802409239206338879457327284868.c"
...
lor.lhs.false6:                                   ; preds = %lor.lhs.false4
  ...
  %3 = load i32, ptr %e, align 4, !tbaa !12
  %cmp7 = icmp ne i32 %3, 5
...
; Function Attrs: nounwind uwtable
define dso_local void @foo(ptr readnone captures(none) %z, ptr noundef readonly byval(%struct.baz) align 8 captures(none) %x, ptr readnone captures(none) %y) local_unnamed_addr #0 {
entry:
  %call.i = tail call i32 (...) @unusedFunction() #6
  %cmp.not.i = icmp ne i32 %call.i, 1
  %b.i = getelementptr inbounds nuw i8, ptr %x, i64 4
  %0 = load i32, ptr %b.i, align 4
  %cmp1.not.i = icmp ne i32 %0, 2
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 20, ptr nonnull %x) #6
  store i32 1, ptr %x, align 8, !tbaa !13
  %b = getelementptr inbounds nuw i8, ptr %x, i64 4
  store i32 2, ptr %b, align 4, !tbaa !5
  %c = getelementptr inbounds nuw i8, ptr %x, i64 8
  store i32 3, ptr %c, align 8, !tbaa !10
  %d = getelementptr inbounds nuw i8, ptr %x, i64 12
  store i32 4, ptr %d, align 4, !tbaa !11
  %e = getelementptr inbounds nuw i8, ptr %x, i64 16
  store i32 5, ptr %e, align 8, !tbaa !12
