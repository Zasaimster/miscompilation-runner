...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/152765533201725276740779351840637277686_O0.ll'
...
for.body:                                         ; preds = %for.cond2
  ...
  %arrayidx = getelementptr inbounds [0 x i32], ptr @x, i64 0, i64 %idxprom
...
if.then:                                          ; preds = %for.body
  ...
  %arrayidx5 = getelementptr inbounds [0 x i32], ptr @x, i64 0, i64 %idxprom4
