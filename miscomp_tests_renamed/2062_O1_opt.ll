...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/174264670346691767922569428391240900666_O1.ll'
...
do.body:                                          ; preds = %do.body, %sw.bb7.preheader
...
for.body33:                                       ; preds = %for.cond30, %do.body
...
cleanup:                                          ; preds = %for.body33, %for.cond30
