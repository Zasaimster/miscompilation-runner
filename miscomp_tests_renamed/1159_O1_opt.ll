...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/120496817960072636214212821657518950330_O1.ll'
...
if.end:                                           ; preds = %entry
  %cmp3.not = icmp eq i8 %y.coerce, 11
...
if.end6:                                          ; preds = %if.end
  %cmp9.not = icmp eq i8 %z.coerce, 12
...
entry:
  %call = tail call i32 @f(i32 poison, i8 poison, i8 11, i8 12, i64 noundef 123)
