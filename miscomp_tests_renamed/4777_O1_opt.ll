; 184255241830446858967603930112030131135
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/184255241830446858967603930112030131135_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/184255241830446858967603930112030131135.c"
...
if.then:                                          ; preds = %land.lhs.true2
  %call.i = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %1, ptr noundef nonnull dereferenceable(2) @.str) #7
...
s.exit:                                           ; preds = %lor.lhs.false.i
  %call.i46 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %1, ptr noundef nonnull dereferenceable(2) @.str) #7
...
entry:
  %call = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %v, ptr noundef nonnull dereferenceable(2) @.str) #7
...
define dso_local noalias noundef nonnull ptr @m(ptr noundef readnone captures(none) %x) local_unnamed_addr #4 {
entry:
  tail call void @abort() #8
  unreachable
}
