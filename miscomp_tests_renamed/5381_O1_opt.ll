; 165567426715966659435153149743847887914
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/165567426715966659435153149743847887914_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/165567426715966659435153149743847887914.c"
...
for.cond1.preheader:                              ; preds = %while.end, %entry
  ...
  %indvars.iv = phi i32 [ 19, %entry ], [ %indvars.iv.next, %while.end ]
  %i.041 = phi i32 [ 1, %entry ], [ %inc19, %while.end ]
  %smax = tail call i32 @llvm.smax.i32(i32 %indvars.iv, i32 1)
  %cmp2.not35 = icmp samesign ugt i32 %i.041, 19
...
while.body:                                       ; preds = %if.end, %while.body.preheader
  ...
  %cmp8 = icmp slt i32 %count.239, 20
...
while.end:                                        ; preds = %if.end
  ...
  %exitcond46.not = icmp eq i32 %inc19, 21
