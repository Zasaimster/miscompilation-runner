...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/170189938602342715603071972301533611735_O1.ll'
...
entry:
  ...
  %conv.i9 = fptosi double %mul.i to i64
  %cmp.not = icmp eq i64 %conv.i, %conv.i9
...
if.end:                                           ; preds = %entry
  %conv6 = sitofp i64 %conv.i9 to double
  ret double %conv6
}
