; 13685524217514682652698231570495199080
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/13685524217514682652698231570495199080_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/13685524217514682652698231570495199080.c"
...
entry:
  ...
  %cmp = icmp eq i64 %t.sroa.2.0.extract.shift.mask, 42949672960
...
entry:
  ...
  %cmp.i = icmp eq i64 %t.sroa.2.0.extract.shift.mask.i, 42949672960
