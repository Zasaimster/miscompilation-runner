; 192381382362932826464480322203903879650
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/192381382362932826464480322203903879650.c'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/192381382362932826464480322203903879650.c"
...
@.str.1 = private unnamed_addr constant [21 x i8] c"A is greater than 5\0A\00", align 1
...
entry:
  ...
  %cond = select i1 %tobool, ptr @.str.2, ptr @ca
  %call = call i32 (ptr, i32, ...) @A(ptr noundef %cond, i32 noundef 2)
  %2 = load volatile i32, ptr @i0, align 4
  %tobool1 = icmp ne i32 %2, 0
  %3 = zext i1 %tobool1 to i64
  %cond2 = select i1 %tobool1, ptr @ca, ptr @.str.3
  %call3 = call i32 (ptr, i32, ...) @A(ptr noundef %cond2, i32 noundef 3)
  %4 = load volatile i32, ptr @i0, align 4
  %tobool4 = icmp ne i32 %4, 0
  %5 = zext i1 %tobool4 to i64
  %cond5 = select i1 %tobool4, ptr @.str.2, ptr @cb
  %call6 = call i32 (ptr, i32, ...) @A(ptr noundef %cond5, i32 noundef 4)
  %6 = load volatile i32, ptr @i0, align 4
  %tobool7 = icmp ne i32 %6, 0
  %7 = zext i1 %tobool7 to i64
  %cond8 = select i1 %tobool7, ptr @cb, ptr @.str.4
  %call9 = call i32 (ptr, i32, ...) @A(ptr noundef %cond8, i32 noundef 2)
  %8 = load volatile i32, ptr @i0, align 4
  %tobool10 = icmp ne i32 %8, 0
  %9 = zext i1 %tobool10 to i64
  %cond11 = select i1 %tobool10, ptr @.str.2, ptr @va
  %call12 = call i32 (ptr, i32, ...) @A(ptr noundef %cond11, i32 noundef 3)
  %10 = load volatile i32, ptr @i0, align 4
  %tobool13 = icmp ne i32 %10, 0
  %11 = zext i1 %tobool13 to i64
  %cond14 = select i1 %tobool13, ptr @va, ptr @.str.5
  %call15 = call i32 (ptr, i32, ...) @A(ptr noundef %cond14, i32 noundef 4)
  %12 = load volatile i32, ptr @i0, align 4
  %tobool16 = icmp ne i32 %12, 0
  %13 = zext i1 %tobool16 to i64
  %cond17 = select i1 %tobool16, ptr @.str.2, ptr @vb
  %call18 = call i32 (ptr, i32, ...) @A(ptr noundef %cond17, i32 noundef 5)
  %14 = load volatile i32, ptr @i0, align 4
  %tobool19 = icmp ne i32 %14, 0
  %15 = zext i1 %tobool19 to i64
  %cond20 = select i1 %tobool19, ptr @vb, ptr @.str.4
  %call21 = call i32 (ptr, i32, ...) @A(ptr noundef %cond20, i32 noundef 2)
  ret void
}
...
cond.end6:                                        ; preds = %cond.false5, %cond.true2
  %cond7 = phi ptr [ %arraydecay4, %cond.true2 ], [ @.str.3, %cond.false5 ]
...
cond.end14:                                       ; preds = %cond.false11, %cond.true10
  %cond15 = phi ptr [ @.str.2, %cond.true10 ], [ %arraydecay13, %cond.false11 ]
...
cond.end22:                                       ; preds = %cond.false21, %cond.true18
  %cond23 = phi ptr [ %arraydecay20, %cond.true18 ], [ @.str.4, %cond.false21 ]
...
cond.end30:                                       ; preds = %cond.false27, %cond.true26
  %cond31 = phi ptr [ @.str.2, %cond.true26 ], [ %arraydecay29, %cond.false27 ]
...
cond.end38:                                       ; preds = %cond.false37, %cond.true34
  %cond39 = phi ptr [ %arraydecay36, %cond.true34 ], [ @.str.5, %cond.false37 ]
...
cond.end46:                                       ; preds = %cond.false43, %cond.true42
  %cond47 = phi ptr [ @.str.2, %cond.true42 ], [ %arraydecay45, %cond.false43 ]
...
cond.end54:                                       ; preds = %cond.false53, %cond.true50
  %cond55 = phi ptr [ %arraydecay52, %cond.true50 ], [ @.str.4, %cond.false53 ]
...
cond.false:                                       ; preds = %entry
  ...
  %cond = select i1 %cmp1, ptr @vb, ptr @.str.3
  br label %cond.end
...
cond.end9:                                        ; preds = %cond.false8, %cond.true7
  %cond10 = phi ptr [ %6, %cond.true7 ], [ @.str.3, %cond.false8 ]
  br label %cond.end11
...
cond.end22:                                       ; preds = %cond.end20, %cond.true15
  %cond23 = phi ptr [ @.str.3, %cond.true15 ], [ %cond21, %cond.end20 ]
