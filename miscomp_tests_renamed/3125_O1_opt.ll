; 154776377355154696215259498633329176496
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/154776377355154696215259498633329176496_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/154776377355154696215259498633329176496.c"
...
attributes #1 = { mustprogress nofree nounwind willreturn memory(write, argmem: read, inaccessiblemem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
