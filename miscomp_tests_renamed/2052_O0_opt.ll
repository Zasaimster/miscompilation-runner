...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/118865264212359723489857617811728354334_O0.ll'
...
entry:
  ...
  %arrayidx2 = getelementptr inbounds [6 x i16], ptr @psd, i64 0, i64 %idxprom1
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %8 = load i16, ptr %lastbin, align 2
...
for.body:                                         ; preds = %for.cond
  ...
  %call11 = call signext i16 @logadd(ptr noundef %arrayidx8, ptr noundef %arrayidx10)
