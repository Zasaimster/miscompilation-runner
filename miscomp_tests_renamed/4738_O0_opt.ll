...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/106976724472931610939184517758297707270_O0.ll'
...
while.body:                                       ; preds = %while.cond
  ...
  %incdec.ptr = getelementptr inbounds nuw float, ptr %0, i32 1
  store ptr %incdec.ptr, ptr %x.addr, align 8
  %1 = load float, ptr %0, align 4
  %2 = load ptr, ptr %y.addr, align 8
  %incdec.ptr1 = getelementptr inbounds nuw float, ptr %2, i32 1
  store ptr %incdec.ptr1, ptr %y.addr, align 8
  %3 = load float, ptr %2, align 4
  %cmp = fcmp oeq float %1, %3
  %conv = zext i1 %cmp to i32
  %4 = load ptr, ptr %d.addr, align 8
  %incdec.ptr2 = getelementptr inbounds nuw i32, ptr %4, i32 1
  store ptr %incdec.ptr2, ptr %d.addr, align 8
