...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/192381382362932826464480322203903879650_O1.ll'
...
entry:
  ...
  %cond5.i = select i1 %tobool4.not.i, ptr @cb, ptr @.str.2
  ...
  %cond8.i = select i1 %tobool7.not.i, ptr @.str.4, ptr @cb
  ...
  %cond11.i = select i1 %tobool10.not.i, ptr @va, ptr @.str.2
  ...
  %cond14.i = select i1 %tobool13.not.i, ptr @.str.5, ptr @va
  ...
  %cond17.i = select i1 %tobool16.not.i, ptr @vb, ptr @.str.2
  ...
  %cond20.i = select i1 %tobool19.not.i, ptr @.str.4, ptr @vb
  ...
  %cond.i2 = select i1 %tobool.not.i1, ptr %lca.i, ptr @.str.2
  ...
  %cond7.i = select i1 %tobool1.not.i4, ptr @.str.3, ptr %lca.i
  ...
  %cond15.i = select i1 %tobool9.not.i, ptr %lcb.i, ptr @.str.2
  ...
  %cond23.i = select i1 %tobool17.not.i, ptr @.str.4, ptr %lcb.i
  ...
  %cond31.i = select i1 %tobool25.not.i, ptr %lva.i, ptr @.str.2
  ...
  %cond39.i = select i1 %tobool33.not.i, ptr @.str.5, ptr %lva.i
  ...
  %cond47.i = select i1 %tobool41.not.i, ptr %lvb.i, ptr @.str.2
  ...
  %cond55.i = select i1 %tobool49.not.i, ptr @.str.4, ptr %lvb.i
...
cond.false.i:                                     ; preds = %entry
  ...
  %cond.i5 = select i1 %cmp1.i, ptr @vb, ptr @.str.3
  br label %cond.end.i
...
cond.false5.i:                                    ; preds = %cond.end.i
  ...
  %cond10.i = select i1 %cmp6.i, ptr %21, ptr @.str.3
...
test_ternary_cond_expr.exit:                      ; preds = %cond.false16.i, %cond.end11.i
  %cond23.i8 = phi ptr [ %cond21.i, %cond.false16.i ], [ @.str.3, %cond.end11.i ]
...
if.end:                                           ; preds = %if.then, %test_ternary_cond_expr.exit
  ret i32 0
}

declare i32 @A(...) local_unnamed_addr #1
