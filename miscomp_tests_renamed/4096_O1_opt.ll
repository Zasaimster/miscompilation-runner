...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/128033292387321963036783117708661039427_O1.ll'
...
entry:
  %0 = load i32, ptr @x, align 4, !tbaa !5
  %or.i = or i32 %0, 128
  store i32 %or.i, ptr @x, align 4, !tbaa !5
  %cmp.not = icmp eq i32 %or.i, 131
