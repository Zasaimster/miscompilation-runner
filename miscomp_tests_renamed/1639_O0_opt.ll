; 162048449451120321739317793589657742580
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/162048449451120321739317793589657742580_O0.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/162048449451120321739317793589657742580.c"
...
@.str.2 = private unnamed_addr constant [30 x i8] c"Square calculation complete.\0A\00", align 1
...
for.end:                                          ; preds = %for.cond2
  ...
  %arrayidx = getelementptr inbounds [256 x i32], ptr @a, i64 0, i64 %idxprom
...
if.then:                                          ; preds = %entry
  ...
  %arrayidx = getelementptr inbounds nuw [256 x i32], ptr @a, i64 0, i64 %idxprom
  %2 = load i32, ptr %arrayidx, align 4
  store i32 %2, ptr @b, align 4
  %3 = load i32, ptr @b, align 4
  %and1 = and i32 %3, 1
  %idxprom2 = zext i32 %and1 to i64
  %arrayidx3 = getelementptr inbounds nuw [256 x i32], ptr @a, i64 0, i64 %idxprom2
  ...
  %and5 = and i64 %xor, 1
  %arrayidx6 = getelementptr inbounds nuw [256 x i32], ptr @a, i64 0, i64 %and5
  ...
  %arrayidx11 = getelementptr inbounds nuw [256 x i32], ptr @a, i64 0, i64 %and10
