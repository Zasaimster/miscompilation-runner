...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/120490098151489475708271319692084706340_O1.ll'
...
define dso_local range(i32 -62, 112) i32 @foo(i8 noundef signext %x) local_unnamed_addr #0 {
entry:
...
sw.epilog:                                        ; preds = %sw.bb33, %sw.bb28, %sw.bb27, %sw.bb25, %sw.bb21, %sw.bb15, %sw.bb13, %sw.bb12, %sw.bb11, %sw.bb9, %sw.bb8, %sw.bb7, %sw.bb6, %sw.bb5, %sw.bb4, %sw.bb3, %sw.bb2, %sw.bb1, %sw.bb, %entry
  %y.0 = phi i32 [ -62, %entry ], [ 18, %sw.bb33 ], [ 105, %sw.bb28 ], [ 102, %sw.bb27 ], [ 106, %sw.bb25 ], [ 107, %sw.bb21 ], [ 10, %sw.bb15 ], [ 111, %sw.bb13 ], [ 15, %sw.bb12 ], [ 12, %sw.bb11 ], [ 16, %sw.bb9 ], [ 28, %sw.bb8 ], [ 8, %sw.bb7 ], [ 31, %sw.bb6 ], [ 17, %sw.bb5 ], [ 5, %sw.bb4 ], [ 19, %sw.bb3 ], [ 2, %sw.bb2 ], [ 7, %sw.bb1 ], [ 1, %sw.bb ]
  ret i32 %y.0
}
