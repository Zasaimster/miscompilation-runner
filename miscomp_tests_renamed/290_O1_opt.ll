...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/149035720606420000591764987696160538088_O1.ll'
...
entry:
  %call = tail call i32 (i32, ...) @calculateSquare(i32 noundef 4) #6
  %conv2 = sext i32 %call to i64
  %0 = inttoptr i64 %conv2 to ptr
  ret ptr %0
}
...
entry:
  ...
  %call.i = tail call i32 (i32, ...) @calculateSquare(i32 noundef 4) #6
  %conv2.i = sext i32 %call.i to i64
  %1 = inttoptr i64 %conv2.i to ptr
  %add.ptr = getelementptr inbounds nuw i8, ptr %0, i64 1
  %cmp.not = icmp eq ptr %add.ptr, %1
