...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/122601457987408018115897455846568117474_O0.ll'
...
entry:
  ...
  call void @llvm.prefetch.p0(ptr getelementptr inbounds ([10 x i8], ptr getelementptr inbounds nuw (%struct.S, ptr @s, i32 0, i32 2), i64 0, i64 1), i32 0, i32 0, i32 1)
  call void @arg_ptr(ptr noundef getelementptr inbounds ([10 x i8], ptr getelementptr inbounds nuw (%struct.S, ptr @s, i32 0, i32 2), i64 0, i64 1))
  %0 = load ptr, ptr @ptr, align 8
