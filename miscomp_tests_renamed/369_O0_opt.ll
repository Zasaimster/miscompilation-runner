...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/18426685828332586206007814242914428363_O0.ll'
...
do.body1:                                         ; preds = %do.end
  ...
  store i32 %0, ptr %conv_u2, align 4
...
do.body56:                                        ; preds = %do.end55
  ...
  %16 = load i8, ptr %v2, align 1
  store i8 %16, ptr %tmp57, align 1
  %17 = load i8, ptr %tmp57, align 1
...
if.then67:                                        ; preds = %if.else63
  ...
  %19 = load i8, ptr %v268, align 1
  %conv69 = sext i8 %19 to i32
...
if.else73:                                        ; preds = %if.else63
  %20 = load i8, ptr %tmp57, align 1
  %conv74 = sext i8 %20 to i32
...
if.then77:                                        ; preds = %if.else73
  ...
  %21 = load i8, ptr %v278, align 1
  %conv79 = sext i8 %21 to i32
  %22 = load i8, ptr %tmp57, align 1
...
if.else91:                                        ; preds = %if.else73
  %25 = load i8, ptr %tmp57, align 1
  %conv92 = sext i8 %25 to i32
...
if.then95:                                        ; preds = %if.else91
  ...
  %26 = load i8, ptr %v296, align 1
  %conv97 = sext i8 %26 to i32
  %27 = load i8, ptr %tmp57, align 1
...
if.else107:                                       ; preds = %if.else91
  ...
  %29 = load i8, ptr %v2108, align 1
  %conv109 = sext i8 %29 to i32
  %30 = load i8, ptr %tmp57, align 1
  %conv110 = sext i8 %30 to i32
...
do.body119:                                       ; preds = %do.end118
  ...
  %31 = load i8, ptr %v3, align 1
  store i8 %31, ptr %tmp120, align 1
  %32 = load i8, ptr %tmp120, align 1
  %conv121 = sext i8 %32 to i32
...
if.else136:                                       ; preds = %if.else126
  %35 = load i8, ptr %tmp120, align 1
  %conv137 = sext i8 %35 to i32
...
if.then140:                                       ; preds = %if.else136
  ...
  %36 = load i8, ptr %v3141, align 1
  %conv142 = sext i8 %36 to i32
  %37 = load i8, ptr %tmp120, align 1
  %conv143 = sext i8 %37 to i32
...
if.else154:                                       ; preds = %if.else136
  %40 = load i8, ptr %tmp120, align 1
  %conv155 = sext i8 %40 to i32
...
if.then158:                                       ; preds = %if.else154
  ...
  %41 = load i8, ptr %v3159, align 1
  %conv160 = sext i8 %41 to i32
  %42 = load i8, ptr %tmp120, align 1
  %conv161 = sext i8 %42 to i32
  %sub162 = sub nsw i32 -1, %conv161
  %shl163 = shl i32 1, %sub162
  %add164 = add nsw i32 %conv160, %shl163
  %43 = load i8, ptr %tmp120, align 1
  %conv165 = sext i8 %43 to i32
...
if.else170:                                       ; preds = %if.else154
  ...
  %44 = load i8, ptr %v3171, align 1
  %conv172 = sext i8 %44 to i32
  %45 = load i8, ptr %tmp120, align 1
  %conv173 = sext i8 %45 to i32
...
do.body182:                                       ; preds = %do.end181
  ...
  %46 = load i8, ptr %v4, align 1
  store i8 %46, ptr %tmp183, align 1
  %47 = load i8, ptr %tmp183, align 1
  %conv184 = sext i8 %47 to i32
...
if.then193:                                       ; preds = %if.else189
  ...
  %49 = load i8, ptr %v4194, align 1
  %conv195 = sext i8 %49 to i32
...
if.else199:                                       ; preds = %if.else189
  %50 = load i8, ptr %tmp183, align 1
  %conv200 = sext i8 %50 to i32
...
if.then203:                                       ; preds = %if.else199
  ...
  %51 = load i8, ptr %v4204, align 1
  %conv205 = sext i8 %51 to i32
  %52 = load i8, ptr %tmp183, align 1
...
if.else217:                                       ; preds = %if.else199
  %55 = load i8, ptr %tmp183, align 1
  %conv218 = sext i8 %55 to i32
...
if.then221:                                       ; preds = %if.else217
  ...
  %56 = load i8, ptr %v4222, align 1
  %conv223 = sext i8 %56 to i32
  %57 = load i8, ptr %tmp183, align 1
  %conv224 = sext i8 %57 to i32
  %sub225 = sub nsw i32 -1, %conv224
  %shl226 = shl i32 1, %sub225
  %add227 = add nsw i32 %conv223, %shl226
  %58 = load i8, ptr %tmp183, align 1
  %conv228 = sext i8 %58 to i32
...
if.else233:                                       ; preds = %if.else217
  ...
  %59 = load i8, ptr %v4234, align 1
  %conv235 = sext i8 %59 to i32
  %60 = load i8, ptr %tmp183, align 1
  %conv236 = sext i8 %60 to i32
...
do.body245:                                       ; preds = %do.end244
  ...
  %61 = load i32, ptr %conv_u246, align 4
  store i32 %61, ptr %res, align 4
  br label %do.end247
