; 187523229039465978674380058090918986145
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/187523229039465978674380058090918986145_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/187523229039465978674380058090918986145.c"
...
for.body:                                         ; preds = %for.body, %entry
  %Count.011 = phi i32 [ 1, %entry ], [ %inc, %for.body ]
  %call = tail call i32 @factorial(i32 noundef %Count.011)
