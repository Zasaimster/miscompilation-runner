; 132346939469294629076813292312232415787
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/132346939469294629076813292312232415787_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/132346939469294629076813292312232415787.c"
...
entry:
  ...
  %call.i.i.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str)
  %0 = load i8, ptr @e, align 1, !tbaa !9
...
while.body.i:                                     ; preds = %while.body.i, %entry
  ...
  %call.i.i.i30 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str)
