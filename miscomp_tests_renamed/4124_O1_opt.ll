...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/172089962643364986528918759682220567662_O1.ll'
...
if.end:                                           ; preds = %lor.lhs.false6
  %call = tail call i32 (i32, ...) @example6(i32 noundef 0) #7
  ret void
}
...
bar.exit:                                         ; preds = %entry
  %call.i = tail call i32 (i32, ...) @example6(i32 noundef 0) #7
  ret void
}
