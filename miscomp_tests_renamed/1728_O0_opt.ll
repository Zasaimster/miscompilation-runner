...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/17373675760476215828421694331353960625_O0.ll'
...
entry:
  ...
  store i32 %call1, ptr %number, align 4
...
for.body4:                                        ; preds = %for.cond2
  ...
  %call5 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %4)
