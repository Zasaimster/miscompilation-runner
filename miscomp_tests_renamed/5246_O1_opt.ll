...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/192655903431578850381672437598063356057_O1.ll'
...
entry:
  ...
  %. = zext i1 %cmp to i32
  store i32 %., ptr @p, align 4, !tbaa !5
...
entry:
  ...
  %cmp.i = icmp slt i32 %call.i, 31
  %..i = zext i1 %cmp.i to i32
  store i32 %..i, ptr @p, align 4, !tbaa !5
  store i32 %..i, ptr @k, align 4, !tbaa !5
