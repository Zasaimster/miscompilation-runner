; 132171341220713557679623411034625948178
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/132171341220713557679623411034625948178_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/132171341220713557679623411034625948178.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@count = dso_local local_unnamed_addr global i32 10, align 4
...
define dso_local noundef i32 @foo2() local_unnamed_addr #2 {
entry:
...
entry:
  %call.i = tail call i32 (...) @example1() #4
  %0 = load i32, ptr @count, align 4, !tbaa !5
  %inc.i = add nsw i32 %0, 1
  store i32 %inc.i, ptr @count, align 4, !tbaa !5
  %cmp4.not = icmp eq i32 %inc.i, 2
