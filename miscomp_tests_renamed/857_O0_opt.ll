...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/115159993053341839491407464503534146181_O0.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %not1 = xor i32 %2, -1
  %div2 = udiv i32 %not1, 7
  store i32 %div2, ptr %f, align 4
...
land.end:                                         ; preds = %land.rhs, %if.then
  %6 = phi i1 [ false, %if.then ], [ %tobool4, %land.rhs ]
  %land.ext = zext i1 %6 to i32
  %not5 = xor i32 %land.ext, -1
  store i32 %not5, ptr %e, align 4
...
while.body:                                       ; preds = %while.cond
  ...
  %inc9 = add i32 %9, 1
  store i32 %inc9, ptr %timeout, align 4
