...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/151332364468272510969230898893528458897_O0.ll'
...
entry:
  ...
  %4 = getelementptr inbounds nuw { i64, i32 }, ptr %x.coerce, i32 0, i32 0
  %5 = load i64, ptr %4, align 4
  %6 = getelementptr inbounds nuw { i64, i32 }, ptr %x.coerce, i32 0, i32 1
  %7 = load i32, ptr %6, align 4
  %call = call i32 (ptr, ...) @printf(ptr noundef @.str, i64 %5, i32 %7)
  %a = getelementptr inbounds nuw %struct.S, ptr %y, i32 0, i32 0
...
lor.lhs.false3:                                   ; preds = %lor.lhs.false
  %c = getelementptr inbounds nuw %struct.S, ptr %y, i32 0, i32 2
  %10 = load i32, ptr %c, align 4
  %cmp4 = icmp ne i32 %10, 8
