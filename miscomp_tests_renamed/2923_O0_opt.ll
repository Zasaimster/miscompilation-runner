...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/136367684200098812838422401204547301086_O0.ll'
...
entry:
  ...
  %call1 = call i32 @bar(i32 noundef 9, i32 noundef 12, i32 noundef 15)
  %cmp = icmp ne i32 %call1, 150
