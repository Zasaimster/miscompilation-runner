; 114813278598447146298374418938510485292
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/114813278598447146298374418938510485292_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/114813278598447146298374418938510485292.c"
...
entry:
  ...
  %tobool.not1 = icmp eq i32 %b.promoted, 0
  br i1 %tobool.not1, label %for.end, label %for.body.lr.ph
...
entry:
  ...
  %tobool.not1.i = icmp eq i32 %b.promoted.i, 0
  br i1 %tobool.not1.i, label %fn1.exit, label %for.body.lr.ph.i
...
for.body.i:                                       ; preds = %for.body.i, %for.body.lr.ph.i
  ...
  br i1 %tobool.not.i, label %for.cond.for.end_crit_edge.i, label %for.body.i, !llvm.loop !11

for.cond.for.end_crit_edge.i:                     ; preds = %for.body.i
  store i32 %0, ptr @b, align 4, !tbaa !5
  br label %fn1.exit

fn1.exit:                                         ; preds = %for.cond.for.end_crit_edge.i, %entry
  %bf.load = load i64, ptr getelementptr inbounds nuw (i8, ptr @c, i64 20), align 4
