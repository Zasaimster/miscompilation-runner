...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/134967742206728010175534499203344897902_O0.ll'
...
entry:
  ...
  %call = call i32 (ptr, ptr, ...) @sprintf(ptr noundef %0, ptr noundef @.str, ptr noundef %1) #3
  ret ptr null
}
