...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/185630659600227343239359511205434273221_O1.ll'
...
if.then:                                          ; preds = %land.lhs.true2
  %call.i = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %1, ptr noundef nonnull dereferenceable(2) @.str) #5
...
s.exit:                                           ; preds = %lor.lhs.false.i
  %call.i46 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %1, ptr noundef nonnull dereferenceable(2) @.str) #5
...
entry:
  %call = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %v, ptr noundef nonnull dereferenceable(2) @.str) #5
...
define dso_local noalias noundef nonnull ptr @m(ptr noundef readnone captures(none) %x) local_unnamed_addr #2 {
entry:
  tail call void @abort() #6
  unreachable
}
