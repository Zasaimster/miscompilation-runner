...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/121000758582426291270538600212295947840_O0.ll'
...
lor.lhs.false:                                    ; preds = %entry
  %1 = load i32, ptr %typenum.addr, align 4
...
if.end:                                           ; preds = %lor.lhs.false
  %2 = load i32, ptr %typenum.addr, align 4
  %sub2 = sub nsw i32 0, %2
  switch i32 %sub2, label %sw.epilog [
    i32 1, label %sw.bb
    i32 2, label %sw.bb3
    i32 3, label %sw.bb4
    i32 4, label %sw.bb5
...
sw.bb6:                                           ; preds = %sw.bb5, %if.end
  store ptr @.str.4, ptr %name, align 8
  br label %sw.bb7

sw.bb7:                                           ; preds = %sw.bb6, %if.end
...
sw.bb9:                                           ; preds = %sw.bb8, %if.end
  store ptr @.str.7, ptr %name, align 8
  br label %sw.bb10

sw.bb10:                                          ; preds = %sw.bb9, %if.end
  store ptr @.str.8, ptr %name, align 8
  br label %sw.bb11

sw.bb11:                                          ; preds = %sw.bb10, %if.end
