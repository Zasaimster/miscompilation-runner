...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/151000954558361180363576450127621359184_O1.ll'
...
entry:
  %add = add nsw i64 %sum, 20
  %call = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i64 noundef %add)
...
define dso_local noundef i64 @unsigned_poly(i64 noundef %sum, i64 noundef %x) local_unnamed_addr #2 {
entry:
  %mul3 = add i64 %x, 1
  %add = mul i64 %mul3, %sum
  ret i64 %add
}
...
entry:
  %call.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i64 noundef 22)
