...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/150400740294761499231629689398648205311_O1.ll'
...
entry:
  %cmp.not = icmp eq ptr @j, inttoptr (i64 20 to ptr)
...
entry:
  %cmp.not.i = icmp eq ptr @j, inttoptr (i64 20 to ptr)
  br i1 %cmp.not.i, label %bla.exit, label %if.then.i

if.then.i:                                        ; preds = %entry
  store i32 1, ptr @j, align 4, !tbaa !5
  br label %bla.exit

bla.exit:                                         ; preds = %if.then.i, %entry
