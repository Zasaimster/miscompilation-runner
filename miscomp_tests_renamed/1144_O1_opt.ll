...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/120323421154307293461085569893905335231_O1.ll'
...
do.body:                                          ; preds = %do.body, %sw.bb6.preheader
...
for.body32:                                       ; preds = %for.cond29, %do.body
...
cleanup:                                          ; preds = %for.body32, %for.cond29
