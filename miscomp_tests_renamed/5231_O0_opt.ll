...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/11688289866890160540312240372554477600_O0.ll'
...
entry:
  ...
  %cmp4 = icmp eq ptr %1, @g_23
  %conv5 = zext i1 %cmp4 to i32
  %call6 = call i32 (i32, ...) @assert(i32 noundef %conv5)
  %2 = load ptr, ptr %l_100, align 8
  %cmp7 = icmp eq ptr %2, @g_23
  %conv8 = zext i1 %cmp7 to i32
  %call9 = call i32 (i32, ...) @assert(i32 noundef %conv8)
  %3 = load ptr, ptr %l_100, align 8
  %cmp10 = icmp eq ptr %3, @g_23
  %conv11 = zext i1 %cmp10 to i32
  %call12 = call i32 (i32, ...) @assert(i32 noundef %conv11)
  %4 = load ptr, ptr %l_100, align 8
  %cmp13 = icmp eq ptr %4, @g_23
  %conv14 = zext i1 %cmp13 to i32
  %call15 = call i32 (i32, ...) @assert(i32 noundef %conv14)
  %5 = load ptr, ptr %l_100, align 8
  %cmp16 = icmp eq ptr %5, @g_23
  %conv17 = zext i1 %cmp16 to i32
  %call18 = call i32 (i32, ...) @assert(i32 noundef %conv17)
