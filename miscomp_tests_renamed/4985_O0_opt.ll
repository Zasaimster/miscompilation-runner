...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/188080400897071464447957009771030476332_O0.ll'
...
entry:
  %call = call i32 (ptr, ...) @printf(ptr noundef @.str, ptr noundef byval(%struct.s) align 8 %s)
