...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/180615477659938148926774583430034658949_O0.ll'
...
define dso_local void @foo(ptr noundef byval(%struct.S) align 8 %s) #0 {
entry:
  %arr = getelementptr inbounds nuw %struct.S, ptr %s, i32 0, i32 1
  %arraydecay = getelementptr inbounds [100 x i8], ptr %arr, i64 0, i64 0
...
entry:
  ...
  call void @foo(ptr noundef byval(%struct.S) align 8 %s)
  ret i32 0
}
