...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/105730437867325286438634430296531602382_O1.ll'
...
cleanup:                                          ; preds = %if.end14, %if.else, %if.then
...
f.exit51:                                         ; preds = %if.end14.i49, %if.end12
...
f.exit65:                                         ; preds = %if.end14.i63, %if.end20
