...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/157338753727088503434056448999922705240_O0.ll'
...
if.then:                                          ; preds = %entry
  ...
  %call2 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef %1, ptr noundef @.str, i32 noundef %2) #3
