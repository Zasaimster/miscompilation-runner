...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/171646210533601867287684648683577007254_O1.ll'
...
define dso_local i32 @doit(i32 noundef %sel, i32 noundef %n, ptr noundef readnone captures(none) %p) local_unnamed_addr #0 {
entry:
