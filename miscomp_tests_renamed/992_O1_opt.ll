...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/151423829946348200999228199201380567422_O1.ll'
...
define dso_local i32 @f(ptr noundef readnone captures(none) %a) local_unnamed_addr #0 {
entry:
  ret i32 undef
}
