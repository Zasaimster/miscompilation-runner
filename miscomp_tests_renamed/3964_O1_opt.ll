; 125018095953383465685076602599233142573
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/125018095953383465685076602599233142573_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/125018095953383465685076602599233142573.c"
...
entry:
  ...
  br i1 %cmp10, label %for.body, label %if.then4.critedge
...
if.then4:                                         ; preds = %if.then4.critedge, %for.end.loopexit
