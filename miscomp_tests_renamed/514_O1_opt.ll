...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/121816600977410321185623292961464366119_O1.ll'
...
if.end.i:                                         ; preds = %if.end5.i, %if.then13
...
gcd_ll.exit:                                      ; preds = %if.end5.i, %if.end.i, %if.then13
