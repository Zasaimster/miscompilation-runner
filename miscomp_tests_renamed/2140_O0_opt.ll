...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/130308833090137110986822532548484494033_O0.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %call1 = call i32 @f(i32 noundef %0)
  %1 = load i32, ptr %i, align 4
  %div = udiv i32 %1, 3
  %cmp2 = icmp ne i32 %call1, %div
