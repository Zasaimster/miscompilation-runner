; 168554861659830814254423034819374002310
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/168554861659830814254423034819374002310_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/168554861659830814254423034819374002310.c"
...
do.body.i:                                        ; preds = %do.body.i, %entry
  %timeout.0.i = phi i64 [ 0, %entry ], [ %dec.i, %do.body.i ]
