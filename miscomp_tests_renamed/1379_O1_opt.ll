...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/15981883422914134899924040051292068285_O1.ll'
...
for.cond1.preheader:                              ; preds = %for.end13, %entry
  ...
  %indvars.iv = phi i32 [ 43, %entry ], [ %indvars.iv.next, %for.end13 ]
  %i.035 = phi i32 [ 0, %entry ], [ %inc16, %for.end13 ]
  %coef.034 = phi i32 [ 1, %entry ], [ %coef.2, %for.end13 ]
  br label %for.body3
...
for.end13:                                        ; preds = %if.end
  ...
  %exitcond39.not = icmp eq i32 %inc16, 42
