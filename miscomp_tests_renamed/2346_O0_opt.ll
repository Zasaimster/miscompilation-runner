...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/140770247181126235924735071081397709937_O0.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx2 = getelementptr inbounds [100 x i32], ptr %rx_skbuff, i64 0, i64 %idxprom1
...
if.end:                                           ; preds = %for.body6
  ...
  %arrayidx15 = getelementptr inbounds [100 x i32], ptr %rx_skbuff13, i64 0, i64 %idxprom14
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx3 = getelementptr inbounds [100 x i32], ptr %rx_skbuff, i64 0, i64 %idxprom2
