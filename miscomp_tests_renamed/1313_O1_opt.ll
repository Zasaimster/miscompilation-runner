...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/123444753563639191904175500102676959379_O1.ll'
...
if.end.i:                                         ; preds = %if.end3.i, %if.then13
...
gcd_ll.exit:                                      ; preds = %if.end3.i, %if.end.i
