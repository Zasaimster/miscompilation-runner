...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/132323079794287958240063331918753874994_O0.ll'
...
if.then:                                          ; preds = %entry
  ...
  %call = call i32 (ptr, ptr, ...) @sprintf(ptr noundef %2, ptr noundef @.str.1, i64 noundef %3, i64 noundef %and1) #5
  br label %if.end
...
if.else:                                          ; preds = %entry
  ...
  %call3 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef %5, ptr noundef @.str.2, i64 noundef %and2) #5
  br label %if.end
...
entry:
  ...
  %call3 = call i32 @strcmp(ptr noundef @.str.3, ptr noundef %arraydecay2) #5
...
if.end:                                           ; preds = %entry
  ...
  %call8 = call i32 @strcmp(ptr noundef @.str.4, ptr noundef %arraydecay7) #5
...
if.end11:                                         ; preds = %if.end
  ...
  %call16 = call i32 @strcmp(ptr noundef @.str.5, ptr noundef %arraydecay15) #5
...
if.end19:                                         ; preds = %if.end11
  ...
  %call24 = call i32 @strcmp(ptr noundef @.str.6, ptr noundef %arraydecay23) #5
...
if.end27:                                         ; preds = %if.end19
  ...
  %call32 = call i32 @strcmp(ptr noundef @.str.7, ptr noundef %arraydecay31) #5
