; 185182696605462580291360496478292037011
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/185182696605462580291360496478292037011_O0.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/185182696605462580291360496478292037011.c"
...
for.body:                                         ; preds = %land.end
  ...
  %arrayidx4 = getelementptr inbounds %struct.S, ptr %8, i64 %idxprom3
  %x5 = getelementptr inbounds nuw %struct.S, ptr %arrayidx4, i32 0, i32 1
  %10 = load i32, ptr %x5, align 4
...
for.body11:                                       ; preds = %for.cond9
  ...
  %arrayidx13 = getelementptr inbounds %struct.S, ptr %17, i64 %idxprom12
  ...
  %arrayidx17 = getelementptr inbounds %struct.S, ptr %22, i64 %idxprom16
