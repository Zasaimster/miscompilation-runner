; 191313825048365275082974237586275975250
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/191313825048365275082974237586275975250_O0.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/191313825048365275082974237586275975250.c"
...
for.body:                                         ; preds = %for.cond
  ...
  %cmp1 = icmp eq ptr %1, inttoptr (i64 5 to ptr)
...
if.end:                                           ; preds = %for.body
  ...
  %bf.shl = shl i32 %bf.load, 13
  %bf.ashr = ashr i32 %bf.shl, 27
