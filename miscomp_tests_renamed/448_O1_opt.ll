...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/10746450998912327272291749994008683128_O1.ll'
...
entry:
  %call = tail call i32 (...) @anotherDummyFunc() #3
...
return:                                           ; preds = %if.end5, %if.end, %entry
  %retval.0 = phi i32 [ -1, %entry ], [ 1, %if.end ], [ %., %if.end5 ]
  ret i32 %retval.0
}
...
land.lhs.true:                                    ; preds = %for.body3
  ...
  %call.i = tail call i32 (...) @anotherDummyFunc() #3
...
if.end:                                           ; preds = %if.end.i, %land.lhs.true, %for.body3
...
land.lhs.true9:                                   ; preds = %if.end
  ...
  %call.i45 = tail call i32 (...) @anotherDummyFunc() #3
...
land.lhs.true19:                                  ; preds = %if.end17
  ...
  %call.i56 = tail call i32 (...) @anotherDummyFunc() #3
...
if.then26:                                        ; preds = %if.end.i60, %land.lhs.true19
  tail call void @abort() #4
  unreachable

for.inc:                                          ; preds = %if.end.i60, %if.end17
