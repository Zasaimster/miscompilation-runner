...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/105757553261778741143312054149968717699_O0.ll'
...
if.then:                                          ; preds = %entry
  store volatile i32 30, ptr @b, align 4
  br label %if.end
...
for.body:                                         ; preds = %for.cond
  %2 = load volatile i8, ptr @f, align 1
