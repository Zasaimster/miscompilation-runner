...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/141785320616043061312815781444817029046_O1.ll'
...
@d = dso_local local_unnamed_addr global [0 x %struct.B] zeroinitializer, align 8
...
entry:
  ...
  store ptr @a, ptr @d, align 8, !tbaa !15
  store i32 5000, ptr @c, align 4, !tbaa !8
  %0 = load i32, ptr @b, align 4, !tbaa !8
