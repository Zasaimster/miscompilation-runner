...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/194093596229972980979876997377531949289_O1.ll'
...
entry:
  store i32 10, ptr @b, align 4, !tbaa !5
  %0 = load i32, ptr @a, align 4, !tbaa !5
  %add.i = add nsw i32 %0, 10
  store i32 %add.i, ptr @a, align 4, !tbaa !5
  %cmp.not = icmp eq i32 %add.i, 38
