; 180009309134655180826764884976650484934
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/180009309134655180826764884976650484934_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/180009309134655180826764884976650484934.c"
...
lor.lhs.false:                                    ; preds = %entry
  ...
  %cmp4 = icmp ne i32 %t.coerce1, 3
  %or.cond = select i1 %cmp2, i1 true, i1 %cmp4
  %cmp6 = icmp ne i32 %i, 4
  %or.cond11 = or i1 %cmp6, %or.cond
  %cmp8 = icmp ne i32 %j, 5
  %or.cond12 = or i1 %cmp8, %or.cond11
  %cmp10 = icmp ne i32 %k, 6
  %or.cond13 = or i1 %cmp10, %or.cond12
...
lor.lhs.false.i:                                  ; preds = %entry
  ...
  %cmp2.i = icmp ne i32 %call1.i, 2
  %cmp4.i = icmp ne i32 %t.coerce1, 3
  %or.cond.i = select i1 %cmp2.i, i1 true, i1 %cmp4.i
  %cmp6.i = icmp ne i32 %i, 4
  %or.cond11.i = or i1 %cmp6.i, %or.cond.i
  %cmp8.i = icmp ne i32 %j, 5
  %or.cond12.i = or i1 %cmp8.i, %or.cond11.i
  %cmp10.i = icmp ne i32 %k, 6
  %or.cond13.i = or i1 %cmp10.i, %or.cond12.i
...
entry:
  %call = tail call i32 @foo(i64 poison, i32 3, i32 noundef 4, i32 noundef 5, i32 noundef 6)
