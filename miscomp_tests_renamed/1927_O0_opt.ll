...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/105175805777448296935058185941291396314_O0.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = load x86_fp80, ptr %pc.addr, align 16
  %add1 = fadd x86_fp80 %4, %conv
  store x86_fp80 %add1, ptr %pc.addr, align 16
  br label %for.inc
...
for.end:                                          ; preds = %for.cond
  %6 = load x86_fp80, ptr %pc.addr, align 16
  ret x86_fp80 %6
}
