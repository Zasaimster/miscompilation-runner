; 181651803412258561294958426347224842943
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/181651803412258561294958426347224842943_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/181651803412258561294958426347224842943.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) uwtable
define dso_local range(i32 -128, 128) i32 @foo(i32 noundef %x, ptr noundef readonly captures(none) %y) local_unnamed_addr #0 {
entry:
...
if.end10:                                         ; preds = %if.end
  ...
  %1 = load i8, ptr %add.ptr12, align 2, !tbaa !5
  %cmp14.not = icmp eq i8 %1, 3
