...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/178179219989564552575629934550891616456_O1.ll'
...
return:                                           ; preds = %if.end10, %if.end6, %if.end, %if.then
...
if.end:                                           ; preds = %sreal_compare.exit, %if.end.i, %for.body3
...
sreal_compare.exit59:                             ; preds = %if.end10.i53, %if.end6.i51, %if.end.i48, %if.then.i57
...
if.then26:                                        ; preds = %sreal_compare.exit74, %if.end.i63
  tail call void @abort() #3
  unreachable

for.inc:                                          ; preds = %sreal_compare.exit74, %if.end17
