...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/149996703067807743635652747466901587133_O1.ll'
...
entry:
  ...
  %cmp4 = icmp slt i32 %call, %call1
  %conv3 = zext i1 %cmp4 to i32
  ret i32 %conv3
}
...
entry:
  ...
  %cmp.i1.not = icmp slt i32 %call.i, %call1.i
