...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/104049206383201160321006016505138212669_O0.ll'
...
entry:
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 16 %ir, ptr align 16 @__const.testit.ir, i64 16, i1 false)
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  %arrayidx = getelementptr inbounds [4 x i32], ptr %ir, i64 0, i64 %idxprom
  %4 = load i32, ptr %arrayidx, align 4
  %call3 = call i32 @ap(i32 noundef %4)
