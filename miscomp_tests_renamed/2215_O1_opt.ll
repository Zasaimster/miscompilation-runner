; 138725401426748719826923095975909654242
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/138725401426748719826923095975909654242_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/138725401426748719826923095975909654242.c"
...
entry:
  store i32 100, ptr @c, align 4, !tbaa !5
  ret void
}
...
entry:
  %call = tail call i32 (...) @anotherDummyFunc() #6
...
; Function Attrs: nounwind uwtable
define dso_local void @foo(i32 %a, i32 noundef %b) local_unnamed_addr #1 {
entry:
  store i32 100, ptr @c, align 4, !tbaa !5
  %call.i = tail call i32 (...) @anotherDummyFunc() #6
