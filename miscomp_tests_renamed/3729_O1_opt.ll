...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/154996669105812344417573600101668134774_O1.ll'
...
entry:
  ...
  %call2 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef 64)
  %call3 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef 12, i32 noundef 34)
  ret i32 0
}
