; 119455905256731797401629860890940829115
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/119455905256731797401629860890940829115_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/119455905256731797401629860890940829115.c"
...
entry:
  ...
  %6 = select i1 %.b, i32 8901, i32 0
  %call1 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %6)
