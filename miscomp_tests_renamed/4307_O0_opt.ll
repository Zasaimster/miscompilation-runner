...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/175635746154864520025806344635091959504_O0.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [42 x i32], ptr %val, i64 0, i64 %idxprom
