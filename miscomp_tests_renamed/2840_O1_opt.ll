...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/140034004993915386986720935974282115160_O1.ll'
...
define dso_local noundef i32 @compute() local_unnamed_addr #0 {
entry:
  ret i32 42
}
...
define dso_local void @remove_from_table(ptr noundef readnone captures(none) %x, i32 noundef %y) local_unnamed_addr #1 {
entry:
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %writes) #8
  ...
  store i32 0, ptr %writes, align 4
  store i8 6, ptr %writes, align 4
  %call = call i32 (ptr, ...) @invalidate_memory(ptr noundef nonnull %writes) #8
  call void @llvm.lifetime.end.p0(i64 72, ptr nonnull %elt) #8
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %writes) #8
  ret i32 0
}
...
declare i32 @invalidate_memory(...) local_unnamed_addr #6
