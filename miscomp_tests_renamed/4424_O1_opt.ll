...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/177747232297638109930261365067337472169_O1.ll'
...
define dso_local void @foo(ptr noundef readonly captures(none) %x, i32 noundef %y) local_unnamed_addr #1 {
entry:
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 320, ptr nonnull %a) #7
