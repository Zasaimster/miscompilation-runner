...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/157338753727088503434056448999922705240_O1.ll'
...
for.body:                                         ; preds = %Callee.exit, %entry
...
Callee.exit:                                      ; preds = %if.then.i, %for.body
