...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/105895132073917518089302822005119786918_O0.ll'
...
if.then13:                                        ; preds = %if.end
  ...
  %call16 = call i32 (i64, i64, ...) @gcd_ll(i64 noundef %30, i64 noundef %31)
  %conv17 = sext i32 %call16 to i64
  store i64 %conv17, ptr %d, align 8
  %32 = load i64, ptr %d, align 8
  %cmp18 = icmp ne i64 %32, 1
