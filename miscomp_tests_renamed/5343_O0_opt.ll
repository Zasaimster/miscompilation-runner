...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/194526416757370674789121720215555997745_O0.ll'
...
entry:
  ...
  store x86_fp80 0xK3FFF8000000000000000, ptr %tmp, align 16
...
if.end:                                           ; preds = %if.then, %entry
  store x86_fp80 0xK4002A000000000000000, ptr %val.addr, align 16
