...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/174783780912659552078983931042317049720_O0.ll'
...
entry:
  ...
  %sig = getelementptr inbounds nuw %struct.sreal, ptr %0, i32 0, i32 0
  %1 = load i32, ptr %sig, align 4
  %2 = load ptr, ptr %b.addr, align 8
  %sig1 = getelementptr inbounds nuw %struct.sreal, ptr %2, i32 0, i32 0
  %3 = load i32, ptr %sig1, align 4
  %cmp = icmp ult i32 %1, %3
  %conv = zext i1 %cmp to i32
  %sub = sub nsw i32 0, %conv
  %4 = load ptr, ptr %b.addr, align 8
  %exp = getelementptr inbounds nuw %struct.sreal, ptr %4, i32 0, i32 1
...
if.end:                                           ; preds = %entry
  ...
  %exp4 = getelementptr inbounds nuw %struct.sreal, ptr %6, i32 0, i32 1
  %7 = load i32, ptr %exp4, align 4
  %8 = load ptr, ptr %b.addr, align 8
  %exp5 = getelementptr inbounds nuw %struct.sreal, ptr %8, i32 0, i32 1
  %9 = load i32, ptr %exp5, align 4
...
if.end9:                                          ; preds = %if.end
  ...
  %sig10 = getelementptr inbounds nuw %struct.sreal, ptr %10, i32 0, i32 0
  %11 = load i32, ptr %sig10, align 4
  %12 = load ptr, ptr %b.addr, align 8
  %sig11 = getelementptr inbounds nuw %struct.sreal, ptr %12, i32 0, i32 0
  %13 = load i32, ptr %sig11, align 4
  %cmp12 = icmp ugt i32 %11, %13
...
if.end15:                                         ; preds = %if.end9
  ...
  %sig16 = getelementptr inbounds nuw %struct.sreal, ptr %14, i32 0, i32 0
  %15 = load i32, ptr %sig16, align 4
  %16 = load ptr, ptr %b.addr, align 8
  %sig17 = getelementptr inbounds nuw %struct.sreal, ptr %16, i32 0, i32 0
  %17 = load i32, ptr %sig17, align 4
