...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/137990151116125181508562898227225901008_O0.ll'
...
if.then:                                          ; preds = %for.body
  ...
  %arrayidx = getelementptr inbounds [0 x i32], ptr %e, i64 0, i64 %idxprom
