; 15036338402759186851944062633998188175
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/15036338402759186851944062633998188175_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/15036338402759186851944062633998188175.c"
...
@a = internal unnamed_addr constant [10 x i32] [i32 0, i32 5, i32 3, i32 3, i32 0, i32 0, i32 3, i32 0, i32 0, i32 0], align 16
...
for.body:                                         ; preds = %for.inc, %entry
  ...
  %arrayidx = getelementptr inbounds nuw [10 x i32], ptr @a, i64 0, i64 %add
