...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/119211398160462061456488189826586352855_O1.ll'
...
for.inc:                                          ; preds = %cond.true, %for.body
  %call6 = tail call i32 (...) @example8() #5
...
declare i32 @example8(...) local_unnamed_addr #3
...
for.inc.i:                                        ; preds = %cond.true.i, %for.body.i
  %call6.i = tail call i32 (...) @example8() #5
