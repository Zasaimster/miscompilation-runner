...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/107058312720027115603657221090216725190.c'
...
bar.exit:                                         ; preds = %if.end.i, %if.else.i
  %2 = load i32, ptr @s, align 4, !tbaa !5
  %xor.i = xor i32 %2, 1
...
bar.exit46:                                       ; preds = %if.end.i44, %if.else.i27
