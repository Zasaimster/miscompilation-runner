...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/168869238163990483685858385933796872389_O1.ll'
...
entry:
  ...
  %call8.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str)
  %cmp9.i = icmp slt i32 %call8.i, 2
...
for.inc.i:                                        ; preds = %if.then.i, %for.body.i
  ...
  store i32 %inc.i, ptr @c, align 4, !tbaa !9
...
foo.exit:                                         ; preds = %for.inc.i, %entry
  %6 = load ptr, ptr @g, align 8, !tbaa !14
  store i32 0, ptr %6, align 4, !tbaa !9
  %7 = load i16, ptr @a, align 2, !tbaa !5
