...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/136472277180029911502746400058134750246_O0.ll'
...
entry:
  ...
  %38 = load i16, ptr @j, align 2
  %conv32 = trunc i16 %38 to i8
  store i8 %conv32, ptr @d, align 1
  %39 = load i16, ptr @k, align 2
  ...
  %conv65 = sext i8 %82 to i64
  store i64 %conv65, ptr @i, align 8
  %83 = load i8, ptr @d, align 1
  %conv66 = sext i8 %83 to i64
  store i64 %conv66, ptr @i, align 8
  %84 = load i8, ptr @e, align 1
  %conv67 = zext i8 %84 to i64
  store i64 %conv67, ptr @i, align 8
  %85 = load i64, ptr @f, align 8
  store i64 %85, ptr @i, align 8
  %86 = load i64, ptr @g, align 8
  store i64 %86, ptr @i, align 8
  %87 = load i64, ptr @h, align 8
  store i64 %87, ptr @i, align 8
  %88 = load i16, ptr @j, align 2
  %conv68 = sext i16 %88 to i64
  store i64 %conv68, ptr @i, align 8
  %89 = load i16, ptr @k, align 2
  %conv69 = zext i16 %89 to i64
  store i64 %conv69, ptr @i, align 8
  %90 = load i32, ptr @a, align 4
  %conv70 = trunc i32 %90 to i16
  ...
  store i16 %99, ptr @j, align 2
  %100 = load i32, ptr @a, align 4
  %conv79 = trunc i32 %100 to i16
