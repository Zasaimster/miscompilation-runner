...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/132960700865372971641014510214394981647_O1.ll'
...
for.cond.preheader:                               ; preds = %entry
  ...
  br i1 %tobool.not5, label %for.inc, label %cleanup

for.inc:                                          ; preds = %for.inc, %for.cond.preheader
  %mask.07 = phi i32 [ %shl, %for.inc ], [ 1, %for.cond.preheader ]
  %bit.06 = phi i32 [ %inc, %for.inc ], [ 1, %for.cond.preheader ]
  %inc = add nuw nsw i32 %bit.06, 1
  %shl = shl i32 %mask.07, 1
  %and = and i32 %shl, %x
