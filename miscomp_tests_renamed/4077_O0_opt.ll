...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/17121909734730674020865946327467025960_O0.ll'
...
entry:
  ...
  store ptr inttoptr (i64 10 to ptr), ptr %temp, align 8
  br label %while.cond

while.cond:                                       ; preds = %while.body, %entry
  %0 = load ptr, ptr %end.addr, align 8
  %cmp = icmp ugt ptr %0, inttoptr (i64 5 to ptr)
