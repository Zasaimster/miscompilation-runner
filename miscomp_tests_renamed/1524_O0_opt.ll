; 127242561107992800657809705524614743026
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/127242561107992800657809705524614743026_O0.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/127242561107992800657809705524614743026.c"
...
if.else:                                          ; preds = %entry
  ...
  %sub = sub nsw i32 %2, 1
  %call1 = call i32 @factorial(i32 noundef %sub)
