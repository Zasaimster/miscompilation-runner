; 102719984307635308683328607920231720163
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/102719984307635308683328607920231720163_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/102719984307635308683328607920231720163.c"
...
define dso_local noundef i32 @fn1(i32 noundef returned %p1) local_unnamed_addr #0 {
entry:
  ...
  store i32 %conv1, ptr @m, align 4, !tbaa !5
  %1 = load i32, ptr @p, align 4, !tbaa !5
  %cmp = icmp eq i32 %conv1, %1
  %conv2 = zext i1 %cmp to i32
  store i32 %conv2, ptr @o, align 4, !tbaa !5
  ret i32 %p1
}
...
entry:
  ...
  %cmp63.i = icmp slt i32 %p.promoted.i, 31
  br i1 %cmp63.i, label %for.body.lr.ph.i, label %fn3.exit
...
for.body.i:                                       ; preds = %for.inc53.i, %for.body.lr.ph.i
  %x.065.i = phi i32 [ 0, %for.body.lr.ph.i ], [ %conv42.i, %for.inc53.i ]
  %inc546264.i = phi i32 [ %p.promoted.i, %for.body.lr.ph.i ], [ %inc54.i, %for.inc53.i ]
  %3 = phi i8 [ %c.promoted.i, %for.body.lr.ph.i ], [ 0, %for.inc53.i ]
  ...
  %cmp.i58.i = icmp samesign ugt i32 %x.065.i, 1
  %conv.i59.i = and i32 %or.i, 255
  %shr.i.i = select i1 %cmp.i58.i, i32 0, i32 %x.065.i
  %cond.i.i = lshr i32 %conv.i59.i, %shr.i.i
...
for.end.split.i:                                  ; preds = %for.body.i
  store i8 0, ptr @q, align 1, !tbaa !11
  br i1 %cmp46.i, label %for.inc53.i, label %for.end.split.split.i, !llvm.loop !12
...
for.end.split.split.i:                            ; preds = %for.end.split.i
  ...
  store i8 %conv41.i, ptr @e, align 1, !tbaa !11
...
if.then.i:                                        ; preds = %for.body.i
  %cmp11.i.le = icmp eq i32 %inc546264.i, %cond.i.i
