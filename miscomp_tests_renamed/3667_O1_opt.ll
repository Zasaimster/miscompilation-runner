; 164113068605360128751359310683677019014
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/164113068605360128751359310683677019014_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/164113068605360128751359310683677019014.c"
...
define dso_local range(i32 0, 2) i32 @bar(i32 noundef %x) local_unnamed_addr #2 {
entry:
  %0 = icmp ne i32 %x, 0
...
lor.rhs.i24:                                      ; preds = %if.end
  %call1.i25 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1)
  %tobool2.i26.not = icmp eq i32 %call1.i25, 0
  br i1 %tobool2.i26.not, label %if.end4, label %if.then3

if.then3:                                         ; preds = %lor.rhs.i24, %if.end
  tail call void @abort() #4
  unreachable
...
lor.rhs.i31:                                      ; preds = %if.end4
  %call1.i32 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1)
...
if.end20:                                         ; preds = %lor.rhs.i31, %if.end4
  ret i32 0
}
