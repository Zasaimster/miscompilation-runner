...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/184527006351259611920260318774588486307_O1.ll'
...
define dso_local i32 @f(ptr noundef readnone byval(%struct.s) align 8 captures(none) %pa, i32 noundef %pb, ...) local_unnamed_addr #0 {
entry:
