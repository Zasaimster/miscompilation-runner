; 144926809848993936430163319142128844207
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/144926809848993936430163319142128844207_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/144926809848993936430163319142128844207.c"
...
entry:
  %call10 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str)
  %cmp11 = icmp slt i32 %call10, 6
...
entry:
  ...
  %call10.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str)
  %cmp11.i = icmp slt i32 %call10.i, 6
  br i1 %cmp11.i, label %for.body.i, label %check_header.exit
