...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/168958034664375524424845541585501666294_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/168958034664375524424845541585501666294.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@s_c_s = dso_local local_unnamed_addr global { i8, i8, i16 } { i8 10, i8 0, i16 13 }, align 2
...
if.end:                                           ; preds = %entry
  %1 = load i16, ptr getelementptr inbounds nuw (i8, ptr @s_c_s, i64 2), align 2, !tbaa !10
...
if.end11:                                         ; preds = %if.end6
  %3 = load i32, ptr getelementptr inbounds nuw (i8, ptr @s_c_i, i64 4), align 4, !tbaa !14
...
if.end20:                                         ; preds = %if.end15
  %5 = load i32, ptr getelementptr inbounds nuw (i8, ptr @s_s_i, i64 4), align 4, !tbaa !17
...
if.end29:                                         ; preds = %if.end24
  %7 = load float, ptr getelementptr inbounds nuw (i8, ptr @s_c_f, i64 4), align 4, !tbaa !21
...
if.end39:                                         ; preds = %if.end34
  %9 = load float, ptr getelementptr inbounds nuw (i8, ptr @s_s_f, i64 4), align 4, !tbaa !24
...
if.end49:                                         ; preds = %if.end44
  %11 = load double, ptr getelementptr inbounds nuw (i8, ptr @s_c_d, i64 8), align 8, !tbaa !28
...
if.end58:                                         ; preds = %if.end53
  %13 = load double, ptr getelementptr inbounds nuw (i8, ptr @s_s_d, i64 8), align 8, !tbaa !31
...
if.end66:                                         ; preds = %if.end62
  %15 = load double, ptr getelementptr inbounds nuw (i8, ptr @s_i_d, i64 8), align 8, !tbaa !34
...
if.end75:                                         ; preds = %if.end70
  %17 = load double, ptr getelementptr inbounds nuw (i8, ptr @s_f_d, i64 8), align 8, !tbaa !37
...
if.end84:                                         ; preds = %if.end79
  %19 = load x86_fp80, ptr getelementptr inbounds nuw (i8, ptr @s_c_ld, i64 16), align 16, !tbaa !41
...
if.end93:                                         ; preds = %if.end88
  %21 = load x86_fp80, ptr getelementptr inbounds nuw (i8, ptr @s_s_ld, i64 16), align 16, !tbaa !44
...
if.end101:                                        ; preds = %if.end97
  %23 = load x86_fp80, ptr getelementptr inbounds nuw (i8, ptr @s_i_ld, i64 16), align 16, !tbaa !47
...
if.end110:                                        ; preds = %if.end105
  %25 = load x86_fp80, ptr getelementptr inbounds nuw (i8, ptr @s_f_ld, i64 16), align 16, !tbaa !50
...
if.end118:                                        ; preds = %if.end114
  %27 = load x86_fp80, ptr getelementptr inbounds nuw (i8, ptr @s_d_ld, i64 16), align 16, !tbaa !53
