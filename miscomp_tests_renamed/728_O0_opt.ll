; 125688052422647013094544780811806986006
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/125688052422647013094544780811806986006_O0.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/125688052422647013094544780811806986006.c"
...
while.body:                                       ; preds = %while.cond
  ...
  %3 = load i8, ptr %l4, align 1
  %conv5 = sext i8 %3 to i32
  %shr = ashr i32 %conv5, 1
  %conv6 = trunc i32 %shr to i8
  store i8 %conv6, ptr %l4, align 1
