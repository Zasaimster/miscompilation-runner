; 165944689401038008974444943883131488464
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/165944689401038008974444943883131488464_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/165944689401038008974444943883131488464.c"
...
define dso_local range(i32 0, 2) i32 @test2(i32 noundef %b, i32 noundef %c) local_unnamed_addr #3 {
entry:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local range(i32 0, 2) i32 @test3(i32 noundef %b, i32 noundef %c) local_unnamed_addr #3 {
entry:
  %tobool.not = icmp eq i32 %b, 0
  %. = zext i1 %tobool.not to i32
  ret i32 %.
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local range(i32 0, 2) i32 @test4(i32 noundef %b, i32 noundef %c) local_unnamed_addr #3 {
entry:
  %tobool.not = icmp eq i32 %b, 0
  %cmp = icmp eq i32 %c, 0
...
if.then.i:                                        ; preds = %entry
  ...
  %call1.i.off = add i32 %call1.i, 999
  %0 = icmp ult i32 %call1.i.off, 1999
  br i1 %0, label %if.end12, label %if.then
