; 185570336819358149377055692835648353723
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/185570336819358149377055692835648353723_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/185570336819358149377055692835648353723.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@masktab = dso_local local_unnamed_addr global [0 x i16] zeroinitializer, align 2
...
for.body:                                         ; preds = %for.body, %for.body.lr.ph
  ...
  %i.025 = phi i32 [ %inc, %for.body.lr.ph ], [ %inc14, %for.body ]
  %indvars.iv = add nsw i64 %indvars.iv.in, 1
  %arrayidx10 = getelementptr inbounds [6 x i16], ptr @psd, i64 0, i64 %indvars.iv
  %4 = load i16, ptr %arrayidx10, align 2, !tbaa !5
  %add.i = add i16 %4, %3
  %inc14 = add nsw i32 %i.025, 1
...
for.body.i:                                       ; preds = %for.body.i, %entry
  ...
  %i.025.i = phi i32 [ 1, %entry ], [ %inc14.i, %for.body.i ]
  %indvars.iv.i = add nuw nsw i64 %indvars.iv.in.i, 1
  %arrayidx10.i = getelementptr inbounds nuw [6 x i16], ptr @psd, i64 0, i64 %indvars.iv.i
  %3 = load i16, ptr %arrayidx10.i, align 2, !tbaa !5
  %add.i.i = add i16 %3, %2
  %inc14.i = add nuw nsw i32 %i.025.i, 1
...
ba_compute_psd.exit:                              ; preds = %for.body.i
  ...
  %4 = load i16, ptr getelementptr inbounds nuw (i8, ptr @bndpsd, i64 2), align 2, !tbaa !5
  %cmp.not = icmp eq i16 %4, 140
  br i1 %cmp.not, label %if.end, label %if.then

if.then:                                          ; preds = %ba_compute_psd.exit
  tail call void @abort() #4
  unreachable

if.end:                                           ; preds = %ba_compute_psd.exit
  ret i32 0
}
