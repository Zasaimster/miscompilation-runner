; 105528751328115964042239200928646360043
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/105528751328115964042239200928646360043_O1.ll'
source_filename = "/mnt/ramtmp/optims/DCE.cpp/target/105528751328115964042239200928646360043.c"
...
if.end.i:                                         ; preds = %entry
  ...
  br i1 %or.cond12.i, label %fn1.exit, label %if.end7.i

if.end7.i:                                        ; preds = %if.end.i
  %6 = load i32, ptr @d, align 4, !tbaa !5
  store i32 %6, ptr @e, align 4, !tbaa !5
  %tobool8.not.i = icmp eq i32 %6, 0
  %storemerge14.i = select i1 %tobool8.not.i, i32 -4, i32 -5
  store i32 %storemerge14.i, ptr @c, align 4, !tbaa !5
  store i32 %storemerge14.i, ptr @j, align 4, !tbaa !5
  br label %fn1.exit

fn1.exit:                                         ; preds = %if.end7.i, %if.end.i, %entry
