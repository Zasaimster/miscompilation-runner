...
; ModuleID = '/mnt/ramtmp/optims/DCE.cpp/target/19006671490029954110620305315255768303_O1.ll'
...
entry:
  %call = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef 42, i32 noundef 42)
  ret i32 0
}
