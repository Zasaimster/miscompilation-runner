...
@_crc_varname_g_icp_effect = private unnamed_addr constant [13 x i8] c"g_icp_effect\00", align 1
...
@globals_table = constant [1 x %global_info] [
	%global_info { i8* bitcast (i32* @g_icp_effect to i8*), i32 4, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @_crc_varname_g_icp_effect, i32 0, i32 0 ) }
]
