...
@_crc_varname_accumulated_result = private unnamed_addr constant [19 x i8] c"accumulated_result\00", align 1
...
@globals_table = constant [1 x %global_info] [
	%global_info { i8* bitcast (i32* @accumulated_result to i8*), i32 4, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @_crc_varname_accumulated_result, i32 0, i32 0 ) }
]
...
define dso_local i32 @_crc_main_old() #0 {
entry:
  %i = alloca i32, align 4
...
loop_body:
  ...
  ; Store the result
  store i32 %next_acc_P, ptr @accumulated_result, align 4
