...
@_crc_varname_Control = private unnamed_addr constant [8 x i8] c"Control\00", align 1
@_crc_varname_Status = private unnamed_addr constant [7 x i8] c"Status\00", align 1
...
@globals_table = constant [2 x %global_info] [
	%global_info { i8* bitcast (i32* @Control to i8*), i32 4, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @_crc_varname_Control, i32 0, i32 0 ) },
	%global_info { i8* bitcast (i32* @Status to i8*), i32 4, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @_crc_varname_Status, i32 0, i32 0 ) }
]
