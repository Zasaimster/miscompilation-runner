...
@_crc_varname_myGlobalValue = private unnamed_addr constant [14 x i8] c"myGlobalValue\00", align 1
...
@globals_table = constant [1 x %global_info] [
	%global_info { i8* bitcast (i32* @myGlobalValue to i8*), i32 4, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @_crc_varname_myGlobalValue, i32 0, i32 0 ) }
]
