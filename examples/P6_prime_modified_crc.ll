...
@_crc_varname_g_inlining_effect = private unnamed_addr constant [18 x i8] c"g_inlining_effect\00", align 1
...
@globals_table = constant [1 x %global_info] [
	%global_info { i8* bitcast (i32* @g_inlining_effect to i8*), i32 4, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @_crc_varname_g_inlining_effect, i32 0, i32 0 ) }
]
