...
@_crc_varname_myVar = private unnamed_addr constant [6 x i8] c"myVar\00", align 1
...
@globals_table = constant [1 x %global_info] [
	%global_info { i8* bitcast ([15 x i8]* @myVar to i8*), i32 15, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @_crc_varname_myVar, i32 0, i32 0 ) }
]
