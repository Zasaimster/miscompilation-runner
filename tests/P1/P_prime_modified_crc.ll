...
@globals_table = constant [2 x %global_info] [
	%global_info { i8* bitcast ([14 x i8]* @old_str to i8*), i32 14, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @_crc_varname_old_str, i32 0, i32 0 ) },
...
define i32 @main() #1 {
entry:
  tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @old_str, i32 0, i32 0))
